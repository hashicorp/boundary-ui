...
<Preview>
  <Story name="Dropdown with Checkboxes" height="13rem">{{
    template: hbs`
      <Rose::Form as |form|>
        <form.checkboxGroup @name="color" @selectedValue="red" as |checkboxGroup|>
          <Rose::Dropdown @text="Color" as |dropdown|>
            <dropdown.item>
              <checkboxGroup.checkbox @label="Red" @value="red" />
            </dropdown.item>
            <dropdown.item>
              <checkboxGroup.checkbox @label="Green" @value="green" />
            </dropdown.item>
            <dropdown.item>
              <checkboxGroup.checkbox @label="Blue" @value="blue" />
            </dropdown.item>
          </Rose::Dropdown>
        </form.checkboxGroup>
      </Rose::Form>
...
Dropdowns also support radio buttons.  Currently, this is the only supported
form field.
