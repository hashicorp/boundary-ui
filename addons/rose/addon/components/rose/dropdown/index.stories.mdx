...
<Preview>
  <Story name="Basic Dropdown" height="7rem">{{
    template: hbs`
      <Rose::Dropdown @text="Choose One&hellip;" @icon="flight/org-16" @showCaret={{showCaret}} as |dropdown|>
...
<Preview>
  <Story name="Icon-only Dropdown" height="5rem">{{
    template: hbs`
      <Rose::Dropdown @text="Choose One&hellip;" @icon="flight/org-16" @iconOnly={{true}} as |dropdown|>
        <dropdown.link @route="index">Menu item</dropdown.link>
        <dropdown.link @route="about">Menu item</dropdown.link>
        <dropdown.separator />
        <dropdown.button>Button menu item</dropdown.button>
...
```html
<Rose::Dropdown @showCaret={{true}} @icon="flight/more-horizontal-16" as |dropdown|>
    <dropdown.link @route="index">Menu item</dropdown.link>
    <dropdown.button>Button menu item</dropdown.button>
</Rose::Dropdown>
```
