...
```html
<Rose::Form as |form|>
  <Rose::Dropdown @text="Dogs"   @ignoreClickInside={{true}} as |dropdown|>
...
<Preview>
  <Story name="Basic Sample" height="10rem">{{
  template: hbs`
  <Rose::Form as |form|>
   <Rose::Dropdown   @ignoreClickInside={{true}} @text="Dogs" as |dropdown|>
    <Rose::Form::Checkbox::Group
      @name={{name}}
      @inline={{inline}}
      @disabled={{disabled}}
