    ...
    <Rose::Table @style={{style}} as |table|>
      <table.header as |header|>
        <header.row @hidden={{hideHeaderRow}} as |row|>
          ...
          <row.headerCell @style={{cellStyle}} @alignCenter={{cellAlignmentCenter}} @alignRight={{cellAlignmentRight}}>Host Set</row.headerCell>
      ...
      <table.body as |body|>
        ...
        <body.row as |row|>
          ...
          <row.cell @style={{cellStyle}} @alignCenter={{cellAlignmentCenter}}>host-set-2</row.cell>
        ...
        <body.row as |row|>
          ...
          <row.cell @style={{cellStyle}} @alignRight={{cellAlignmentRight}}>host-set-1</row.cell>
