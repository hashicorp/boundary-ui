...
<Preview>
  <Story name="Basic">{{
    ...
    <Rose::Table @style={{style}} as |table|>
      <table.header as |header|>
        <header.row @visually-hidden={{visuallyHideHeaderRow}} as |row|>
          <row.headerCell>Address</row.headerCell>
    ...
    `,
    context: {
      visuallyHideHeaderRow: boolean('visuallyHideHeaderRow', false),
      cellStyle: select(
        'cellStyle',
        {
          default: '',
  ...
  <Story name="Basic Key/Value Table">{{
    template: hbs`
      <Rose::Table @style="condensed" as |table|>
        <table.header as |header|>
          <header.row @visually-hidden=true as |row|>
        ...
        <table.footer as |footer|>
          <footer.row  @visually-hidden=true as |row|>
            <row.cell>Footer</row.cell>
          </footer.row>
        </table.footer>
      </Rose::Table>
