...
module(
  'Integration | Component | rose/header/dropdown/content/button',
  function (hooks) {
    ...
    test('it renders with content', async function (assert) {
      await render(
        hbs`<Rose::Header::Dropdown::Content::Button>Button content</Rose::Header::Dropdown::Content::Button>`
      );
      assert.equal(
        find('.rose-header-dropdown-content-button').textContent.trim(),
        'Button content'
      );
    });
