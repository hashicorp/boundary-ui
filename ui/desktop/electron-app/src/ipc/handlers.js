...
/**
 * Sets the active terminal ID in the terminal manager to capture user input
 */
handle('setActiveTerminal', (terminalId) =>
  terminalManager.setActiveTerminalId(terminalId),
);
