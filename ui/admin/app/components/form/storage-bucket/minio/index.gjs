...
<template>
  ...
  >
    ...
    <Field
      ...
      {{on 'input' (setFromEvent @model 'endpoint_url')}}
      as |F|
    >
      <F.Label>{{t
          'resources.storage-bucket.form.endpoint_url.label'
        }}</F.Label>
      <F.HelperText>{{t
    ...
    <Field
      ...
      disabled={{form.disabled}}
      readOnly={{not @model.isNew}}
      {{on 'input' (setFromEvent @model 'bucket_name')}}
      as |F|
    >
    ...
    <Field
      ...
      disabled={{form.disabled}}
      readOnly={{not @model.isNew}}
      {{on 'input' (setFromEvent @model 'region')}}
      as |F|
    >
    ...
    {{#if @model.isNew}}
      ...
      <Field
        ...
        {{on 'input' (setFromEvent @model 'access_key_id')}}
        as |F|
      >
        <F.Label>
      ...
      <Field
        ...
        disabled={{form.disabled}}
        @hasVisibilityToggle={{false}}
        {{on 'input' (setFromEvent @model 'secret_access_key')}}
        as |F|
      >
        <F.Label>{{t
