...
<Table class="list-wrapper-field" name={{@name}}>
  ...
  <:body as |B|>
    ...
    {{#each @options as |option index|}}
      <B.Tr>
        <B.Td>
          <Field @value={{option.value}} @type="text" disabled={{@disabled}} aria-label={{t "titles.value"}} />
        </B.Td>
    ...
    <B.Tr>
      ...
      <B.Td>
        <Field @value={{this.newOptionValue}} @type="text" disabled={{@disabled}} aria-label={{t "titles.value"}} />
      </B.Td>
