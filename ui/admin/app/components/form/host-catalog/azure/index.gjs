...
<template>
  ...
  >
    ...
    <Field
      ...
      @isRequired={{true}}
      disabled={{form.disabled}}
      {{on 'input' (setFromEvent @model 'tenant_id')}}
      as |F|
    >
    ...
    <Field
      ...
      @isRequired={{true}}
      disabled={{form.disabled}}
      {{on 'input' (setFromEvent @model 'subscription_id')}}
      as |F|
    >
    ...
    <Field
      ...
      @isRequired={{true}}
      disabled={{form.disabled}}
      {{on 'input' (setFromEvent @model 'client_id')}}
      as |F|
    >
      <F.Label>{{t
          'resources.host-catalog.form.azure_client_id.label'
        }}</F.Label>
      <F.HelperText>
    ...
    <Field
      ...
      @isRequired={{true}}
      disabled={{form.disabled}}
      {{on 'input' (setFromEvent @model 'secret_value')}}
      as |F|
    >
