...
module('Acceptance | policies | update', function (hooks) {
  ...
  test('users can update forever select option to a custom input', async function (assert) {
    setRunOptions({
      rules: {
        'color-contrast': {
          // [ember-a11y-ignore]: axe rule "color-contrast" automatically ignored on 2025-07-25T21:48:17.482Z
          enabled: false,
        },
      },
    });
  ...
  test('users can update from do_not_delete to a custom input', async function (assert) {
    setRunOptions({
      rules: {
        'color-contrast': {
          // [ember-a11y-ignore]: axe rule "color-contrast" automatically ignored on 2025-07-25T21:48:17.483Z
          enabled: false,
        },
      },
    });
  ...
  test('users cannot update delete override when do_not_protect is selected', async function (assert) {
    setRunOptions({
      rules: {
        'color-contrast': {
          // [ember-a11y-ignore]: axe rule "color-contrast" automatically ignored on 2025-07-25T21:48:17.484Z
          enabled: false,
        },
      },
    });
  ...
  test('can cancel changes to an existing storage policy', async function (assert) {
    setRunOptions({
      rules: {
        'color-contrast': {
          // [ember-a11y-ignore]: axe rule "color-contrast" automatically ignored on 2025-07-25T21:48:17.485Z
          enabled: false,
        },
      },
    });
