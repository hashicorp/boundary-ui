  ...
  function (hooks) {
    ...
    test('users can create a new storage bucket with org scope', async function (assert) {
      setRunOptions({
        rules: {
          label: {
            // [ember-a11y-ignore]: axe rule "label" automatically ignored on 2025-07-25T21:48:17.422Z
            enabled: false,
          },

          'color-contrast': {
            // [ember-a11y-ignore]: axe rule "color-contrast" automatically ignored on 2025-07-25T21:48:17.422Z
            enabled: false,
          },
        },
      });
    ...
    test('saving a new storage bucket with invalid fields displays error messages', async function (assert) {
      setRunOptions({
        rules: {
          label: {
            // [ember-a11y-ignore]: axe rule "label" automatically ignored on 2025-07-25T21:48:17.423Z
            enabled: false,
          },

          'color-contrast': {
            // [ember-a11y-ignore]: axe rule "color-contrast" automatically ignored on 2025-07-25T21:48:17.423Z
            enabled: false,
          },
        },
      });
