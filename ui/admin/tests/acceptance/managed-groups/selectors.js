...
export const MANAGED_DROPDOWN_DELETE_ACTION =
...
export const FIELD_GROUP_NAMES_BTN = '[name="group_names"] button';
export const FIELD_GROUP_NAMES_ERROR = '[data-test-error-message-group-names]';

export const FIELD_FILTER_ERROR = '[data-test-error-message-filter-string]';
