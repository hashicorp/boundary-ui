 ...
 * @export
 * @interface ControllerApiV1WrappedError
 */
export interface ControllerApiV1WrappedError {
    /**
     * A string indicating what operation was being run when the wrapped error occurred.
     * @type {string}
     * @memberof ControllerApiV1WrappedError
     */
    op?: string;
    /**
...
/**
 * Check if a given object implements the ControllerApiV1WrappedError interface.
 */
export function instanceOfControllerApiV1WrappedError(value: object): value is ControllerApiV1WrappedError {
    return true;
}

export function ControllerApiV1WrappedErrorFromJSON(json: any): ControllerApiV1WrappedError {
    return ControllerApiV1WrappedErrorFromJSONTyped(json, false);
}

export function ControllerApiV1WrappedErrorFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiV1WrappedError {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiV1WrappedErrorToJSON(json: any): ControllerApiV1WrappedError {
    return ControllerApiV1WrappedErrorToJSONTyped(json, false);
}

export function ControllerApiV1WrappedErrorToJSONTyped(value?: ControllerApiV1WrappedError | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
