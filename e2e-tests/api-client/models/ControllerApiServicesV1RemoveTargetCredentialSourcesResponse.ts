...
import type { ControllerApiResourcesTargetsV1Target } from './ControllerApiResourcesTargetsV1Target';
import {
    ControllerApiResourcesTargetsV1TargetFromJSON,
    ControllerApiResourcesTargetsV1TargetFromJSONTyped,
    ControllerApiResourcesTargetsV1TargetToJSON,
    ControllerApiResourcesTargetsV1TargetToJSONTyped,
} from './ControllerApiResourcesTargetsV1Target';

/**
 * 
 * @export
 * @interface ControllerApiServicesV1RemoveTargetCredentialSourcesResponse
 */
export interface ControllerApiServicesV1RemoveTargetCredentialSourcesResponse {
    /**
     * 
     * @type {ControllerApiResourcesTargetsV1Target}
     * @memberof ControllerApiServicesV1RemoveTargetCredentialSourcesResponse
     */
    item?: ControllerApiResourcesTargetsV1Target;
}

/**
 * Check if a given object implements the ControllerApiServicesV1RemoveTargetCredentialSourcesResponse interface.
 */
export function instanceOfControllerApiServicesV1RemoveTargetCredentialSourcesResponse(value: object): value is ControllerApiServicesV1RemoveTargetCredentialSourcesResponse {
    return true;
}

export function ControllerApiServicesV1RemoveTargetCredentialSourcesResponseFromJSON(json: any): ControllerApiServicesV1RemoveTargetCredentialSourcesResponse {
    return ControllerApiServicesV1RemoveTargetCredentialSourcesResponseFromJSONTyped(json, false);
}

export function ControllerApiServicesV1RemoveTargetCredentialSourcesResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1RemoveTargetCredentialSourcesResponse {
    if (json == null) {
        return json;
    }
    return {
        
        'item': json['item'] == null ? undefined : ControllerApiResourcesTargetsV1TargetFromJSON(json['item']),
    };
}

export function ControllerApiServicesV1RemoveTargetCredentialSourcesResponseToJSON(json: any): ControllerApiServicesV1RemoveTargetCredentialSourcesResponse {
    return ControllerApiServicesV1RemoveTargetCredentialSourcesResponseToJSONTyped(json, false);
}

export function ControllerApiServicesV1RemoveTargetCredentialSourcesResponseToJSONTyped(value?: ControllerApiServicesV1RemoveTargetCredentialSourcesResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'item': ControllerApiResourcesTargetsV1TargetToJSON(value['item']),
    };
}
