 ...
 * 
 * @export
 * @interface ControllerApiServicesV1GetRoleResponse
 */
export interface ControllerApiServicesV1GetRoleResponse {
    /**
     * 
     * @type {ControllerApiResourcesRolesV1Role}
     * @memberof ControllerApiServicesV1GetRoleResponse
     */
    item?: ControllerApiResourcesRolesV1Role;
}

/**
 * Check if a given object implements the ControllerApiServicesV1GetRoleResponse interface.
 */
export function instanceOfControllerApiServicesV1GetRoleResponse(value: object): value is ControllerApiServicesV1GetRoleResponse {
    return true;
}

export function ControllerApiServicesV1GetRoleResponseFromJSON(json: any): ControllerApiServicesV1GetRoleResponse {
    return ControllerApiServicesV1GetRoleResponseFromJSONTyped(json, false);
}

export function ControllerApiServicesV1GetRoleResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1GetRoleResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiServicesV1GetRoleResponseToJSON(json: any): ControllerApiServicesV1GetRoleResponse {
    return ControllerApiServicesV1GetRoleResponseToJSONTyped(json, false);
}

export function ControllerApiServicesV1GetRoleResponseToJSONTyped(value?: ControllerApiServicesV1GetRoleResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
