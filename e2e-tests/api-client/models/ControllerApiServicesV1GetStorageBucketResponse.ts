 ...
 * 
 * @export
 * @interface ControllerApiServicesV1GetStorageBucketResponse
 */
export interface ControllerApiServicesV1GetStorageBucketResponse {
    /**
     * 
     * @type {ControllerApiResourcesStoragebucketsV1StorageBucket}
     * @memberof ControllerApiServicesV1GetStorageBucketResponse
     */
    item?: ControllerApiResourcesStoragebucketsV1StorageBucket;
}

/**
 * Check if a given object implements the ControllerApiServicesV1GetStorageBucketResponse interface.
 */
export function instanceOfControllerApiServicesV1GetStorageBucketResponse(value: object): value is ControllerApiServicesV1GetStorageBucketResponse {
    return true;
}

export function ControllerApiServicesV1GetStorageBucketResponseFromJSON(json: any): ControllerApiServicesV1GetStorageBucketResponse {
    return ControllerApiServicesV1GetStorageBucketResponseFromJSONTyped(json, false);
}

export function ControllerApiServicesV1GetStorageBucketResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1GetStorageBucketResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiServicesV1GetStorageBucketResponseToJSON(json: any): ControllerApiServicesV1GetStorageBucketResponse {
    return ControllerApiServicesV1GetStorageBucketResponseToJSONTyped(json, false);
}

export function ControllerApiServicesV1GetStorageBucketResponseToJSONTyped(value?: ControllerApiServicesV1GetStorageBucketResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
