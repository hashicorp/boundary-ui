 ...
 * 
 * @export
 * @interface ControllerApiServicesV1GetCredentialLibraryResponse
 */
export interface ControllerApiServicesV1GetCredentialLibraryResponse {
    /**
     * 
     * @type {ControllerApiResourcesCredentiallibrariesV1CredentialLibrary}
     * @memberof ControllerApiServicesV1GetCredentialLibraryResponse
     */
    item?: ControllerApiResourcesCredentiallibrariesV1CredentialLibrary;
}

/**
 * Check if a given object implements the ControllerApiServicesV1GetCredentialLibraryResponse interface.
 */
export function instanceOfControllerApiServicesV1GetCredentialLibraryResponse(value: object): value is ControllerApiServicesV1GetCredentialLibraryResponse {
    return true;
}

export function ControllerApiServicesV1GetCredentialLibraryResponseFromJSON(json: any): ControllerApiServicesV1GetCredentialLibraryResponse {
    return ControllerApiServicesV1GetCredentialLibraryResponseFromJSONTyped(json, false);
}

export function ControllerApiServicesV1GetCredentialLibraryResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1GetCredentialLibraryResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiServicesV1GetCredentialLibraryResponseToJSON(json: any): ControllerApiServicesV1GetCredentialLibraryResponse {
    return ControllerApiServicesV1GetCredentialLibraryResponseToJSONTyped(json, false);
}

export function ControllerApiServicesV1GetCredentialLibraryResponseToJSONTyped(value?: ControllerApiServicesV1GetCredentialLibraryResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
