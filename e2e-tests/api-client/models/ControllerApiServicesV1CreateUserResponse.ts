 ...
 * 
 * @export
 * @interface ControllerApiServicesV1CreateUserResponse
 */
export interface ControllerApiServicesV1CreateUserResponse {
    /**
     * 
     * @type {string}
     * @memberof ControllerApiServicesV1CreateUserResponse
     */
    uri?: string;
    /**
     * 
...
/**
 * Check if a given object implements the ControllerApiServicesV1CreateUserResponse interface.
 */
export function instanceOfControllerApiServicesV1CreateUserResponse(value: object): value is ControllerApiServicesV1CreateUserResponse {
    return true;
}

export function ControllerApiServicesV1CreateUserResponseFromJSON(json: any): ControllerApiServicesV1CreateUserResponse {
    return ControllerApiServicesV1CreateUserResponseFromJSONTyped(json, false);
}

export function ControllerApiServicesV1CreateUserResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1CreateUserResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiServicesV1CreateUserResponseToJSON(json: any): ControllerApiServicesV1CreateUserResponse {
    return ControllerApiServicesV1CreateUserResponseToJSONTyped(json, false);
}

export function ControllerApiServicesV1CreateUserResponseToJSONTyped(value?: ControllerApiServicesV1CreateUserResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
