...
import type { ControllerApiResourcesWorkersV1Worker } from './ControllerApiResourcesWorkersV1Worker';
import {
    ControllerApiResourcesWorkersV1WorkerFromJSON,
    ControllerApiResourcesWorkersV1WorkerFromJSONTyped,
    ControllerApiResourcesWorkersV1WorkerToJSON,
    ControllerApiResourcesWorkersV1WorkerToJSONTyped,
} from './ControllerApiResourcesWorkersV1Worker';

/**
 * 
 * @export
 * @interface ControllerApiServicesV1CreateControllerLedResponse
 */
export interface ControllerApiServicesV1CreateControllerLedResponse {
    /**
     * 
     * @type {string}
     * @memberof ControllerApiServicesV1CreateControllerLedResponse
     */
    uri?: string;
    /**
     * 
     * @type {ControllerApiResourcesWorkersV1Worker}
     * @memberof ControllerApiServicesV1CreateControllerLedResponse
     */
    item?: ControllerApiResourcesWorkersV1Worker;
}

/**
 * Check if a given object implements the ControllerApiServicesV1CreateControllerLedResponse interface.
 */
export function instanceOfControllerApiServicesV1CreateControllerLedResponse(value: object): value is ControllerApiServicesV1CreateControllerLedResponse {
    return true;
}

export function ControllerApiServicesV1CreateControllerLedResponseFromJSON(json: any): ControllerApiServicesV1CreateControllerLedResponse {
    return ControllerApiServicesV1CreateControllerLedResponseFromJSONTyped(json, false);
}

export function ControllerApiServicesV1CreateControllerLedResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1CreateControllerLedResponse {
    if (json == null) {
        return json;
    }
    return {
        ...
        'item': json['item'] == null ? undefined : ControllerApiResourcesWorkersV1WorkerFromJSON(json['item']),
    };
}

export function ControllerApiServicesV1CreateControllerLedResponseToJSON(json: any): ControllerApiServicesV1CreateControllerLedResponse {
    return ControllerApiServicesV1CreateControllerLedResponseToJSONTyped(json, false);
}

export function ControllerApiServicesV1CreateControllerLedResponseToJSONTyped(value?: ControllerApiServicesV1CreateControllerLedResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'uri': value['uri'],
        'item': ControllerApiResourcesWorkersV1WorkerToJSON(value['item']),
    };
}
