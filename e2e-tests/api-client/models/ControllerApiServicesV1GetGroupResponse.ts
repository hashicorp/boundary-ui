 ...
 * 
 * @export
 * @interface ControllerApiServicesV1GetGroupResponse
 */
export interface ControllerApiServicesV1GetGroupResponse {
    /**
     * 
     * @type {ControllerApiResourcesGroupsV1Group}
     * @memberof ControllerApiServicesV1GetGroupResponse
     */
    item?: ControllerApiResourcesGroupsV1Group;
}

/**
 * Check if a given object implements the ControllerApiServicesV1GetGroupResponse interface.
 */
export function instanceOfControllerApiServicesV1GetGroupResponse(value: object): value is ControllerApiServicesV1GetGroupResponse {
    return true;
}

export function ControllerApiServicesV1GetGroupResponseFromJSON(json: any): ControllerApiServicesV1GetGroupResponse {
    return ControllerApiServicesV1GetGroupResponseFromJSONTyped(json, false);
}

export function ControllerApiServicesV1GetGroupResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1GetGroupResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiServicesV1GetGroupResponseToJSON(json: any): ControllerApiServicesV1GetGroupResponse {
    return ControllerApiServicesV1GetGroupResponseToJSONTyped(json, false);
}

export function ControllerApiServicesV1GetGroupResponseToJSONTyped(value?: ControllerApiServicesV1GetGroupResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
