 ...
 * 
 * @export
 * @interface ControllerApiServicesV1CreatePolicyResponse
 */
export interface ControllerApiServicesV1CreatePolicyResponse {
    /**
     * 
     * @type {string}
     * @memberof ControllerApiServicesV1CreatePolicyResponse
     */
    uri?: string;
    /**
     * 
...
/**
 * Check if a given object implements the ControllerApiServicesV1CreatePolicyResponse interface.
 */
export function instanceOfControllerApiServicesV1CreatePolicyResponse(value: object): value is ControllerApiServicesV1CreatePolicyResponse {
    return true;
}

export function ControllerApiServicesV1CreatePolicyResponseFromJSON(json: any): ControllerApiServicesV1CreatePolicyResponse {
    return ControllerApiServicesV1CreatePolicyResponseFromJSONTyped(json, false);
}

export function ControllerApiServicesV1CreatePolicyResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1CreatePolicyResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiServicesV1CreatePolicyResponseToJSON(json: any): ControllerApiServicesV1CreatePolicyResponse {
    return ControllerApiServicesV1CreatePolicyResponseToJSONTyped(json, false);
}

export function ControllerApiServicesV1CreatePolicyResponseToJSONTyped(value?: ControllerApiServicesV1CreatePolicyResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
