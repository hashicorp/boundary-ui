 ...
 * 
 * @export
 * @interface ControllerApiServicesV1RotateKeysRequest
 */
export interface ControllerApiServicesV1RotateKeysRequest {
    /**
     * 
     * @type {string}
     * @memberof ControllerApiServicesV1RotateKeysRequest
     */
    scopeId?: string;
    /**
     * 
...
/**
 * Check if a given object implements the ControllerApiServicesV1RotateKeysRequest interface.
 */
export function instanceOfControllerApiServicesV1RotateKeysRequest(value: object): value is ControllerApiServicesV1RotateKeysRequest {
    return true;
}

export function ControllerApiServicesV1RotateKeysRequestFromJSON(json: any): ControllerApiServicesV1RotateKeysRequest {
    return ControllerApiServicesV1RotateKeysRequestFromJSONTyped(json, false);
}

export function ControllerApiServicesV1RotateKeysRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1RotateKeysRequest {
    if (json == null) {
        return json;
    }
    return {
        ...
        'rewrap': json['rewrap'] == null ? undefined : json['rewrap'],
    };
}

export function ControllerApiServicesV1RotateKeysRequestToJSON(json: any): ControllerApiServicesV1RotateKeysRequest {
    return ControllerApiServicesV1RotateKeysRequestToJSONTyped(json, false);
}

export function ControllerApiServicesV1RotateKeysRequestToJSONTyped(value?: ControllerApiServicesV1RotateKeysRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
