...
import type { ControllerApiResourcesBillingV1ActiveUsers } from './ControllerApiResourcesBillingV1ActiveUsers';
import {
    ControllerApiResourcesBillingV1ActiveUsersFromJSON,
    ControllerApiResourcesBillingV1ActiveUsersFromJSONTyped,
    ControllerApiResourcesBillingV1ActiveUsersToJSON,
    ControllerApiResourcesBillingV1ActiveUsersToJSONTyped,
} from './ControllerApiResourcesBillingV1ActiveUsers';

/**
 * 
 * @export
 * @interface ControllerApiServicesV1MonthlyActiveUsersResponse
 */
export interface ControllerApiServicesV1MonthlyActiveUsersResponse {
    /**
     * 
     * @type {Array<ControllerApiResourcesBillingV1ActiveUsers>}
     * @memberof ControllerApiServicesV1MonthlyActiveUsersResponse
     */
    items?: Array<ControllerApiResourcesBillingV1ActiveUsers>;
}

/**
 * Check if a given object implements the ControllerApiServicesV1MonthlyActiveUsersResponse interface.
 */
export function instanceOfControllerApiServicesV1MonthlyActiveUsersResponse(value: object): value is ControllerApiServicesV1MonthlyActiveUsersResponse {
    return true;
}

export function ControllerApiServicesV1MonthlyActiveUsersResponseFromJSON(json: any): ControllerApiServicesV1MonthlyActiveUsersResponse {
    return ControllerApiServicesV1MonthlyActiveUsersResponseFromJSONTyped(json, false);
}

export function ControllerApiServicesV1MonthlyActiveUsersResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1MonthlyActiveUsersResponse {
    if (json == null) {
        return json;
    }
    return {
        
        'items': json['items'] == null ? undefined : ((json['items'] as Array<any>).map(ControllerApiResourcesBillingV1ActiveUsersFromJSON)),
    };
}

export function ControllerApiServicesV1MonthlyActiveUsersResponseToJSON(json: any): ControllerApiServicesV1MonthlyActiveUsersResponse {
    return ControllerApiServicesV1MonthlyActiveUsersResponseToJSONTyped(json, false);
}

export function ControllerApiServicesV1MonthlyActiveUsersResponseToJSONTyped(value?: ControllerApiServicesV1MonthlyActiveUsersResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'items': value['items'] == null ? undefined : ((value['items'] as Array<any>).map(ControllerApiResourcesBillingV1ActiveUsersToJSON)),
    };
}
