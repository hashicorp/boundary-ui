...
import type { ControllerApiResourcesTargetsV1SessionSecret } from './ControllerApiResourcesTargetsV1SessionSecret';
import {
    ControllerApiResourcesTargetsV1SessionSecretFromJSON,
    ControllerApiResourcesTargetsV1SessionSecretFromJSONTyped,
    ControllerApiResourcesTargetsV1SessionSecretToJSON,
    ControllerApiResourcesTargetsV1SessionSecretToJSONTyped,
} from './ControllerApiResourcesTargetsV1SessionSecret';

/**
 * Credential information for a session.
 * @export
 * @interface ControllerApiResourcesTargetsV1SessionCredential
 */
export interface ControllerApiResourcesTargetsV1SessionCredential {
    /**
     * 
     * @type {ControllerApiResourcesTargetsV1CredentialSource}
     * @memberof ControllerApiResourcesTargetsV1SessionCredential
     */
    credentialSource?: ControllerApiResourcesTargetsV1CredentialSource;
    /**
     * 
     * @type {ControllerApiResourcesTargetsV1SessionSecret}
     * @memberof ControllerApiResourcesTargetsV1SessionCredential
     */
    secret?: ControllerApiResourcesTargetsV1SessionSecret;
    /**
...
/**
 * Check if a given object implements the ControllerApiResourcesTargetsV1SessionCredential interface.
 */
export function instanceOfControllerApiResourcesTargetsV1SessionCredential(value: object): value is ControllerApiResourcesTargetsV1SessionCredential {
    return true;
}

export function ControllerApiResourcesTargetsV1SessionCredentialFromJSON(json: any): ControllerApiResourcesTargetsV1SessionCredential {
    return ControllerApiResourcesTargetsV1SessionCredentialFromJSONTyped(json, false);
}

export function ControllerApiResourcesTargetsV1SessionCredentialFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiResourcesTargetsV1SessionCredential {
    if (json == null) {
        return json;
    }
    return {
        
        'credentialSource': json['credential_source'] == null ? undefined : ControllerApiResourcesTargetsV1CredentialSourceFromJSON(json['credential_source']),
        'secret': json['secret'] == null ? undefined : ControllerApiResourcesTargetsV1SessionSecretFromJSON(json['secret']),
        'credential': json['credential'] == null ? undefined : json['credential'],
    };
}

export function ControllerApiResourcesTargetsV1SessionCredentialToJSON(json: any): ControllerApiResourcesTargetsV1SessionCredential {
    return ControllerApiResourcesTargetsV1SessionCredentialToJSONTyped(json, false);
}

export function ControllerApiResourcesTargetsV1SessionCredentialToJSONTyped(value?: Omit<ControllerApiResourcesTargetsV1SessionCredential, 'credential'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'credential_source': ControllerApiResourcesTargetsV1CredentialSourceToJSON(value['credentialSource']),
        'secret': ControllerApiResourcesTargetsV1SessionSecretToJSON(value['secret']),
    };
}
