 ...
 * 
 * @export
 * @interface ControllerApiServicesV1ListGroupsResponse
 */
export interface ControllerApiServicesV1ListGroupsResponse {
    /**
     * 
     * @type {Array<ControllerApiResourcesGroupsV1Group>}
     * @memberof ControllerApiServicesV1ListGroupsResponse
     */
    items?: Array<ControllerApiResourcesGroupsV1Group>;
    /**
...
/**
 * Check if a given object implements the ControllerApiServicesV1ListGroupsResponse interface.
 */
export function instanceOfControllerApiServicesV1ListGroupsResponse(value: object): value is ControllerApiServicesV1ListGroupsResponse {
    return true;
}

export function ControllerApiServicesV1ListGroupsResponseFromJSON(json: any): ControllerApiServicesV1ListGroupsResponse {
    return ControllerApiServicesV1ListGroupsResponseFromJSONTyped(json, false);
}

export function ControllerApiServicesV1ListGroupsResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1ListGroupsResponse {
    if (json == null) {
        return json;
    }
    return {
        
        'items': json['items'] == null ? undefined : ((json['items'] as Array<any>).map(ControllerApiResourcesGroupsV1GroupFromJSON)),
...
export function ControllerApiServicesV1ListGroupsResponseToJSON(json: any): ControllerApiServicesV1ListGroupsResponse {
    return ControllerApiServicesV1ListGroupsResponseToJSONTyped(json, false);
}

export function ControllerApiServicesV1ListGroupsResponseToJSONTyped(value?: ControllerApiServicesV1ListGroupsResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'items': value['items'] == null ? undefined : ((value['items'] as Array<any>).map(ControllerApiResourcesGroupsV1GroupToJSON)),
