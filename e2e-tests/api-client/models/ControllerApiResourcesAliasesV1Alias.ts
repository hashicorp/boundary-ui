 ...
 * 
 * @export
 * @interface ControllerApiResourcesAliasesV1Alias
 */
export interface ControllerApiResourcesAliasesV1Alias {
    /**
     * The ID of the alias.
     * @type {string}
     * @memberof ControllerApiResourcesAliasesV1Alias
     */
    readonly id?: string;
    /**
    ...
    type?: string;
    /**
     * The attributes that are applicable for the specific alias type. The schema of this field depends on the type of resource that you create the alias for.
...
/**
 * Check if a given object implements the ControllerApiResourcesAliasesV1Alias interface.
 */
export function instanceOfControllerApiResourcesAliasesV1Alias(value: object): value is ControllerApiResourcesAliasesV1Alias {
    return true;
}

export function ControllerApiResourcesAliasesV1AliasFromJSON(json: any): ControllerApiResourcesAliasesV1Alias {
    return ControllerApiResourcesAliasesV1AliasFromJSONTyped(json, false);
}

export function ControllerApiResourcesAliasesV1AliasFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiResourcesAliasesV1Alias {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiResourcesAliasesV1AliasToJSON(json: any): ControllerApiResourcesAliasesV1Alias {
    return ControllerApiResourcesAliasesV1AliasToJSONTyped(json, false);
}

export function ControllerApiResourcesAliasesV1AliasToJSONTyped(value?: Omit<ControllerApiResourcesAliasesV1Alias, 'id'|'created_time'|'updated_time'|'authorized_actions'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
