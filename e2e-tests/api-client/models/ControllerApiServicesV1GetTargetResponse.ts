 ...
 * 
 * @export
 * @interface ControllerApiServicesV1GetTargetResponse
 */
export interface ControllerApiServicesV1GetTargetResponse {
    /**
     * 
     * @type {ControllerApiResourcesTargetsV1Target}
     * @memberof ControllerApiServicesV1GetTargetResponse
     */
    item?: ControllerApiResourcesTargetsV1Target;
}

/**
 * Check if a given object implements the ControllerApiServicesV1GetTargetResponse interface.
 */
export function instanceOfControllerApiServicesV1GetTargetResponse(value: object): value is ControllerApiServicesV1GetTargetResponse {
    return true;
}

export function ControllerApiServicesV1GetTargetResponseFromJSON(json: any): ControllerApiServicesV1GetTargetResponse {
    return ControllerApiServicesV1GetTargetResponseFromJSONTyped(json, false);
}

export function ControllerApiServicesV1GetTargetResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1GetTargetResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiServicesV1GetTargetResponseToJSON(json: any): ControllerApiServicesV1GetTargetResponse {
    return ControllerApiServicesV1GetTargetResponseToJSONTyped(json, false);
}

export function ControllerApiServicesV1GetTargetResponseToJSONTyped(value?: ControllerApiServicesV1GetTargetResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
