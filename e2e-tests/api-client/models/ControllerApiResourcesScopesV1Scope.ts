 ...
 * 
 * @export
 * @interface ControllerApiResourcesScopesV1Scope
 */
export interface ControllerApiResourcesScopesV1Scope {
    /**
     * The ID of the scope.
     * @type {string}
     * @memberof ControllerApiResourcesScopesV1Scope
     */
    readonly id?: string;
    /**
...
/**
 * Check if a given object implements the ControllerApiResourcesScopesV1Scope interface.
 */
export function instanceOfControllerApiResourcesScopesV1Scope(value: object): value is ControllerApiResourcesScopesV1Scope {
    return true;
}

export function ControllerApiResourcesScopesV1ScopeFromJSON(json: any): ControllerApiResourcesScopesV1Scope {
    return ControllerApiResourcesScopesV1ScopeFromJSONTyped(json, false);
}

export function ControllerApiResourcesScopesV1ScopeFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiResourcesScopesV1Scope {
    if (json == null) {
        return json;
    }
    return {
        ...
        'primaryAuthMethodId': json['primary_auth_method_id'] == null ? undefined : json['primary_auth_method_id'],
        ...
        'storagePolicyId': json['storage_policy_id'] == null ? undefined : json['storage_policy_id'],
    };
}

export function ControllerApiResourcesScopesV1ScopeToJSON(json: any): ControllerApiResourcesScopesV1Scope {
    return ControllerApiResourcesScopesV1ScopeToJSONTyped(json, false);
}

export function ControllerApiResourcesScopesV1ScopeToJSONTyped(value?: Omit<ControllerApiResourcesScopesV1Scope, 'id'|'created_time'|'updated_time'|'authorized_actions'|'authorized_collection_actions'|'storage_policy_id'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'type': value['type'],
        'primary_auth_method_id': value['primaryAuthMethodId'],
    };
}
