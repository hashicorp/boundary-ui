 ...
 * 
 * @export
 * @interface ControllerApiServicesV1TargetServiceAddTargetHostSourcesBody
 */
export interface ControllerApiServicesV1TargetServiceAddTargetHostSourcesBody {
    /**
     * Version is used to ensure this resource has not changed.
     * The mutation will fail if the version does not match the latest known good version.
     * @type {number}
     * @memberof ControllerApiServicesV1TargetServiceAddTargetHostSourcesBody
     */
    version?: number;
    /**
     * 
...
/**
 * Check if a given object implements the ControllerApiServicesV1TargetServiceAddTargetHostSourcesBody interface.
 */
export function instanceOfControllerApiServicesV1TargetServiceAddTargetHostSourcesBody(value: object): value is ControllerApiServicesV1TargetServiceAddTargetHostSourcesBody {
    return true;
}

export function ControllerApiServicesV1TargetServiceAddTargetHostSourcesBodyFromJSON(json: any): ControllerApiServicesV1TargetServiceAddTargetHostSourcesBody {
    return ControllerApiServicesV1TargetServiceAddTargetHostSourcesBodyFromJSONTyped(json, false);
}

export function ControllerApiServicesV1TargetServiceAddTargetHostSourcesBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1TargetServiceAddTargetHostSourcesBody {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiServicesV1TargetServiceAddTargetHostSourcesBodyToJSON(json: any): ControllerApiServicesV1TargetServiceAddTargetHostSourcesBody {
    return ControllerApiServicesV1TargetServiceAddTargetHostSourcesBodyToJSONTyped(json, false);
}

export function ControllerApiServicesV1TargetServiceAddTargetHostSourcesBodyToJSONTyped(value?: ControllerApiServicesV1TargetServiceAddTargetHostSourcesBody | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
