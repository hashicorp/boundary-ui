 ...
 * 
 * @export
 * @interface ControllerApiServicesV1CreateAliasResponse
 */
export interface ControllerApiServicesV1CreateAliasResponse {
    /**
     * 
     * @type {string}
     * @memberof ControllerApiServicesV1CreateAliasResponse
     */
    uri?: string;
    /**
     * 
     * @type {ControllerApiResourcesAliasesV1Alias}
     * @memberof ControllerApiServicesV1CreateAliasResponse
     */
    item?: ControllerApiResourcesAliasesV1Alias;
}

/**
 * Check if a given object implements the ControllerApiServicesV1CreateAliasResponse interface.
 */
export function instanceOfControllerApiServicesV1CreateAliasResponse(value: object): value is ControllerApiServicesV1CreateAliasResponse {
    return true;
}

export function ControllerApiServicesV1CreateAliasResponseFromJSON(json: any): ControllerApiServicesV1CreateAliasResponse {
    return ControllerApiServicesV1CreateAliasResponseFromJSONTyped(json, false);
}

export function ControllerApiServicesV1CreateAliasResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1CreateAliasResponse {
    if (json == null) {
        return json;
    }
    return {
        ...
        'item': json['item'] == null ? undefined : ControllerApiResourcesAliasesV1AliasFromJSON(json['item']),
    };
}

export function ControllerApiServicesV1CreateAliasResponseToJSON(json: any): ControllerApiServicesV1CreateAliasResponse {
    return ControllerApiServicesV1CreateAliasResponseToJSONTyped(json, false);
}

export function ControllerApiServicesV1CreateAliasResponseToJSONTyped(value?: ControllerApiServicesV1CreateAliasResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'uri': value['uri'],
        'item': ControllerApiResourcesAliasesV1AliasToJSON(value['item']),
    };
}
