 ...
 * 
 * @export
 * @interface ControllerApiServicesV1AccountServiceChangePasswordBody
 */
export interface ControllerApiServicesV1AccountServiceChangePasswordBody {
    /**
     * Version is used to ensure this resource has not changed.
     * The mutation will fail if the version does not match the latest known good version.
     * @type {number}
     * @memberof ControllerApiServicesV1AccountServiceChangePasswordBody
     */
    version?: number;
    /**
...
/**
 * Check if a given object implements the ControllerApiServicesV1AccountServiceChangePasswordBody interface.
 */
export function instanceOfControllerApiServicesV1AccountServiceChangePasswordBody(value: object): value is ControllerApiServicesV1AccountServiceChangePasswordBody {
    return true;
}

export function ControllerApiServicesV1AccountServiceChangePasswordBodyFromJSON(json: any): ControllerApiServicesV1AccountServiceChangePasswordBody {
    return ControllerApiServicesV1AccountServiceChangePasswordBodyFromJSONTyped(json, false);
}

export function ControllerApiServicesV1AccountServiceChangePasswordBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1AccountServiceChangePasswordBody {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiServicesV1AccountServiceChangePasswordBodyToJSON(json: any): ControllerApiServicesV1AccountServiceChangePasswordBody {
    return ControllerApiServicesV1AccountServiceChangePasswordBodyToJSONTyped(json, false);
}

export function ControllerApiServicesV1AccountServiceChangePasswordBodyToJSONTyped(value?: ControllerApiServicesV1AccountServiceChangePasswordBody | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
