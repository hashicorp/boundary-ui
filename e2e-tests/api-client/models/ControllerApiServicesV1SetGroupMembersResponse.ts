 ...
 * 
 * @export
 * @interface ControllerApiServicesV1SetGroupMembersResponse
 */
export interface ControllerApiServicesV1SetGroupMembersResponse {
    /**
     * 
     * @type {ControllerApiResourcesGroupsV1Group}
     * @memberof ControllerApiServicesV1SetGroupMembersResponse
     */
    item?: ControllerApiResourcesGroupsV1Group;
}

/**
 * Check if a given object implements the ControllerApiServicesV1SetGroupMembersResponse interface.
 */
export function instanceOfControllerApiServicesV1SetGroupMembersResponse(value: object): value is ControllerApiServicesV1SetGroupMembersResponse {
    return true;
}

export function ControllerApiServicesV1SetGroupMembersResponseFromJSON(json: any): ControllerApiServicesV1SetGroupMembersResponse {
    return ControllerApiServicesV1SetGroupMembersResponseFromJSONTyped(json, false);
}

export function ControllerApiServicesV1SetGroupMembersResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1SetGroupMembersResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiServicesV1SetGroupMembersResponseToJSON(json: any): ControllerApiServicesV1SetGroupMembersResponse {
    return ControllerApiServicesV1SetGroupMembersResponseToJSONTyped(json, false);
}

export function ControllerApiServicesV1SetGroupMembersResponseToJSONTyped(value?: ControllerApiServicesV1SetGroupMembersResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
