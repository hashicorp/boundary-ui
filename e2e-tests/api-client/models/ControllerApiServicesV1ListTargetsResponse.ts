 ...
 * 
 * @export
 * @interface ControllerApiServicesV1ListTargetsResponse
 */
export interface ControllerApiServicesV1ListTargetsResponse {
    /**
     * 
     * @type {Array<ControllerApiResourcesTargetsV1Target>}
     * @memberof ControllerApiServicesV1ListTargetsResponse
     */
    items?: Array<ControllerApiResourcesTargetsV1Target>;
    /**
...
/**
 * Check if a given object implements the ControllerApiServicesV1ListTargetsResponse interface.
 */
export function instanceOfControllerApiServicesV1ListTargetsResponse(value: object): value is ControllerApiServicesV1ListTargetsResponse {
    return true;
}

export function ControllerApiServicesV1ListTargetsResponseFromJSON(json: any): ControllerApiServicesV1ListTargetsResponse {
    return ControllerApiServicesV1ListTargetsResponseFromJSONTyped(json, false);
}

export function ControllerApiServicesV1ListTargetsResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1ListTargetsResponse {
    if (json == null) {
        return json;
    }
    return {
        
        'items': json['items'] == null ? undefined : ((json['items'] as Array<any>).map(ControllerApiResourcesTargetsV1TargetFromJSON)),
...
export function ControllerApiServicesV1ListTargetsResponseToJSON(json: any): ControllerApiServicesV1ListTargetsResponse {
    return ControllerApiServicesV1ListTargetsResponseToJSONTyped(json, false);
}

export function ControllerApiServicesV1ListTargetsResponseToJSONTyped(value?: ControllerApiServicesV1ListTargetsResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'items': value['items'] == null ? undefined : ((value['items'] as Array<any>).map(ControllerApiResourcesTargetsV1TargetToJSON)),
