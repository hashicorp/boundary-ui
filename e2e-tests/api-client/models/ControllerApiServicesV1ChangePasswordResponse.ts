 ...
 * 
 * @export
 * @interface ControllerApiServicesV1ChangePasswordResponse
 */
export interface ControllerApiServicesV1ChangePasswordResponse {
    /**
     * 
     * @type {ControllerApiResourcesAccountsV1Account}
     * @memberof ControllerApiServicesV1ChangePasswordResponse
     */
    item?: ControllerApiResourcesAccountsV1Account;
}

/**
 * Check if a given object implements the ControllerApiServicesV1ChangePasswordResponse interface.
 */
export function instanceOfControllerApiServicesV1ChangePasswordResponse(value: object): value is ControllerApiServicesV1ChangePasswordResponse {
    return true;
}

export function ControllerApiServicesV1ChangePasswordResponseFromJSON(json: any): ControllerApiServicesV1ChangePasswordResponse {
    return ControllerApiServicesV1ChangePasswordResponseFromJSONTyped(json, false);
}

export function ControllerApiServicesV1ChangePasswordResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1ChangePasswordResponse {
    if (json == null) {
        return json;
    }
    return {
        
        'item': json['item'] == null ? undefined : ControllerApiResourcesAccountsV1AccountFromJSON(json['item']),
    };
}

export function ControllerApiServicesV1ChangePasswordResponseToJSON(json: any): ControllerApiServicesV1ChangePasswordResponse {
    return ControllerApiServicesV1ChangePasswordResponseToJSONTyped(json, false);
}

export function ControllerApiServicesV1ChangePasswordResponseToJSONTyped(value?: ControllerApiServicesV1ChangePasswordResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'item': ControllerApiResourcesAccountsV1AccountToJSON(value['item']),
    };
}
