 ...
 * 
 * @export
 * @interface ControllerApiServicesV1GetManagedGroupResponse
 */
export interface ControllerApiServicesV1GetManagedGroupResponse {
    /**
     * 
     * @type {ControllerApiResourcesManagedgroupsV1ManagedGroup}
     * @memberof ControllerApiServicesV1GetManagedGroupResponse
     */
    item?: ControllerApiResourcesManagedgroupsV1ManagedGroup;
}

/**
 * Check if a given object implements the ControllerApiServicesV1GetManagedGroupResponse interface.
 */
export function instanceOfControllerApiServicesV1GetManagedGroupResponse(value: object): value is ControllerApiServicesV1GetManagedGroupResponse {
    return true;
}

export function ControllerApiServicesV1GetManagedGroupResponseFromJSON(json: any): ControllerApiServicesV1GetManagedGroupResponse {
    return ControllerApiServicesV1GetManagedGroupResponseFromJSONTyped(json, false);
}

export function ControllerApiServicesV1GetManagedGroupResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1GetManagedGroupResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiServicesV1GetManagedGroupResponseToJSON(json: any): ControllerApiServicesV1GetManagedGroupResponse {
    return ControllerApiServicesV1GetManagedGroupResponseToJSONTyped(json, false);
}

export function ControllerApiServicesV1GetManagedGroupResponseToJSONTyped(value?: ControllerApiServicesV1GetManagedGroupResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
