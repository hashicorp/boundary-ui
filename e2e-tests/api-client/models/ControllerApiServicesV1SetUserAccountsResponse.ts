 ...
 * 
 * @export
 * @interface ControllerApiServicesV1SetUserAccountsResponse
 */
export interface ControllerApiServicesV1SetUserAccountsResponse {
    /**
     * 
     * @type {ControllerApiResourcesUsersV1User}
     * @memberof ControllerApiServicesV1SetUserAccountsResponse
     */
    item?: ControllerApiResourcesUsersV1User;
}

/**
 * Check if a given object implements the ControllerApiServicesV1SetUserAccountsResponse interface.
 */
export function instanceOfControllerApiServicesV1SetUserAccountsResponse(value: object): value is ControllerApiServicesV1SetUserAccountsResponse {
    return true;
}

export function ControllerApiServicesV1SetUserAccountsResponseFromJSON(json: any): ControllerApiServicesV1SetUserAccountsResponse {
    return ControllerApiServicesV1SetUserAccountsResponseFromJSONTyped(json, false);
}

export function ControllerApiServicesV1SetUserAccountsResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1SetUserAccountsResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiServicesV1SetUserAccountsResponseToJSON(json: any): ControllerApiServicesV1SetUserAccountsResponse {
    return ControllerApiServicesV1SetUserAccountsResponseToJSONTyped(json, false);
}

export function ControllerApiServicesV1SetUserAccountsResponseToJSONTyped(value?: ControllerApiServicesV1SetUserAccountsResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
