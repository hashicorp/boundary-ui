 ...
 * 
 * @export
 * @interface ControllerApiServicesV1RoleServiceAddRoleGrantsBody
 */
export interface ControllerApiServicesV1RoleServiceAddRoleGrantsBody {
    /**
     * Version is used to ensure this resource has not changed.
     * The mutation will fail if the version does not match the latest known good version.
     * @type {number}
     * @memberof ControllerApiServicesV1RoleServiceAddRoleGrantsBody
     */
    version?: number;
    /**
     * 
...
/**
 * Check if a given object implements the ControllerApiServicesV1RoleServiceAddRoleGrantsBody interface.
 */
export function instanceOfControllerApiServicesV1RoleServiceAddRoleGrantsBody(value: object): value is ControllerApiServicesV1RoleServiceAddRoleGrantsBody {
    return true;
}

export function ControllerApiServicesV1RoleServiceAddRoleGrantsBodyFromJSON(json: any): ControllerApiServicesV1RoleServiceAddRoleGrantsBody {
    return ControllerApiServicesV1RoleServiceAddRoleGrantsBodyFromJSONTyped(json, false);
}

export function ControllerApiServicesV1RoleServiceAddRoleGrantsBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1RoleServiceAddRoleGrantsBody {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiServicesV1RoleServiceAddRoleGrantsBodyToJSON(json: any): ControllerApiServicesV1RoleServiceAddRoleGrantsBody {
    return ControllerApiServicesV1RoleServiceAddRoleGrantsBodyToJSONTyped(json, false);
}

export function ControllerApiServicesV1RoleServiceAddRoleGrantsBodyToJSONTyped(value?: ControllerApiServicesV1RoleServiceAddRoleGrantsBody | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
