...
import type { ControllerApiResourcesScopesV1Key } from './ControllerApiResourcesScopesV1Key';
import {
    ControllerApiResourcesScopesV1KeyFromJSON,
    ControllerApiResourcesScopesV1KeyFromJSONTyped,
    ControllerApiResourcesScopesV1KeyToJSON,
    ControllerApiResourcesScopesV1KeyToJSONTyped,
} from './ControllerApiResourcesScopesV1Key';

/**
 * 
 * @export
 * @interface ControllerApiServicesV1ListKeysResponse
 */
export interface ControllerApiServicesV1ListKeysResponse {
    /**
     * 
     * @type {Array<ControllerApiResourcesScopesV1Key>}
     * @memberof ControllerApiServicesV1ListKeysResponse
     */
    items?: Array<ControllerApiResourcesScopesV1Key>;
}

/**
 * Check if a given object implements the ControllerApiServicesV1ListKeysResponse interface.
 */
export function instanceOfControllerApiServicesV1ListKeysResponse(value: object): value is ControllerApiServicesV1ListKeysResponse {
    return true;
}

export function ControllerApiServicesV1ListKeysResponseFromJSON(json: any): ControllerApiServicesV1ListKeysResponse {
    return ControllerApiServicesV1ListKeysResponseFromJSONTyped(json, false);
}

export function ControllerApiServicesV1ListKeysResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1ListKeysResponse {
    if (json == null) {
        return json;
    }
    return {
        
        'items': json['items'] == null ? undefined : ((json['items'] as Array<any>).map(ControllerApiResourcesScopesV1KeyFromJSON)),
    };
}

export function ControllerApiServicesV1ListKeysResponseToJSON(json: any): ControllerApiServicesV1ListKeysResponse {
    return ControllerApiServicesV1ListKeysResponseToJSONTyped(json, false);
}

export function ControllerApiServicesV1ListKeysResponseToJSONTyped(value?: ControllerApiServicesV1ListKeysResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'items': value['items'] == null ? undefined : ((value['items'] as Array<any>).map(ControllerApiResourcesScopesV1KeyToJSON)),
    };
}
