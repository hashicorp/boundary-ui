 ...
 * 
 * @export
 * @interface ControllerApiServicesV1UpdateAliasResponse
 */
export interface ControllerApiServicesV1UpdateAliasResponse {
    /**
     * 
     * @type {ControllerApiResourcesAliasesV1Alias}
     * @memberof ControllerApiServicesV1UpdateAliasResponse
     */
    item?: ControllerApiResourcesAliasesV1Alias;
}

/**
 * Check if a given object implements the ControllerApiServicesV1UpdateAliasResponse interface.
 */
export function instanceOfControllerApiServicesV1UpdateAliasResponse(value: object): value is ControllerApiServicesV1UpdateAliasResponse {
    return true;
}

export function ControllerApiServicesV1UpdateAliasResponseFromJSON(json: any): ControllerApiServicesV1UpdateAliasResponse {
    return ControllerApiServicesV1UpdateAliasResponseFromJSONTyped(json, false);
}

export function ControllerApiServicesV1UpdateAliasResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1UpdateAliasResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiServicesV1UpdateAliasResponseToJSON(json: any): ControllerApiServicesV1UpdateAliasResponse {
    return ControllerApiServicesV1UpdateAliasResponseToJSONTyped(json, false);
}

export function ControllerApiServicesV1UpdateAliasResponseToJSONTyped(value?: ControllerApiServicesV1UpdateAliasResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
