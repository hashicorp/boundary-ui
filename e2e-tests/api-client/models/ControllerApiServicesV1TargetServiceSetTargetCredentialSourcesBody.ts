 ...
 * @export
 * @interface ControllerApiServicesV1TargetServiceSetTargetCredentialSourcesBody
 */
export interface ControllerApiServicesV1TargetServiceSetTargetCredentialSourcesBody {
    /**
     * Version is used to ensure this resource has not changed.
     * The mutation will fail if the version does not match the latest known good version.
     * @type {number}
     * @memberof ControllerApiServicesV1TargetServiceSetTargetCredentialSourcesBody
     */
    version?: number;
    /**
...
/**
 * Check if a given object implements the ControllerApiServicesV1TargetServiceSetTargetCredentialSourcesBody interface.
 */
export function instanceOfControllerApiServicesV1TargetServiceSetTargetCredentialSourcesBody(value: object): value is ControllerApiServicesV1TargetServiceSetTargetCredentialSourcesBody {
    return true;
}

export function ControllerApiServicesV1TargetServiceSetTargetCredentialSourcesBodyFromJSON(json: any): ControllerApiServicesV1TargetServiceSetTargetCredentialSourcesBody {
    return ControllerApiServicesV1TargetServiceSetTargetCredentialSourcesBodyFromJSONTyped(json, false);
}

export function ControllerApiServicesV1TargetServiceSetTargetCredentialSourcesBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1TargetServiceSetTargetCredentialSourcesBody {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiServicesV1TargetServiceSetTargetCredentialSourcesBodyToJSON(json: any): ControllerApiServicesV1TargetServiceSetTargetCredentialSourcesBody {
    return ControllerApiServicesV1TargetServiceSetTargetCredentialSourcesBodyToJSONTyped(json, false);
}

export function ControllerApiServicesV1TargetServiceSetTargetCredentialSourcesBodyToJSONTyped(value?: ControllerApiServicesV1TargetServiceSetTargetCredentialSourcesBody | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
