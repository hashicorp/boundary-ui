 ...
 * 
 * @export
 * @interface ControllerApiResourcesPluginsV1PluginInfo
 */
export interface ControllerApiResourcesPluginsV1PluginInfo {
    /**
     * Output only. The ID of the Plugin.
     * @type {string}
     * @memberof ControllerApiResourcesPluginsV1PluginInfo
     */
    readonly id?: string;
    /**
...
/**
 * Check if a given object implements the ControllerApiResourcesPluginsV1PluginInfo interface.
 */
export function instanceOfControllerApiResourcesPluginsV1PluginInfo(value: object): value is ControllerApiResourcesPluginsV1PluginInfo {
    return true;
}

export function ControllerApiResourcesPluginsV1PluginInfoFromJSON(json: any): ControllerApiResourcesPluginsV1PluginInfo {
    return ControllerApiResourcesPluginsV1PluginInfoFromJSONTyped(json, false);
}

export function ControllerApiResourcesPluginsV1PluginInfoFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiResourcesPluginsV1PluginInfo {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiResourcesPluginsV1PluginInfoToJSON(json: any): ControllerApiResourcesPluginsV1PluginInfo {
    return ControllerApiResourcesPluginsV1PluginInfoToJSONTyped(json, false);
}

export function ControllerApiResourcesPluginsV1PluginInfoToJSONTyped(value?: Omit<ControllerApiResourcesPluginsV1PluginInfo, 'id'|'name'|'description'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
