 ...
 * 
 * @export
 * @interface ControllerApiServicesV1HostSetServiceAddHostSetHostsBody
 */
export interface ControllerApiServicesV1HostSetServiceAddHostSetHostsBody {
    /**
     * Version is used to ensure this resource has not changed.
     * The mutation will fail if the version does not match the latest known good version.
     * @type {number}
     * @memberof ControllerApiServicesV1HostSetServiceAddHostSetHostsBody
     */
    version?: number;
    /**
...
/**
 * Check if a given object implements the ControllerApiServicesV1HostSetServiceAddHostSetHostsBody interface.
 */
export function instanceOfControllerApiServicesV1HostSetServiceAddHostSetHostsBody(value: object): value is ControllerApiServicesV1HostSetServiceAddHostSetHostsBody {
    return true;
}

export function ControllerApiServicesV1HostSetServiceAddHostSetHostsBodyFromJSON(json: any): ControllerApiServicesV1HostSetServiceAddHostSetHostsBody {
    return ControllerApiServicesV1HostSetServiceAddHostSetHostsBodyFromJSONTyped(json, false);
}

export function ControllerApiServicesV1HostSetServiceAddHostSetHostsBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1HostSetServiceAddHostSetHostsBody {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiServicesV1HostSetServiceAddHostSetHostsBodyToJSON(json: any): ControllerApiServicesV1HostSetServiceAddHostSetHostsBody {
    return ControllerApiServicesV1HostSetServiceAddHostSetHostsBodyToJSONTyped(json, false);
}

export function ControllerApiServicesV1HostSetServiceAddHostSetHostsBodyToJSONTyped(value?: ControllerApiServicesV1HostSetServiceAddHostSetHostsBody | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
