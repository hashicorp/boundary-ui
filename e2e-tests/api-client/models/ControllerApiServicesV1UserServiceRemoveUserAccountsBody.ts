 ...
 * 
 * @export
 * @interface ControllerApiServicesV1UserServiceRemoveUserAccountsBody
 */
export interface ControllerApiServicesV1UserServiceRemoveUserAccountsBody {
    /**
     * The version ensures the User hasn't changed since it was last retrieved and if it has the request will fail.
     * @type {number}
     * @memberof ControllerApiServicesV1UserServiceRemoveUserAccountsBody
     */
    version?: number;
    /**
     * 
...
/**
 * Check if a given object implements the ControllerApiServicesV1UserServiceRemoveUserAccountsBody interface.
 */
export function instanceOfControllerApiServicesV1UserServiceRemoveUserAccountsBody(value: object): value is ControllerApiServicesV1UserServiceRemoveUserAccountsBody {
    return true;
}

export function ControllerApiServicesV1UserServiceRemoveUserAccountsBodyFromJSON(json: any): ControllerApiServicesV1UserServiceRemoveUserAccountsBody {
    return ControllerApiServicesV1UserServiceRemoveUserAccountsBodyFromJSONTyped(json, false);
}

export function ControllerApiServicesV1UserServiceRemoveUserAccountsBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1UserServiceRemoveUserAccountsBody {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiServicesV1UserServiceRemoveUserAccountsBodyToJSON(json: any): ControllerApiServicesV1UserServiceRemoveUserAccountsBody {
    return ControllerApiServicesV1UserServiceRemoveUserAccountsBodyToJSONTyped(json, false);
}

export function ControllerApiServicesV1UserServiceRemoveUserAccountsBodyToJSONTyped(value?: ControllerApiServicesV1UserServiceRemoveUserAccountsBody | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
