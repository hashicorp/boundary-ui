...
import type { ControllerApiResourcesUsersV1User } from './ControllerApiResourcesUsersV1User';
import {
    ControllerApiResourcesUsersV1UserFromJSON,
    ControllerApiResourcesUsersV1UserFromJSONTyped,
    ControllerApiResourcesUsersV1UserToJSON,
    ControllerApiResourcesUsersV1UserToJSONTyped,
} from './ControllerApiResourcesUsersV1User';

/**
 * 
 * @export
 * @interface ControllerApiServicesV1RemoveUserAccountsResponse
 */
export interface ControllerApiServicesV1RemoveUserAccountsResponse {
    /**
     * 
     * @type {ControllerApiResourcesUsersV1User}
     * @memberof ControllerApiServicesV1RemoveUserAccountsResponse
     */
    item?: ControllerApiResourcesUsersV1User;
}

/**
 * Check if a given object implements the ControllerApiServicesV1RemoveUserAccountsResponse interface.
 */
export function instanceOfControllerApiServicesV1RemoveUserAccountsResponse(value: object): value is ControllerApiServicesV1RemoveUserAccountsResponse {
    return true;
}

export function ControllerApiServicesV1RemoveUserAccountsResponseFromJSON(json: any): ControllerApiServicesV1RemoveUserAccountsResponse {
    return ControllerApiServicesV1RemoveUserAccountsResponseFromJSONTyped(json, false);
}

export function ControllerApiServicesV1RemoveUserAccountsResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1RemoveUserAccountsResponse {
    if (json == null) {
        return json;
    }
    return {
        
        'item': json['item'] == null ? undefined : ControllerApiResourcesUsersV1UserFromJSON(json['item']),
    };
}

export function ControllerApiServicesV1RemoveUserAccountsResponseToJSON(json: any): ControllerApiServicesV1RemoveUserAccountsResponse {
    return ControllerApiServicesV1RemoveUserAccountsResponseToJSONTyped(json, false);
}

export function ControllerApiServicesV1RemoveUserAccountsResponseToJSONTyped(value?: ControllerApiServicesV1RemoveUserAccountsResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'item': ControllerApiResourcesUsersV1UserToJSON(value['item']),
    };
}
