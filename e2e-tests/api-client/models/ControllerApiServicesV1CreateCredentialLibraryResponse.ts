 ...
 * 
 * @export
 * @interface ControllerApiServicesV1CreateCredentialLibraryResponse
 */
export interface ControllerApiServicesV1CreateCredentialLibraryResponse {
    /**
     * 
     * @type {string}
     * @memberof ControllerApiServicesV1CreateCredentialLibraryResponse
     */
    uri?: string;
    /**
     * 
     * @type {ControllerApiResourcesCredentiallibrariesV1CredentialLibrary}
     * @memberof ControllerApiServicesV1CreateCredentialLibraryResponse
     */
    item?: ControllerApiResourcesCredentiallibrariesV1CredentialLibrary;
}

/**
 * Check if a given object implements the ControllerApiServicesV1CreateCredentialLibraryResponse interface.
 */
export function instanceOfControllerApiServicesV1CreateCredentialLibraryResponse(value: object): value is ControllerApiServicesV1CreateCredentialLibraryResponse {
    return true;
}

export function ControllerApiServicesV1CreateCredentialLibraryResponseFromJSON(json: any): ControllerApiServicesV1CreateCredentialLibraryResponse {
    return ControllerApiServicesV1CreateCredentialLibraryResponseFromJSONTyped(json, false);
}

export function ControllerApiServicesV1CreateCredentialLibraryResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1CreateCredentialLibraryResponse {
    if (json == null) {
        return json;
    }
    return {
        ...
        'item': json['item'] == null ? undefined : ControllerApiResourcesCredentiallibrariesV1CredentialLibraryFromJSON(json['item']),
    };
}

export function ControllerApiServicesV1CreateCredentialLibraryResponseToJSON(json: any): ControllerApiServicesV1CreateCredentialLibraryResponse {
    return ControllerApiServicesV1CreateCredentialLibraryResponseToJSONTyped(json, false);
}

export function ControllerApiServicesV1CreateCredentialLibraryResponseToJSONTyped(value?: ControllerApiServicesV1CreateCredentialLibraryResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'uri': value['uri'],
        'item': ControllerApiResourcesCredentiallibrariesV1CredentialLibraryToJSON(value['item']),
    };
}
