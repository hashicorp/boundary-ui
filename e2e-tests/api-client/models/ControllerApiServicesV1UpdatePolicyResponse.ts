 ...
 * 
 * @export
 * @interface ControllerApiServicesV1UpdatePolicyResponse
 */
export interface ControllerApiServicesV1UpdatePolicyResponse {
    /**
     * 
     * @type {ControllerApiResourcesPoliciesV1Policy}
     * @memberof ControllerApiServicesV1UpdatePolicyResponse
     */
    item?: ControllerApiResourcesPoliciesV1Policy;
}

/**
 * Check if a given object implements the ControllerApiServicesV1UpdatePolicyResponse interface.
 */
export function instanceOfControllerApiServicesV1UpdatePolicyResponse(value: object): value is ControllerApiServicesV1UpdatePolicyResponse {
    return true;
}

export function ControllerApiServicesV1UpdatePolicyResponseFromJSON(json: any): ControllerApiServicesV1UpdatePolicyResponse {
    return ControllerApiServicesV1UpdatePolicyResponseFromJSONTyped(json, false);
}

export function ControllerApiServicesV1UpdatePolicyResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1UpdatePolicyResponse {
    if (json == null) {
        return json;
    }
    return {
        
        'item': json['item'] == null ? undefined : ControllerApiResourcesPoliciesV1PolicyFromJSON(json['item']),
    };
}

export function ControllerApiServicesV1UpdatePolicyResponseToJSON(json: any): ControllerApiServicesV1UpdatePolicyResponse {
    return ControllerApiServicesV1UpdatePolicyResponseToJSONTyped(json, false);
}

export function ControllerApiServicesV1UpdatePolicyResponseToJSONTyped(value?: ControllerApiServicesV1UpdatePolicyResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'item': ControllerApiResourcesPoliciesV1PolicyToJSON(value['item']),
    };
}
