 ...
 * 
 * @export
 * @interface ControllerApiResourcesSessionrecordingsV1CredentialStore
 */
export interface ControllerApiResourcesSessionrecordingsV1CredentialStore {
    /**
     * The ID of the Credential Store.
     * @type {string}
     * @memberof ControllerApiResourcesSessionrecordingsV1CredentialStore
     */
    id?: string;
    /**
...
/**
 * Check if a given object implements the ControllerApiResourcesSessionrecordingsV1CredentialStore interface.
 */
export function instanceOfControllerApiResourcesSessionrecordingsV1CredentialStore(value: object): value is ControllerApiResourcesSessionrecordingsV1CredentialStore {
    return true;
}

export function ControllerApiResourcesSessionrecordingsV1CredentialStoreFromJSON(json: any): ControllerApiResourcesSessionrecordingsV1CredentialStore {
    return ControllerApiResourcesSessionrecordingsV1CredentialStoreFromJSONTyped(json, false);
}

export function ControllerApiResourcesSessionrecordingsV1CredentialStoreFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiResourcesSessionrecordingsV1CredentialStore {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiResourcesSessionrecordingsV1CredentialStoreToJSON(json: any): ControllerApiResourcesSessionrecordingsV1CredentialStore {
    return ControllerApiResourcesSessionrecordingsV1CredentialStoreToJSONTyped(json, false);
}

export function ControllerApiResourcesSessionrecordingsV1CredentialStoreToJSONTyped(value?: ControllerApiResourcesSessionrecordingsV1CredentialStore | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
