 ...
 * 
 * @export
 * @interface ControllerApiServicesV1ListRolesResponse
 */
export interface ControllerApiServicesV1ListRolesResponse {
    /**
     * 
     * @type {Array<ControllerApiResourcesRolesV1Role>}
     * @memberof ControllerApiServicesV1ListRolesResponse
     */
    items?: Array<ControllerApiResourcesRolesV1Role>;
    /**
...
/**
 * Check if a given object implements the ControllerApiServicesV1ListRolesResponse interface.
 */
export function instanceOfControllerApiServicesV1ListRolesResponse(value: object): value is ControllerApiServicesV1ListRolesResponse {
    return true;
}

export function ControllerApiServicesV1ListRolesResponseFromJSON(json: any): ControllerApiServicesV1ListRolesResponse {
    return ControllerApiServicesV1ListRolesResponseFromJSONTyped(json, false);
}

export function ControllerApiServicesV1ListRolesResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1ListRolesResponse {
    if (json == null) {
        return json;
    }
    return {
        
        'items': json['items'] == null ? undefined : ((json['items'] as Array<any>).map(ControllerApiResourcesRolesV1RoleFromJSON)),
...
export function ControllerApiServicesV1ListRolesResponseToJSON(json: any): ControllerApiServicesV1ListRolesResponse {
    return ControllerApiServicesV1ListRolesResponseToJSONTyped(json, false);
}

export function ControllerApiServicesV1ListRolesResponseToJSONTyped(value?: ControllerApiServicesV1ListRolesResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'items': value['items'] == null ? undefined : ((value['items'] as Array<any>).map(ControllerApiResourcesRolesV1RoleToJSON)),
