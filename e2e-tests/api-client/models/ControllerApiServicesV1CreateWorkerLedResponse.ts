 ...
 * 
 * @export
 * @interface ControllerApiServicesV1CreateWorkerLedResponse
 */
export interface ControllerApiServicesV1CreateWorkerLedResponse {
    /**
     * 
     * @type {string}
     * @memberof ControllerApiServicesV1CreateWorkerLedResponse
     */
    uri?: string;
    /**
     * 
...
/**
 * Check if a given object implements the ControllerApiServicesV1CreateWorkerLedResponse interface.
 */
export function instanceOfControllerApiServicesV1CreateWorkerLedResponse(value: object): value is ControllerApiServicesV1CreateWorkerLedResponse {
    return true;
}

export function ControllerApiServicesV1CreateWorkerLedResponseFromJSON(json: any): ControllerApiServicesV1CreateWorkerLedResponse {
    return ControllerApiServicesV1CreateWorkerLedResponseFromJSONTyped(json, false);
}

export function ControllerApiServicesV1CreateWorkerLedResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1CreateWorkerLedResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiServicesV1CreateWorkerLedResponseToJSON(json: any): ControllerApiServicesV1CreateWorkerLedResponse {
    return ControllerApiServicesV1CreateWorkerLedResponseToJSONTyped(json, false);
}

export function ControllerApiServicesV1CreateWorkerLedResponseToJSONTyped(value?: ControllerApiServicesV1CreateWorkerLedResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
