 ...
 * 
 * @export
 * @interface ControllerApiServicesV1CreateGroupResponse
 */
export interface ControllerApiServicesV1CreateGroupResponse {
    /**
     * 
     * @type {string}
     * @memberof ControllerApiServicesV1CreateGroupResponse
     */
    uri?: string;
    /**
     * 
...
/**
 * Check if a given object implements the ControllerApiServicesV1CreateGroupResponse interface.
 */
export function instanceOfControllerApiServicesV1CreateGroupResponse(value: object): value is ControllerApiServicesV1CreateGroupResponse {
    return true;
}

export function ControllerApiServicesV1CreateGroupResponseFromJSON(json: any): ControllerApiServicesV1CreateGroupResponse {
    return ControllerApiServicesV1CreateGroupResponseFromJSONTyped(json, false);
}

export function ControllerApiServicesV1CreateGroupResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1CreateGroupResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiServicesV1CreateGroupResponseToJSON(json: any): ControllerApiServicesV1CreateGroupResponse {
    return ControllerApiServicesV1CreateGroupResponseToJSONTyped(json, false);
}

export function ControllerApiServicesV1CreateGroupResponseToJSONTyped(value?: ControllerApiServicesV1CreateGroupResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
