 ...
 * 
 * @export
 * @interface ControllerApiServicesV1UserServiceAddUserAccountsBody
 */
export interface ControllerApiServicesV1UserServiceAddUserAccountsBody {
    /**
     * The version ensures the User hasn't changed since it was last retrieved and if it has the request will fail.
     * @type {number}
     * @memberof ControllerApiServicesV1UserServiceAddUserAccountsBody
     */
    version?: number;
    /**
     * 
...
/**
 * Check if a given object implements the ControllerApiServicesV1UserServiceAddUserAccountsBody interface.
 */
export function instanceOfControllerApiServicesV1UserServiceAddUserAccountsBody(value: object): value is ControllerApiServicesV1UserServiceAddUserAccountsBody {
    return true;
}

export function ControllerApiServicesV1UserServiceAddUserAccountsBodyFromJSON(json: any): ControllerApiServicesV1UserServiceAddUserAccountsBody {
    return ControllerApiServicesV1UserServiceAddUserAccountsBodyFromJSONTyped(json, false);
}

export function ControllerApiServicesV1UserServiceAddUserAccountsBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1UserServiceAddUserAccountsBody {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiServicesV1UserServiceAddUserAccountsBodyToJSON(json: any): ControllerApiServicesV1UserServiceAddUserAccountsBody {
    return ControllerApiServicesV1UserServiceAddUserAccountsBodyToJSONTyped(json, false);
}

export function ControllerApiServicesV1UserServiceAddUserAccountsBodyToJSONTyped(value?: ControllerApiServicesV1UserServiceAddUserAccountsBody | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
