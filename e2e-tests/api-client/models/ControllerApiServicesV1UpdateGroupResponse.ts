 ...
 * 
 * @export
 * @interface ControllerApiServicesV1UpdateGroupResponse
 */
export interface ControllerApiServicesV1UpdateGroupResponse {
    /**
     * 
     * @type {ControllerApiResourcesGroupsV1Group}
     * @memberof ControllerApiServicesV1UpdateGroupResponse
     */
    item?: ControllerApiResourcesGroupsV1Group;
}

/**
 * Check if a given object implements the ControllerApiServicesV1UpdateGroupResponse interface.
 */
export function instanceOfControllerApiServicesV1UpdateGroupResponse(value: object): value is ControllerApiServicesV1UpdateGroupResponse {
    return true;
}

export function ControllerApiServicesV1UpdateGroupResponseFromJSON(json: any): ControllerApiServicesV1UpdateGroupResponse {
    return ControllerApiServicesV1UpdateGroupResponseFromJSONTyped(json, false);
}

export function ControllerApiServicesV1UpdateGroupResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1UpdateGroupResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiServicesV1UpdateGroupResponseToJSON(json: any): ControllerApiServicesV1UpdateGroupResponse {
    return ControllerApiServicesV1UpdateGroupResponseToJSONTyped(json, false);
}

export function ControllerApiServicesV1UpdateGroupResponseToJSONTyped(value?: ControllerApiServicesV1UpdateGroupResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
