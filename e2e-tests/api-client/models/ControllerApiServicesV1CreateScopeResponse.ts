 ...
 * 
 * @export
 * @interface ControllerApiServicesV1CreateScopeResponse
 */
export interface ControllerApiServicesV1CreateScopeResponse {
    /**
     * 
     * @type {string}
     * @memberof ControllerApiServicesV1CreateScopeResponse
     */
    uri?: string;
    /**
     * 
...
/**
 * Check if a given object implements the ControllerApiServicesV1CreateScopeResponse interface.
 */
export function instanceOfControllerApiServicesV1CreateScopeResponse(value: object): value is ControllerApiServicesV1CreateScopeResponse {
    return true;
}

export function ControllerApiServicesV1CreateScopeResponseFromJSON(json: any): ControllerApiServicesV1CreateScopeResponse {
    return ControllerApiServicesV1CreateScopeResponseFromJSONTyped(json, false);
}

export function ControllerApiServicesV1CreateScopeResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1CreateScopeResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiServicesV1CreateScopeResponseToJSON(json: any): ControllerApiServicesV1CreateScopeResponse {
    return ControllerApiServicesV1CreateScopeResponseToJSONTyped(json, false);
}

export function ControllerApiServicesV1CreateScopeResponseToJSONTyped(value?: ControllerApiServicesV1CreateScopeResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
