 ...
 * 
 * @export
 * @interface ControllerApiServicesV1SessionServiceCancelSessionBody
 */
export interface ControllerApiServicesV1SessionServiceCancelSessionBody {
    /**
     * 
     * @type {number}
     * @memberof ControllerApiServicesV1SessionServiceCancelSessionBody
     */
    version?: number;
}

/**
 * Check if a given object implements the ControllerApiServicesV1SessionServiceCancelSessionBody interface.
 */
export function instanceOfControllerApiServicesV1SessionServiceCancelSessionBody(value: object): value is ControllerApiServicesV1SessionServiceCancelSessionBody {
    return true;
}

export function ControllerApiServicesV1SessionServiceCancelSessionBodyFromJSON(json: any): ControllerApiServicesV1SessionServiceCancelSessionBody {
    return ControllerApiServicesV1SessionServiceCancelSessionBodyFromJSONTyped(json, false);
}

export function ControllerApiServicesV1SessionServiceCancelSessionBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1SessionServiceCancelSessionBody {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiServicesV1SessionServiceCancelSessionBodyToJSON(json: any): ControllerApiServicesV1SessionServiceCancelSessionBody {
    return ControllerApiServicesV1SessionServiceCancelSessionBodyToJSONTyped(json, false);
}

export function ControllerApiServicesV1SessionServiceCancelSessionBodyToJSONTyped(value?: ControllerApiServicesV1SessionServiceCancelSessionBody | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
