...
import type { ControllerApiResourcesAccountsV1Account } from './ControllerApiResourcesAccountsV1Account';
import {
    ControllerApiResourcesAccountsV1AccountFromJSON,
    ControllerApiResourcesAccountsV1AccountFromJSONTyped,
    ControllerApiResourcesAccountsV1AccountToJSON,
    ControllerApiResourcesAccountsV1AccountToJSONTyped,
} from './ControllerApiResourcesAccountsV1Account';

/**
 * 
 * @export
 * @interface ControllerApiServicesV1ListAccountsResponse
 */
export interface ControllerApiServicesV1ListAccountsResponse {
    /**
     * The list of accounts.
     * @type {Array<ControllerApiResourcesAccountsV1Account>}
     * @memberof ControllerApiServicesV1ListAccountsResponse
     */
    items?: Array<ControllerApiResourcesAccountsV1Account>;
    /**
...
/**
 * Check if a given object implements the ControllerApiServicesV1ListAccountsResponse interface.
 */
export function instanceOfControllerApiServicesV1ListAccountsResponse(value: object): value is ControllerApiServicesV1ListAccountsResponse {
    return true;
}

export function ControllerApiServicesV1ListAccountsResponseFromJSON(json: any): ControllerApiServicesV1ListAccountsResponse {
    return ControllerApiServicesV1ListAccountsResponseFromJSONTyped(json, false);
}

export function ControllerApiServicesV1ListAccountsResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1ListAccountsResponse {
    if (json == null) {
        return json;
    }
    return {
        
        'items': json['items'] == null ? undefined : ((json['items'] as Array<any>).map(ControllerApiResourcesAccountsV1AccountFromJSON)),
...
export function ControllerApiServicesV1ListAccountsResponseToJSON(json: any): ControllerApiServicesV1ListAccountsResponse {
    return ControllerApiServicesV1ListAccountsResponseToJSONTyped(json, false);
}

export function ControllerApiServicesV1ListAccountsResponseToJSONTyped(value?: ControllerApiServicesV1ListAccountsResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'items': value['items'] == null ? undefined : ((value['items'] as Array<any>).map(ControllerApiResourcesAccountsV1AccountToJSON)),
