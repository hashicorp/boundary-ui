 ...
 * 
 * @export
 * @interface ControllerApiResourcesGroupsV1Member
 */
export interface ControllerApiResourcesGroupsV1Member {
    /**
     * Output only. The ID of the member.
     * @type {string}
     * @memberof ControllerApiResourcesGroupsV1Member
     */
    readonly id?: string;
    /**
...
/**
 * Check if a given object implements the ControllerApiResourcesGroupsV1Member interface.
 */
export function instanceOfControllerApiResourcesGroupsV1Member(value: object): value is ControllerApiResourcesGroupsV1Member {
    return true;
}

export function ControllerApiResourcesGroupsV1MemberFromJSON(json: any): ControllerApiResourcesGroupsV1Member {
    return ControllerApiResourcesGroupsV1MemberFromJSONTyped(json, false);
}

export function ControllerApiResourcesGroupsV1MemberFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiResourcesGroupsV1Member {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiResourcesGroupsV1MemberToJSON(json: any): ControllerApiResourcesGroupsV1Member {
    return ControllerApiResourcesGroupsV1MemberToJSONTyped(json, false);
}

export function ControllerApiResourcesGroupsV1MemberToJSONTyped(value?: Omit<ControllerApiResourcesGroupsV1Member, 'id'|'scope_id'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
