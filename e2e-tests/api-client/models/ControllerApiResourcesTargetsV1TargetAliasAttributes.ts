...
import type { ControllerApiResourcesTargetsV1AuthorizeSessionArguments } from './ControllerApiResourcesTargetsV1AuthorizeSessionArguments';
import {
    ControllerApiResourcesTargetsV1AuthorizeSessionArgumentsFromJSON,
    ControllerApiResourcesTargetsV1AuthorizeSessionArgumentsFromJSONTyped,
    ControllerApiResourcesTargetsV1AuthorizeSessionArgumentsToJSON,
    ControllerApiResourcesTargetsV1AuthorizeSessionArgumentsToJSONTyped,
} from './ControllerApiResourcesTargetsV1AuthorizeSessionArguments';

/**
 * 
 * @export
 * @interface ControllerApiResourcesTargetsV1TargetAliasAttributes
 */
export interface ControllerApiResourcesTargetsV1TargetAliasAttributes {
    /**
     * 
     * @type {ControllerApiResourcesTargetsV1AuthorizeSessionArguments}
     * @memberof ControllerApiResourcesTargetsV1TargetAliasAttributes
     */
    authorizeSessionArguments?: ControllerApiResourcesTargetsV1AuthorizeSessionArguments;
}

/**
 * Check if a given object implements the ControllerApiResourcesTargetsV1TargetAliasAttributes interface.
 */
export function instanceOfControllerApiResourcesTargetsV1TargetAliasAttributes(value: object): value is ControllerApiResourcesTargetsV1TargetAliasAttributes {
    return true;
}

export function ControllerApiResourcesTargetsV1TargetAliasAttributesFromJSON(json: any): ControllerApiResourcesTargetsV1TargetAliasAttributes {
    return ControllerApiResourcesTargetsV1TargetAliasAttributesFromJSONTyped(json, false);
}

export function ControllerApiResourcesTargetsV1TargetAliasAttributesFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiResourcesTargetsV1TargetAliasAttributes {
    if (json == null) {
        return json;
    }
    return {
        
        'authorizeSessionArguments': json['authorize_session_arguments'] == null ? undefined : ControllerApiResourcesTargetsV1AuthorizeSessionArgumentsFromJSON(json['authorize_session_arguments']),
    };
}

export function ControllerApiResourcesTargetsV1TargetAliasAttributesToJSON(json: any): ControllerApiResourcesTargetsV1TargetAliasAttributes {
    return ControllerApiResourcesTargetsV1TargetAliasAttributesToJSONTyped(json, false);
}

export function ControllerApiResourcesTargetsV1TargetAliasAttributesToJSONTyped(value?: ControllerApiResourcesTargetsV1TargetAliasAttributes | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'authorize_session_arguments': ControllerApiResourcesTargetsV1AuthorizeSessionArgumentsToJSON(value['authorizeSessionArguments']),
    };
}
