 ...
 * 
 * @export
 * @interface ControllerApiResourcesManagedgroupsV1ManagedGroup
 */
export interface ControllerApiResourcesManagedgroupsV1ManagedGroup {
    /**
     * Output only. The ID of the ManagedGroup.
     * @type {string}
     * @memberof ControllerApiResourcesManagedgroupsV1ManagedGroup
     */
    readonly id?: string;
    /**
     * 
...
/**
 * Check if a given object implements the ControllerApiResourcesManagedgroupsV1ManagedGroup interface.
 */
export function instanceOfControllerApiResourcesManagedgroupsV1ManagedGroup(value: object): value is ControllerApiResourcesManagedgroupsV1ManagedGroup {
    return true;
}

export function ControllerApiResourcesManagedgroupsV1ManagedGroupFromJSON(json: any): ControllerApiResourcesManagedgroupsV1ManagedGroup {
    return ControllerApiResourcesManagedgroupsV1ManagedGroupFromJSONTyped(json, false);
}

export function ControllerApiResourcesManagedgroupsV1ManagedGroupFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiResourcesManagedgroupsV1ManagedGroup {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiResourcesManagedgroupsV1ManagedGroupToJSON(json: any): ControllerApiResourcesManagedgroupsV1ManagedGroup {
    return ControllerApiResourcesManagedgroupsV1ManagedGroupToJSONTyped(json, false);
}

export function ControllerApiResourcesManagedgroupsV1ManagedGroupToJSONTyped(value?: Omit<ControllerApiResourcesManagedgroupsV1ManagedGroup, 'id'|'created_time'|'updated_time'|'member_ids'|'authorized_actions'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
