 ...
 * 
 * @export
 * @interface ControllerApiServicesV1SetWorkerTagsResponse
 */
export interface ControllerApiServicesV1SetWorkerTagsResponse {
    /**
     * 
     * @type {ControllerApiResourcesWorkersV1Worker}
     * @memberof ControllerApiServicesV1SetWorkerTagsResponse
     */
    item?: ControllerApiResourcesWorkersV1Worker;
}

/**
 * Check if a given object implements the ControllerApiServicesV1SetWorkerTagsResponse interface.
 */
export function instanceOfControllerApiServicesV1SetWorkerTagsResponse(value: object): value is ControllerApiServicesV1SetWorkerTagsResponse {
    return true;
}

export function ControllerApiServicesV1SetWorkerTagsResponseFromJSON(json: any): ControllerApiServicesV1SetWorkerTagsResponse {
    return ControllerApiServicesV1SetWorkerTagsResponseFromJSONTyped(json, false);
}

export function ControllerApiServicesV1SetWorkerTagsResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1SetWorkerTagsResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiServicesV1SetWorkerTagsResponseToJSON(json: any): ControllerApiServicesV1SetWorkerTagsResponse {
    return ControllerApiServicesV1SetWorkerTagsResponseToJSONTyped(json, false);
}

export function ControllerApiServicesV1SetWorkerTagsResponseToJSONTyped(value?: ControllerApiServicesV1SetWorkerTagsResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
