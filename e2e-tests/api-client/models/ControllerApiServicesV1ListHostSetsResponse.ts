 ...
 * 
 * @export
 * @interface ControllerApiServicesV1ListHostSetsResponse
 */
export interface ControllerApiServicesV1ListHostSetsResponse {
    /**
     * 
     * @type {Array<ControllerApiResourcesHostsetsV1HostSet>}
     * @memberof ControllerApiServicesV1ListHostSetsResponse
     */
    items?: Array<ControllerApiResourcesHostsetsV1HostSet>;
    /**
...
/**
 * Check if a given object implements the ControllerApiServicesV1ListHostSetsResponse interface.
 */
export function instanceOfControllerApiServicesV1ListHostSetsResponse(value: object): value is ControllerApiServicesV1ListHostSetsResponse {
    return true;
}

export function ControllerApiServicesV1ListHostSetsResponseFromJSON(json: any): ControllerApiServicesV1ListHostSetsResponse {
    return ControllerApiServicesV1ListHostSetsResponseFromJSONTyped(json, false);
}

export function ControllerApiServicesV1ListHostSetsResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1ListHostSetsResponse {
    if (json == null) {
        return json;
    }
    return {
        
        'items': json['items'] == null ? undefined : ((json['items'] as Array<any>).map(ControllerApiResourcesHostsetsV1HostSetFromJSON)),
...
export function ControllerApiServicesV1ListHostSetsResponseToJSON(json: any): ControllerApiServicesV1ListHostSetsResponse {
    return ControllerApiServicesV1ListHostSetsResponseToJSONTyped(json, false);
}

export function ControllerApiServicesV1ListHostSetsResponseToJSONTyped(value?: ControllerApiServicesV1ListHostSetsResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'items': value['items'] == null ? undefined : ((value['items'] as Array<any>).map(ControllerApiResourcesHostsetsV1HostSetToJSON)),
