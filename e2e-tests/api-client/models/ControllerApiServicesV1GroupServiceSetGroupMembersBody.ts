 ...
 * 
 * @export
 * @interface ControllerApiServicesV1GroupServiceSetGroupMembersBody
 */
export interface ControllerApiServicesV1GroupServiceSetGroupMembersBody {
    /**
     * Version is used to ensure this resource has not changed.
     * The mutation will fail if the version does not match the latest known good version.
     * @type {number}
     * @memberof ControllerApiServicesV1GroupServiceSetGroupMembersBody
     */
    version?: number;
    /**
     * 
...
/**
 * Check if a given object implements the ControllerApiServicesV1GroupServiceSetGroupMembersBody interface.
 */
export function instanceOfControllerApiServicesV1GroupServiceSetGroupMembersBody(value: object): value is ControllerApiServicesV1GroupServiceSetGroupMembersBody {
    return true;
}

export function ControllerApiServicesV1GroupServiceSetGroupMembersBodyFromJSON(json: any): ControllerApiServicesV1GroupServiceSetGroupMembersBody {
    return ControllerApiServicesV1GroupServiceSetGroupMembersBodyFromJSONTyped(json, false);
}

export function ControllerApiServicesV1GroupServiceSetGroupMembersBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1GroupServiceSetGroupMembersBody {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiServicesV1GroupServiceSetGroupMembersBodyToJSON(json: any): ControllerApiServicesV1GroupServiceSetGroupMembersBody {
    return ControllerApiServicesV1GroupServiceSetGroupMembersBodyToJSONTyped(json, false);
}

export function ControllerApiServicesV1GroupServiceSetGroupMembersBodyToJSONTyped(value?: ControllerApiServicesV1GroupServiceSetGroupMembersBody | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
