 ...
 * 
 * @export
 * @interface ControllerApiServicesV1ReApplyStoragePolicyResponse
 */
export interface ControllerApiServicesV1ReApplyStoragePolicyResponse {
    /**
     * 
     * @type {ControllerApiResourcesSessionrecordingsV1SessionRecording}
     * @memberof ControllerApiServicesV1ReApplyStoragePolicyResponse
     */
    item?: ControllerApiResourcesSessionrecordingsV1SessionRecording;
}

/**
 * Check if a given object implements the ControllerApiServicesV1ReApplyStoragePolicyResponse interface.
 */
export function instanceOfControllerApiServicesV1ReApplyStoragePolicyResponse(value: object): value is ControllerApiServicesV1ReApplyStoragePolicyResponse {
    return true;
}

export function ControllerApiServicesV1ReApplyStoragePolicyResponseFromJSON(json: any): ControllerApiServicesV1ReApplyStoragePolicyResponse {
    return ControllerApiServicesV1ReApplyStoragePolicyResponseFromJSONTyped(json, false);
}

export function ControllerApiServicesV1ReApplyStoragePolicyResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1ReApplyStoragePolicyResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiServicesV1ReApplyStoragePolicyResponseToJSON(json: any): ControllerApiServicesV1ReApplyStoragePolicyResponse {
    return ControllerApiServicesV1ReApplyStoragePolicyResponseToJSONTyped(json, false);
}

export function ControllerApiServicesV1ReApplyStoragePolicyResponseToJSONTyped(value?: ControllerApiServicesV1ReApplyStoragePolicyResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
