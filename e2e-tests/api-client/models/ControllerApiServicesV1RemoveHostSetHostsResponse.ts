...
import type { ControllerApiResourcesHostsetsV1HostSet } from './ControllerApiResourcesHostsetsV1HostSet';
import {
    ControllerApiResourcesHostsetsV1HostSetFromJSON,
    ControllerApiResourcesHostsetsV1HostSetFromJSONTyped,
    ControllerApiResourcesHostsetsV1HostSetToJSON,
    ControllerApiResourcesHostsetsV1HostSetToJSONTyped,
} from './ControllerApiResourcesHostsetsV1HostSet';

/**
 * 
 * @export
 * @interface ControllerApiServicesV1RemoveHostSetHostsResponse
 */
export interface ControllerApiServicesV1RemoveHostSetHostsResponse {
    /**
     * 
     * @type {ControllerApiResourcesHostsetsV1HostSet}
     * @memberof ControllerApiServicesV1RemoveHostSetHostsResponse
     */
    item?: ControllerApiResourcesHostsetsV1HostSet;
}

/**
 * Check if a given object implements the ControllerApiServicesV1RemoveHostSetHostsResponse interface.
 */
export function instanceOfControllerApiServicesV1RemoveHostSetHostsResponse(value: object): value is ControllerApiServicesV1RemoveHostSetHostsResponse {
    return true;
}

export function ControllerApiServicesV1RemoveHostSetHostsResponseFromJSON(json: any): ControllerApiServicesV1RemoveHostSetHostsResponse {
    return ControllerApiServicesV1RemoveHostSetHostsResponseFromJSONTyped(json, false);
}

export function ControllerApiServicesV1RemoveHostSetHostsResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1RemoveHostSetHostsResponse {
    if (json == null) {
        return json;
    }
    return {
        
        'item': json['item'] == null ? undefined : ControllerApiResourcesHostsetsV1HostSetFromJSON(json['item']),
    };
}

export function ControllerApiServicesV1RemoveHostSetHostsResponseToJSON(json: any): ControllerApiServicesV1RemoveHostSetHostsResponse {
    return ControllerApiServicesV1RemoveHostSetHostsResponseToJSONTyped(json, false);
}

export function ControllerApiServicesV1RemoveHostSetHostsResponseToJSONTyped(value?: ControllerApiServicesV1RemoveHostSetHostsResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'item': ControllerApiResourcesHostsetsV1HostSetToJSON(value['item']),
    };
}
