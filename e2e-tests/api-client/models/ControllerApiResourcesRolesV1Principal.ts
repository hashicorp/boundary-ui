 ...
 * 
 * @export
 * @interface ControllerApiResourcesRolesV1Principal
 */
export interface ControllerApiResourcesRolesV1Principal {
    /**
     * Output only. The ID of the principal.
     * @type {string}
     * @memberof ControllerApiResourcesRolesV1Principal
     */
    readonly id?: string;
    /**
...
/**
 * Check if a given object implements the ControllerApiResourcesRolesV1Principal interface.
 */
export function instanceOfControllerApiResourcesRolesV1Principal(value: object): value is ControllerApiResourcesRolesV1Principal {
    return true;
}

export function ControllerApiResourcesRolesV1PrincipalFromJSON(json: any): ControllerApiResourcesRolesV1Principal {
    return ControllerApiResourcesRolesV1PrincipalFromJSONTyped(json, false);
}

export function ControllerApiResourcesRolesV1PrincipalFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiResourcesRolesV1Principal {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiResourcesRolesV1PrincipalToJSON(json: any): ControllerApiResourcesRolesV1Principal {
    return ControllerApiResourcesRolesV1PrincipalToJSONTyped(json, false);
}

export function ControllerApiResourcesRolesV1PrincipalToJSONTyped(value?: Omit<ControllerApiResourcesRolesV1Principal, 'id'|'type'|'scope_id'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
