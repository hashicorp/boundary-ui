 ...
 * 
 * @export
 * @interface ControllerApiServicesV1ListScopesResponse
 */
export interface ControllerApiServicesV1ListScopesResponse {
    /**
     * The items returned in this page.
     * @type {Array<ControllerApiResourcesScopesV1Scope>}
     * @memberof ControllerApiServicesV1ListScopesResponse
     */
    items?: Array<ControllerApiResourcesScopesV1Scope>;
    /**
...
/**
 * Check if a given object implements the ControllerApiServicesV1ListScopesResponse interface.
 */
export function instanceOfControllerApiServicesV1ListScopesResponse(value: object): value is ControllerApiServicesV1ListScopesResponse {
    return true;
}

export function ControllerApiServicesV1ListScopesResponseFromJSON(json: any): ControllerApiServicesV1ListScopesResponse {
    return ControllerApiServicesV1ListScopesResponseFromJSONTyped(json, false);
}

export function ControllerApiServicesV1ListScopesResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1ListScopesResponse {
    if (json == null) {
        return json;
    }
    return {
        
        'items': json['items'] == null ? undefined : ((json['items'] as Array<any>).map(ControllerApiResourcesScopesV1ScopeFromJSON)),
...
export function ControllerApiServicesV1ListScopesResponseToJSON(json: any): ControllerApiServicesV1ListScopesResponse {
    return ControllerApiServicesV1ListScopesResponseToJSONTyped(json, false);
}

export function ControllerApiServicesV1ListScopesResponseToJSONTyped(value?: ControllerApiServicesV1ListScopesResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'items': value['items'] == null ? undefined : ((value['items'] as Array<any>).map(ControllerApiResourcesScopesV1ScopeToJSON)),
