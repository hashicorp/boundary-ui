 ...
 * 
 * @export
 * @interface ControllerApiServicesV1CreateCredentialStoreResponse
 */
export interface ControllerApiServicesV1CreateCredentialStoreResponse {
    /**
     * 
     * @type {string}
     * @memberof ControllerApiServicesV1CreateCredentialStoreResponse
     */
    uri?: string;
    /**
     * 
     * @type {ControllerApiResourcesCredentialstoresV1CredentialStore}
     * @memberof ControllerApiServicesV1CreateCredentialStoreResponse
     */
    item?: ControllerApiResourcesCredentialstoresV1CredentialStore;
}

/**
 * Check if a given object implements the ControllerApiServicesV1CreateCredentialStoreResponse interface.
 */
export function instanceOfControllerApiServicesV1CreateCredentialStoreResponse(value: object): value is ControllerApiServicesV1CreateCredentialStoreResponse {
    return true;
}

export function ControllerApiServicesV1CreateCredentialStoreResponseFromJSON(json: any): ControllerApiServicesV1CreateCredentialStoreResponse {
    return ControllerApiServicesV1CreateCredentialStoreResponseFromJSONTyped(json, false);
}

export function ControllerApiServicesV1CreateCredentialStoreResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1CreateCredentialStoreResponse {
    if (json == null) {
        return json;
    }
    return {
        ...
        'item': json['item'] == null ? undefined : ControllerApiResourcesCredentialstoresV1CredentialStoreFromJSON(json['item']),
    };
}

export function ControllerApiServicesV1CreateCredentialStoreResponseToJSON(json: any): ControllerApiServicesV1CreateCredentialStoreResponse {
    return ControllerApiServicesV1CreateCredentialStoreResponseToJSONTyped(json, false);
}

export function ControllerApiServicesV1CreateCredentialStoreResponseToJSONTyped(value?: ControllerApiServicesV1CreateCredentialStoreResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'uri': value['uri'],
        'item': ControllerApiResourcesCredentialstoresV1CredentialStoreToJSON(value['item']),
    };
}
