 ...
 * 
 * @export
 * @interface ControllerApiServicesV1ScopeServiceDetachStoragePolicyBody
 */
export interface ControllerApiServicesV1ScopeServiceDetachStoragePolicyBody {
    /**
     * Version is used to ensure this resource has not changed.
     * The mutation will fail if the version does not match the latest known good version.
     * @type {number}
     * @memberof ControllerApiServicesV1ScopeServiceDetachStoragePolicyBody
     */
    version?: number;
}

/**
 * Check if a given object implements the ControllerApiServicesV1ScopeServiceDetachStoragePolicyBody interface.
 */
export function instanceOfControllerApiServicesV1ScopeServiceDetachStoragePolicyBody(value: object): value is ControllerApiServicesV1ScopeServiceDetachStoragePolicyBody {
    return true;
}

export function ControllerApiServicesV1ScopeServiceDetachStoragePolicyBodyFromJSON(json: any): ControllerApiServicesV1ScopeServiceDetachStoragePolicyBody {
    return ControllerApiServicesV1ScopeServiceDetachStoragePolicyBodyFromJSONTyped(json, false);
}

export function ControllerApiServicesV1ScopeServiceDetachStoragePolicyBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1ScopeServiceDetachStoragePolicyBody {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiServicesV1ScopeServiceDetachStoragePolicyBodyToJSON(json: any): ControllerApiServicesV1ScopeServiceDetachStoragePolicyBody {
    return ControllerApiServicesV1ScopeServiceDetachStoragePolicyBodyToJSONTyped(json, false);
}

export function ControllerApiServicesV1ScopeServiceDetachStoragePolicyBodyToJSONTyped(value?: ControllerApiServicesV1ScopeServiceDetachStoragePolicyBody | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
