 ...
 * 
 * @export
 * @interface ControllerApiResourcesAuthtokensV1AuthToken
 */
export interface ControllerApiResourcesAuthtokensV1AuthToken {
    /**
     * Output only. The ID of the Auth Token.
     * @type {string}
     * @memberof ControllerApiResourcesAuthtokensV1AuthToken
     */
    readonly id?: string;
    /**
     ...
     * @memberof ControllerApiResourcesAuthtokensV1AuthToken
     */
    readonly approximateLastUsedTime?: Date;
    /**
...
/**
 * Check if a given object implements the ControllerApiResourcesAuthtokensV1AuthToken interface.
 */
export function instanceOfControllerApiResourcesAuthtokensV1AuthToken(value: object): value is ControllerApiResourcesAuthtokensV1AuthToken {
    return true;
}

export function ControllerApiResourcesAuthtokensV1AuthTokenFromJSON(json: any): ControllerApiResourcesAuthtokensV1AuthToken {
    return ControllerApiResourcesAuthtokensV1AuthTokenFromJSONTyped(json, false);
}

export function ControllerApiResourcesAuthtokensV1AuthTokenFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiResourcesAuthtokensV1AuthToken {
    if (json == null) {
        return json;
    }
    return {
        ...
        'approximateLastUsedTime': json['approximate_last_used_time'] == null ? undefined : (new Date(json['approximate_last_used_time'])),
...
export function ControllerApiResourcesAuthtokensV1AuthTokenToJSON(json: any): ControllerApiResourcesAuthtokensV1AuthToken {
    return ControllerApiResourcesAuthtokensV1AuthTokenToJSONTyped(json, false);
}

export function ControllerApiResourcesAuthtokensV1AuthTokenToJSONTyped(value?: Omit<ControllerApiResourcesAuthtokensV1AuthToken, 'id'|'token'|'user_id'|'auth_method_id'|'account_id'|'created_time'|'updated_time'|'approximate_last_used_time'|'expiration_time'|'authorized_actions'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
