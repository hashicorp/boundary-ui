 ...
 * 
 * @export
 * @interface ControllerApiResourcesSessionsV1SessionState
 */
export interface ControllerApiResourcesSessionsV1SessionState {
    /**
     * The status of the Session, e.g. "pending", "active", "canceling", "terminated".
     * @type {string}
     * @memberof ControllerApiResourcesSessionsV1SessionState
     */
    status?: string;
    /**
...
/**
 * Check if a given object implements the ControllerApiResourcesSessionsV1SessionState interface.
 */
export function instanceOfControllerApiResourcesSessionsV1SessionState(value: object): value is ControllerApiResourcesSessionsV1SessionState {
    return true;
}

export function ControllerApiResourcesSessionsV1SessionStateFromJSON(json: any): ControllerApiResourcesSessionsV1SessionState {
    return ControllerApiResourcesSessionsV1SessionStateFromJSONTyped(json, false);
}

export function ControllerApiResourcesSessionsV1SessionStateFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiResourcesSessionsV1SessionState {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiResourcesSessionsV1SessionStateToJSON(json: any): ControllerApiResourcesSessionsV1SessionState {
    return ControllerApiResourcesSessionsV1SessionStateToJSONTyped(json, false);
}

export function ControllerApiResourcesSessionsV1SessionStateToJSONTyped(value?: Omit<ControllerApiResourcesSessionsV1SessionState, 'start_time'|'end_time'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
