 ...
 * 
 * @export
 * @interface ControllerApiServicesV1AddRoleGrantsResponse
 */
export interface ControllerApiServicesV1AddRoleGrantsResponse {
    /**
     * 
     * @type {ControllerApiResourcesRolesV1Role}
     * @memberof ControllerApiServicesV1AddRoleGrantsResponse
     */
    item?: ControllerApiResourcesRolesV1Role;
}

/**
 * Check if a given object implements the ControllerApiServicesV1AddRoleGrantsResponse interface.
 */
export function instanceOfControllerApiServicesV1AddRoleGrantsResponse(value: object): value is ControllerApiServicesV1AddRoleGrantsResponse {
    return true;
}

export function ControllerApiServicesV1AddRoleGrantsResponseFromJSON(json: any): ControllerApiServicesV1AddRoleGrantsResponse {
    return ControllerApiServicesV1AddRoleGrantsResponseFromJSONTyped(json, false);
}

export function ControllerApiServicesV1AddRoleGrantsResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1AddRoleGrantsResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiServicesV1AddRoleGrantsResponseToJSON(json: any): ControllerApiServicesV1AddRoleGrantsResponse {
    return ControllerApiServicesV1AddRoleGrantsResponseToJSONTyped(json, false);
}

export function ControllerApiServicesV1AddRoleGrantsResponseToJSONTyped(value?: ControllerApiServicesV1AddRoleGrantsResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
