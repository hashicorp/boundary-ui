 ...
 * 
 * @export
 * @interface ControllerApiServicesV1UpdateCredentialStoreResponse
 */
export interface ControllerApiServicesV1UpdateCredentialStoreResponse {
    /**
     * 
     * @type {ControllerApiResourcesCredentialstoresV1CredentialStore}
     * @memberof ControllerApiServicesV1UpdateCredentialStoreResponse
     */
    item?: ControllerApiResourcesCredentialstoresV1CredentialStore;
}

/**
 * Check if a given object implements the ControllerApiServicesV1UpdateCredentialStoreResponse interface.
 */
export function instanceOfControllerApiServicesV1UpdateCredentialStoreResponse(value: object): value is ControllerApiServicesV1UpdateCredentialStoreResponse {
    return true;
}

export function ControllerApiServicesV1UpdateCredentialStoreResponseFromJSON(json: any): ControllerApiServicesV1UpdateCredentialStoreResponse {
    return ControllerApiServicesV1UpdateCredentialStoreResponseFromJSONTyped(json, false);
}

export function ControllerApiServicesV1UpdateCredentialStoreResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1UpdateCredentialStoreResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiServicesV1UpdateCredentialStoreResponseToJSON(json: any): ControllerApiServicesV1UpdateCredentialStoreResponse {
    return ControllerApiServicesV1UpdateCredentialStoreResponseToJSONTyped(json, false);
}

export function ControllerApiServicesV1UpdateCredentialStoreResponseToJSONTyped(value?: ControllerApiServicesV1UpdateCredentialStoreResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
