 ...
 * 
 * @export
 * @interface ControllerApiServicesV1UpdateCredentialLibraryResponse
 */
export interface ControllerApiServicesV1UpdateCredentialLibraryResponse {
    /**
     * 
     * @type {ControllerApiResourcesCredentiallibrariesV1CredentialLibrary}
     * @memberof ControllerApiServicesV1UpdateCredentialLibraryResponse
     */
    item?: ControllerApiResourcesCredentiallibrariesV1CredentialLibrary;
}

/**
 * Check if a given object implements the ControllerApiServicesV1UpdateCredentialLibraryResponse interface.
 */
export function instanceOfControllerApiServicesV1UpdateCredentialLibraryResponse(value: object): value is ControllerApiServicesV1UpdateCredentialLibraryResponse {
    return true;
}

export function ControllerApiServicesV1UpdateCredentialLibraryResponseFromJSON(json: any): ControllerApiServicesV1UpdateCredentialLibraryResponse {
    return ControllerApiServicesV1UpdateCredentialLibraryResponseFromJSONTyped(json, false);
}

export function ControllerApiServicesV1UpdateCredentialLibraryResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1UpdateCredentialLibraryResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiServicesV1UpdateCredentialLibraryResponseToJSON(json: any): ControllerApiServicesV1UpdateCredentialLibraryResponse {
    return ControllerApiServicesV1UpdateCredentialLibraryResponseToJSONTyped(json, false);
}

export function ControllerApiServicesV1UpdateCredentialLibraryResponseToJSONTyped(value?: ControllerApiServicesV1UpdateCredentialLibraryResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
