 ...
 * 
 * @export
 * @interface ControllerApiServicesV1ListUsersResponse
 */
export interface ControllerApiServicesV1ListUsersResponse {
    /**
     * 
     * @type {Array<ControllerApiResourcesUsersV1User>}
     * @memberof ControllerApiServicesV1ListUsersResponse
     */
    items?: Array<ControllerApiResourcesUsersV1User>;
    /**
...
/**
 * Check if a given object implements the ControllerApiServicesV1ListUsersResponse interface.
 */
export function instanceOfControllerApiServicesV1ListUsersResponse(value: object): value is ControllerApiServicesV1ListUsersResponse {
    return true;
}

export function ControllerApiServicesV1ListUsersResponseFromJSON(json: any): ControllerApiServicesV1ListUsersResponse {
    return ControllerApiServicesV1ListUsersResponseFromJSONTyped(json, false);
}

export function ControllerApiServicesV1ListUsersResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1ListUsersResponse {
    if (json == null) {
        return json;
    }
    return {
        
        'items': json['items'] == null ? undefined : ((json['items'] as Array<any>).map(ControllerApiResourcesUsersV1UserFromJSON)),
...
export function ControllerApiServicesV1ListUsersResponseToJSON(json: any): ControllerApiServicesV1ListUsersResponse {
    return ControllerApiServicesV1ListUsersResponseToJSONTyped(json, false);
}

export function ControllerApiServicesV1ListUsersResponseToJSONTyped(value?: ControllerApiServicesV1ListUsersResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'items': value['items'] == null ? undefined : ((value['items'] as Array<any>).map(ControllerApiResourcesUsersV1UserToJSON)),
