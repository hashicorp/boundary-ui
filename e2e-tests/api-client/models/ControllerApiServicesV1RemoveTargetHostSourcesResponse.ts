 ...
 * 
 * @export
 * @interface ControllerApiServicesV1RemoveTargetHostSourcesResponse
 */
export interface ControllerApiServicesV1RemoveTargetHostSourcesResponse {
    /**
     * 
     * @type {ControllerApiResourcesTargetsV1Target}
     * @memberof ControllerApiServicesV1RemoveTargetHostSourcesResponse
     */
    item?: ControllerApiResourcesTargetsV1Target;
}

/**
 * Check if a given object implements the ControllerApiServicesV1RemoveTargetHostSourcesResponse interface.
 */
export function instanceOfControllerApiServicesV1RemoveTargetHostSourcesResponse(value: object): value is ControllerApiServicesV1RemoveTargetHostSourcesResponse {
    return true;
}

export function ControllerApiServicesV1RemoveTargetHostSourcesResponseFromJSON(json: any): ControllerApiServicesV1RemoveTargetHostSourcesResponse {
    return ControllerApiServicesV1RemoveTargetHostSourcesResponseFromJSONTyped(json, false);
}

export function ControllerApiServicesV1RemoveTargetHostSourcesResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1RemoveTargetHostSourcesResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiServicesV1RemoveTargetHostSourcesResponseToJSON(json: any): ControllerApiServicesV1RemoveTargetHostSourcesResponse {
    return ControllerApiServicesV1RemoveTargetHostSourcesResponseToJSONTyped(json, false);
}

export function ControllerApiServicesV1RemoveTargetHostSourcesResponseToJSONTyped(value?: ControllerApiServicesV1RemoveTargetHostSourcesResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
