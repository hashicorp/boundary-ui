 ...
 * 
 * @export
 * @interface ControllerApiResourcesTargetsV1AuthorizeSessionArguments
 */
export interface ControllerApiResourcesTargetsV1AuthorizeSessionArguments {
    /**
     ...
     * @type {string}
     * @memberof ControllerApiResourcesTargetsV1AuthorizeSessionArguments
     */
    hostId?: string;
}

/**
 * Check if a given object implements the ControllerApiResourcesTargetsV1AuthorizeSessionArguments interface.
 */
export function instanceOfControllerApiResourcesTargetsV1AuthorizeSessionArguments(value: object): value is ControllerApiResourcesTargetsV1AuthorizeSessionArguments {
    return true;
}

export function ControllerApiResourcesTargetsV1AuthorizeSessionArgumentsFromJSON(json: any): ControllerApiResourcesTargetsV1AuthorizeSessionArguments {
    return ControllerApiResourcesTargetsV1AuthorizeSessionArgumentsFromJSONTyped(json, false);
}

export function ControllerApiResourcesTargetsV1AuthorizeSessionArgumentsFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiResourcesTargetsV1AuthorizeSessionArguments {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiResourcesTargetsV1AuthorizeSessionArgumentsToJSON(json: any): ControllerApiResourcesTargetsV1AuthorizeSessionArguments {
    return ControllerApiResourcesTargetsV1AuthorizeSessionArgumentsToJSONTyped(json, false);
}

export function ControllerApiResourcesTargetsV1AuthorizeSessionArgumentsToJSONTyped(value?: ControllerApiResourcesTargetsV1AuthorizeSessionArguments | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
