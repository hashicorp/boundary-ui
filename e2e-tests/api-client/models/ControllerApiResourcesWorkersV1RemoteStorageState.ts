...
import type { ControllerApiResourcesWorkersV1RemoteStoragePermissions } from './ControllerApiResourcesWorkersV1RemoteStoragePermissions';
import {
    ControllerApiResourcesWorkersV1RemoteStoragePermissionsFromJSON,
    ControllerApiResourcesWorkersV1RemoteStoragePermissionsFromJSONTyped,
    ControllerApiResourcesWorkersV1RemoteStoragePermissionsToJSON,
    ControllerApiResourcesWorkersV1RemoteStoragePermissionsToJSONTyped,
} from './ControllerApiResourcesWorkersV1RemoteStoragePermissions';

/**
 * 
 * @export
 * @interface ControllerApiResourcesWorkersV1RemoteStorageState
 */
export interface ControllerApiResourcesWorkersV1RemoteStorageState {
    /**
     ...
     * @type {string}
     * @memberof ControllerApiResourcesWorkersV1RemoteStorageState
     */
    readonly status?: string;
    /**
     * 
     * @type {ControllerApiResourcesWorkersV1RemoteStoragePermissions}
     * @memberof ControllerApiResourcesWorkersV1RemoteStorageState
     */
    permissions?: ControllerApiResourcesWorkersV1RemoteStoragePermissions;
}

/**
 * Check if a given object implements the ControllerApiResourcesWorkersV1RemoteStorageState interface.
 */
export function instanceOfControllerApiResourcesWorkersV1RemoteStorageState(value: object): value is ControllerApiResourcesWorkersV1RemoteStorageState {
    return true;
}

export function ControllerApiResourcesWorkersV1RemoteStorageStateFromJSON(json: any): ControllerApiResourcesWorkersV1RemoteStorageState {
    return ControllerApiResourcesWorkersV1RemoteStorageStateFromJSONTyped(json, false);
}

export function ControllerApiResourcesWorkersV1RemoteStorageStateFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiResourcesWorkersV1RemoteStorageState {
    if (json == null) {
        return json;
    }
    return {
        ...
        'permissions': json['permissions'] == null ? undefined : ControllerApiResourcesWorkersV1RemoteStoragePermissionsFromJSON(json['permissions']),
    };
}

export function ControllerApiResourcesWorkersV1RemoteStorageStateToJSON(json: any): ControllerApiResourcesWorkersV1RemoteStorageState {
    return ControllerApiResourcesWorkersV1RemoteStorageStateToJSONTyped(json, false);
}

export function ControllerApiResourcesWorkersV1RemoteStorageStateToJSONTyped(value?: Omit<ControllerApiResourcesWorkersV1RemoteStorageState, 'status'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'permissions': ControllerApiResourcesWorkersV1RemoteStoragePermissionsToJSON(value['permissions']),
    };
}
