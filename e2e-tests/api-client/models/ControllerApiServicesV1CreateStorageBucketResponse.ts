 ...
 * 
 * @export
 * @interface ControllerApiServicesV1CreateStorageBucketResponse
 */
export interface ControllerApiServicesV1CreateStorageBucketResponse {
    /**
     * 
     * @type {string}
     * @memberof ControllerApiServicesV1CreateStorageBucketResponse
     */
    uri?: string;
    /**
     * 
...
/**
 * Check if a given object implements the ControllerApiServicesV1CreateStorageBucketResponse interface.
 */
export function instanceOfControllerApiServicesV1CreateStorageBucketResponse(value: object): value is ControllerApiServicesV1CreateStorageBucketResponse {
    return true;
}

export function ControllerApiServicesV1CreateStorageBucketResponseFromJSON(json: any): ControllerApiServicesV1CreateStorageBucketResponse {
    return ControllerApiServicesV1CreateStorageBucketResponseFromJSONTyped(json, false);
}

export function ControllerApiServicesV1CreateStorageBucketResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1CreateStorageBucketResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiServicesV1CreateStorageBucketResponseToJSON(json: any): ControllerApiServicesV1CreateStorageBucketResponse {
    return ControllerApiServicesV1CreateStorageBucketResponseToJSONTyped(json, false);
}

export function ControllerApiServicesV1CreateStorageBucketResponseToJSONTyped(value?: ControllerApiServicesV1CreateStorageBucketResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
