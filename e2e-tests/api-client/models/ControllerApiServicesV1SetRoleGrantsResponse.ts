 ...
 * 
 * @export
 * @interface ControllerApiServicesV1SetRoleGrantsResponse
 */
export interface ControllerApiServicesV1SetRoleGrantsResponse {
    /**
     * 
     * @type {ControllerApiResourcesRolesV1Role}
     * @memberof ControllerApiServicesV1SetRoleGrantsResponse
     */
    item?: ControllerApiResourcesRolesV1Role;
}

/**
 * Check if a given object implements the ControllerApiServicesV1SetRoleGrantsResponse interface.
 */
export function instanceOfControllerApiServicesV1SetRoleGrantsResponse(value: object): value is ControllerApiServicesV1SetRoleGrantsResponse {
    return true;
}

export function ControllerApiServicesV1SetRoleGrantsResponseFromJSON(json: any): ControllerApiServicesV1SetRoleGrantsResponse {
    return ControllerApiServicesV1SetRoleGrantsResponseFromJSONTyped(json, false);
}

export function ControllerApiServicesV1SetRoleGrantsResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1SetRoleGrantsResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiServicesV1SetRoleGrantsResponseToJSON(json: any): ControllerApiServicesV1SetRoleGrantsResponse {
    return ControllerApiServicesV1SetRoleGrantsResponseToJSONTyped(json, false);
}

export function ControllerApiServicesV1SetRoleGrantsResponseToJSONTyped(value?: ControllerApiServicesV1SetRoleGrantsResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
