...
import type { ControllerApiResourcesCredentiallibrariesV1CredentialLibrary } from './ControllerApiResourcesCredentiallibrariesV1CredentialLibrary';
import {
    ControllerApiResourcesCredentiallibrariesV1CredentialLibraryFromJSON,
    ControllerApiResourcesCredentiallibrariesV1CredentialLibraryFromJSONTyped,
    ControllerApiResourcesCredentiallibrariesV1CredentialLibraryToJSON,
    ControllerApiResourcesCredentiallibrariesV1CredentialLibraryToJSONTyped,
} from './ControllerApiResourcesCredentiallibrariesV1CredentialLibrary';

/**
 * 
 * @export
 * @interface ControllerApiServicesV1ListCredentialLibrariesResponse
 */
export interface ControllerApiServicesV1ListCredentialLibrariesResponse {
    /**
     * The items returned in this page.
     * @type {Array<ControllerApiResourcesCredentiallibrariesV1CredentialLibrary>}
     * @memberof ControllerApiServicesV1ListCredentialLibrariesResponse
     */
    items?: Array<ControllerApiResourcesCredentiallibrariesV1CredentialLibrary>;
    /**
...
/**
 * Check if a given object implements the ControllerApiServicesV1ListCredentialLibrariesResponse interface.
 */
export function instanceOfControllerApiServicesV1ListCredentialLibrariesResponse(value: object): value is ControllerApiServicesV1ListCredentialLibrariesResponse {
    return true;
}

export function ControllerApiServicesV1ListCredentialLibrariesResponseFromJSON(json: any): ControllerApiServicesV1ListCredentialLibrariesResponse {
    return ControllerApiServicesV1ListCredentialLibrariesResponseFromJSONTyped(json, false);
}

export function ControllerApiServicesV1ListCredentialLibrariesResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1ListCredentialLibrariesResponse {
    if (json == null) {
        return json;
    }
    return {
        
        'items': json['items'] == null ? undefined : ((json['items'] as Array<any>).map(ControllerApiResourcesCredentiallibrariesV1CredentialLibraryFromJSON)),
...
export function ControllerApiServicesV1ListCredentialLibrariesResponseToJSON(json: any): ControllerApiServicesV1ListCredentialLibrariesResponse {
    return ControllerApiServicesV1ListCredentialLibrariesResponseToJSONTyped(json, false);
}

export function ControllerApiServicesV1ListCredentialLibrariesResponseToJSONTyped(value?: ControllerApiServicesV1ListCredentialLibrariesResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'items': value['items'] == null ? undefined : ((value['items'] as Array<any>).map(ControllerApiResourcesCredentiallibrariesV1CredentialLibraryToJSON)),
