 ...
 * 
 * @export
 * @interface ControllerApiServicesV1CreateTargetResponse
 */
export interface ControllerApiServicesV1CreateTargetResponse {
    /**
     * 
     * @type {string}
     * @memberof ControllerApiServicesV1CreateTargetResponse
     */
    uri?: string;
    /**
     * 
...
/**
 * Check if a given object implements the ControllerApiServicesV1CreateTargetResponse interface.
 */
export function instanceOfControllerApiServicesV1CreateTargetResponse(value: object): value is ControllerApiServicesV1CreateTargetResponse {
    return true;
}

export function ControllerApiServicesV1CreateTargetResponseFromJSON(json: any): ControllerApiServicesV1CreateTargetResponse {
    return ControllerApiServicesV1CreateTargetResponseFromJSONTyped(json, false);
}

export function ControllerApiServicesV1CreateTargetResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1CreateTargetResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiServicesV1CreateTargetResponseToJSON(json: any): ControllerApiServicesV1CreateTargetResponse {
    return ControllerApiServicesV1CreateTargetResponseToJSONTyped(json, false);
}

export function ControllerApiServicesV1CreateTargetResponseToJSONTyped(value?: ControllerApiServicesV1CreateTargetResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
