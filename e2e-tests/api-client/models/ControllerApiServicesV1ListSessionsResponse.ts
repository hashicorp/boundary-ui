...
import type { ControllerApiResourcesSessionsV1Session } from './ControllerApiResourcesSessionsV1Session';
import {
    ControllerApiResourcesSessionsV1SessionFromJSON,
    ControllerApiResourcesSessionsV1SessionFromJSONTyped,
    ControllerApiResourcesSessionsV1SessionToJSON,
    ControllerApiResourcesSessionsV1SessionToJSONTyped,
} from './ControllerApiResourcesSessionsV1Session';

/**
 * 
 * @export
 * @interface ControllerApiServicesV1ListSessionsResponse
 */
export interface ControllerApiServicesV1ListSessionsResponse {
    /**
     * 
     * @type {Array<ControllerApiResourcesSessionsV1Session>}
     * @memberof ControllerApiServicesV1ListSessionsResponse
     */
    items?: Array<ControllerApiResourcesSessionsV1Session>;
    /**
...
/**
 * Check if a given object implements the ControllerApiServicesV1ListSessionsResponse interface.
 */
export function instanceOfControllerApiServicesV1ListSessionsResponse(value: object): value is ControllerApiServicesV1ListSessionsResponse {
    return true;
}

export function ControllerApiServicesV1ListSessionsResponseFromJSON(json: any): ControllerApiServicesV1ListSessionsResponse {
    return ControllerApiServicesV1ListSessionsResponseFromJSONTyped(json, false);
}

export function ControllerApiServicesV1ListSessionsResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1ListSessionsResponse {
    if (json == null) {
        return json;
    }
    return {
        
        'items': json['items'] == null ? undefined : ((json['items'] as Array<any>).map(ControllerApiResourcesSessionsV1SessionFromJSON)),
...
export function ControllerApiServicesV1ListSessionsResponseToJSON(json: any): ControllerApiServicesV1ListSessionsResponse {
    return ControllerApiServicesV1ListSessionsResponseToJSONTyped(json, false);
}

export function ControllerApiServicesV1ListSessionsResponseToJSONTyped(value?: ControllerApiServicesV1ListSessionsResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'items': value['items'] == null ? undefined : ((value['items'] as Array<any>).map(ControllerApiResourcesSessionsV1SessionToJSON)),
