 ...
 * 
 * @export
 * @interface ControllerApiServicesV1UpdateTargetResponse
 */
export interface ControllerApiServicesV1UpdateTargetResponse {
    /**
     * 
     * @type {ControllerApiResourcesTargetsV1Target}
     * @memberof ControllerApiServicesV1UpdateTargetResponse
     */
    item?: ControllerApiResourcesTargetsV1Target;
}

/**
 * Check if a given object implements the ControllerApiServicesV1UpdateTargetResponse interface.
 */
export function instanceOfControllerApiServicesV1UpdateTargetResponse(value: object): value is ControllerApiServicesV1UpdateTargetResponse {
    return true;
}

export function ControllerApiServicesV1UpdateTargetResponseFromJSON(json: any): ControllerApiServicesV1UpdateTargetResponse {
    return ControllerApiServicesV1UpdateTargetResponseFromJSONTyped(json, false);
}

export function ControllerApiServicesV1UpdateTargetResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1UpdateTargetResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiServicesV1UpdateTargetResponseToJSON(json: any): ControllerApiServicesV1UpdateTargetResponse {
    return ControllerApiServicesV1UpdateTargetResponseToJSONTyped(json, false);
}

export function ControllerApiServicesV1UpdateTargetResponseToJSONTyped(value?: ControllerApiServicesV1UpdateTargetResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
