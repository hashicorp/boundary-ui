 ...
 * 
 * @export
 * @interface ControllerApiResourcesScopesV1KeyVersion
 */
export interface ControllerApiResourcesScopesV1KeyVersion {
    /**
     * The ID of the key version.
     * @type {string}
     * @memberof ControllerApiResourcesScopesV1KeyVersion
     */
    id?: string;
    /**
...
/**
 * Check if a given object implements the ControllerApiResourcesScopesV1KeyVersion interface.
 */
export function instanceOfControllerApiResourcesScopesV1KeyVersion(value: object): value is ControllerApiResourcesScopesV1KeyVersion {
    return true;
}

export function ControllerApiResourcesScopesV1KeyVersionFromJSON(json: any): ControllerApiResourcesScopesV1KeyVersion {
    return ControllerApiResourcesScopesV1KeyVersionFromJSONTyped(json, false);
}

export function ControllerApiResourcesScopesV1KeyVersionFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiResourcesScopesV1KeyVersion {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiResourcesScopesV1KeyVersionToJSON(json: any): ControllerApiResourcesScopesV1KeyVersion {
    return ControllerApiResourcesScopesV1KeyVersionToJSONTyped(json, false);
}

export function ControllerApiResourcesScopesV1KeyVersionToJSONTyped(value?: ControllerApiResourcesScopesV1KeyVersion | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
