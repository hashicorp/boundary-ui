 ...
 * 
 * @export
 * @interface ControllerApiServicesV1RoleServiceAddRolePrincipalsBody
 */
export interface ControllerApiServicesV1RoleServiceAddRolePrincipalsBody {
    /**
     * Version is used to ensure this resource has not changed.
     * The mutation will fail if the version does not match the latest known good version.
     * @type {number}
     * @memberof ControllerApiServicesV1RoleServiceAddRolePrincipalsBody
     */
    version?: number;
    /**
     * 
...
/**
 * Check if a given object implements the ControllerApiServicesV1RoleServiceAddRolePrincipalsBody interface.
 */
export function instanceOfControllerApiServicesV1RoleServiceAddRolePrincipalsBody(value: object): value is ControllerApiServicesV1RoleServiceAddRolePrincipalsBody {
    return true;
}

export function ControllerApiServicesV1RoleServiceAddRolePrincipalsBodyFromJSON(json: any): ControllerApiServicesV1RoleServiceAddRolePrincipalsBody {
    return ControllerApiServicesV1RoleServiceAddRolePrincipalsBodyFromJSONTyped(json, false);
}

export function ControllerApiServicesV1RoleServiceAddRolePrincipalsBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1RoleServiceAddRolePrincipalsBody {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiServicesV1RoleServiceAddRolePrincipalsBodyToJSON(json: any): ControllerApiServicesV1RoleServiceAddRolePrincipalsBody {
    return ControllerApiServicesV1RoleServiceAddRolePrincipalsBodyToJSONTyped(json, false);
}

export function ControllerApiServicesV1RoleServiceAddRolePrincipalsBodyToJSONTyped(value?: ControllerApiServicesV1RoleServiceAddRolePrincipalsBody | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
