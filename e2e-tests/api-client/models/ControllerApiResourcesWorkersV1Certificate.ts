 ...
 * 
 * @export
 * @interface ControllerApiResourcesWorkersV1Certificate
 */
export interface ControllerApiResourcesWorkersV1Certificate {
    /**
     * 
     * @type {string}
     * @memberof ControllerApiResourcesWorkersV1Certificate
     */
    readonly id?: string;
    /**
     * 
...
/**
 * Check if a given object implements the ControllerApiResourcesWorkersV1Certificate interface.
 */
export function instanceOfControllerApiResourcesWorkersV1Certificate(value: object): value is ControllerApiResourcesWorkersV1Certificate {
    return true;
}

export function ControllerApiResourcesWorkersV1CertificateFromJSON(json: any): ControllerApiResourcesWorkersV1Certificate {
    return ControllerApiResourcesWorkersV1CertificateFromJSONTyped(json, false);
}

export function ControllerApiResourcesWorkersV1CertificateFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiResourcesWorkersV1Certificate {
    if (json == null) {
        return json;
    }
    return {
        ...
        'publicKeySha256': json['public_key_sha256'] == null ? undefined : json['public_key_sha256'],
        'notBeforeTime': json['not_before_time'] == null ? undefined : (new Date(json['not_before_time'])),
        'notAfterTime': json['not_after_time'] == null ? undefined : (new Date(json['not_after_time'])),
    };
}

export function ControllerApiResourcesWorkersV1CertificateToJSON(json: any): ControllerApiResourcesWorkersV1Certificate {
    return ControllerApiResourcesWorkersV1CertificateToJSONTyped(json, false);
}

export function ControllerApiResourcesWorkersV1CertificateToJSONTyped(value?: Omit<ControllerApiResourcesWorkersV1Certificate, 'id'|'public_key_sha256'|'not_before_time'|'not_after_time'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
