 ...
 * 
 * @export
 * @interface ControllerApiServicesV1UpdateAuthMethodResponse
 */
export interface ControllerApiServicesV1UpdateAuthMethodResponse {
    /**
     * 
     * @type {ControllerApiResourcesAuthmethodsV1AuthMethod}
     * @memberof ControllerApiServicesV1UpdateAuthMethodResponse
     */
    item?: ControllerApiResourcesAuthmethodsV1AuthMethod;
}

/**
 * Check if a given object implements the ControllerApiServicesV1UpdateAuthMethodResponse interface.
 */
export function instanceOfControllerApiServicesV1UpdateAuthMethodResponse(value: object): value is ControllerApiServicesV1UpdateAuthMethodResponse {
    return true;
}

export function ControllerApiServicesV1UpdateAuthMethodResponseFromJSON(json: any): ControllerApiServicesV1UpdateAuthMethodResponse {
    return ControllerApiServicesV1UpdateAuthMethodResponseFromJSONTyped(json, false);
}

export function ControllerApiServicesV1UpdateAuthMethodResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1UpdateAuthMethodResponse {
    if (json == null) {
        return json;
    }
    return {
        
        'item': json['item'] == null ? undefined : ControllerApiResourcesAuthmethodsV1AuthMethodFromJSON(json['item']),
    };
}

export function ControllerApiServicesV1UpdateAuthMethodResponseToJSON(json: any): ControllerApiServicesV1UpdateAuthMethodResponse {
    return ControllerApiServicesV1UpdateAuthMethodResponseToJSONTyped(json, false);
}

export function ControllerApiServicesV1UpdateAuthMethodResponseToJSONTyped(value?: ControllerApiServicesV1UpdateAuthMethodResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'item': ControllerApiResourcesAuthmethodsV1AuthMethodToJSON(value['item']),
    };
}
