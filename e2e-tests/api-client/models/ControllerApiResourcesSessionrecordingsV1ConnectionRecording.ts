...
import type { ControllerApiResourcesSessionrecordingsV1ChannelRecording } from './ControllerApiResourcesSessionrecordingsV1ChannelRecording';
import {
    ControllerApiResourcesSessionrecordingsV1ChannelRecordingFromJSON,
    ControllerApiResourcesSessionrecordingsV1ChannelRecordingFromJSONTyped,
    ControllerApiResourcesSessionrecordingsV1ChannelRecordingToJSON,
    ControllerApiResourcesSessionrecordingsV1ChannelRecordingToJSONTyped,
} from './ControllerApiResourcesSessionrecordingsV1ChannelRecording';

/**
 * ConnectionRecording contains the recording of a single Connection within a Session.
 * @export
 * @interface ControllerApiResourcesSessionrecordingsV1ConnectionRecording
 */
export interface ControllerApiResourcesSessionrecordingsV1ConnectionRecording {
    /**
     * The ID of the Connection recording.
     * @type {string}
     * @memberof ControllerApiResourcesSessionrecordingsV1ConnectionRecording
     */
    id?: string;
    /**
     ...
     * @type {Array<ControllerApiResourcesSessionrecordingsV1ChannelRecording>}
     * @memberof ControllerApiResourcesSessionrecordingsV1ConnectionRecording
     */
    channelRecordings?: Array<ControllerApiResourcesSessionrecordingsV1ChannelRecording>;
}

/**
 * Check if a given object implements the ControllerApiResourcesSessionrecordingsV1ConnectionRecording interface.
 */
export function instanceOfControllerApiResourcesSessionrecordingsV1ConnectionRecording(value: object): value is ControllerApiResourcesSessionrecordingsV1ConnectionRecording {
    return true;
}

export function ControllerApiResourcesSessionrecordingsV1ConnectionRecordingFromJSON(json: any): ControllerApiResourcesSessionrecordingsV1ConnectionRecording {
    return ControllerApiResourcesSessionrecordingsV1ConnectionRecordingFromJSONTyped(json, false);
}

export function ControllerApiResourcesSessionrecordingsV1ConnectionRecordingFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiResourcesSessionrecordingsV1ConnectionRecording {
    if (json == null) {
        return json;
    }
    return {
        ...
        'channelRecordings': json['channel_recordings'] == null ? undefined : ((json['channel_recordings'] as Array<any>).map(ControllerApiResourcesSessionrecordingsV1ChannelRecordingFromJSON)),
    };
}

export function ControllerApiResourcesSessionrecordingsV1ConnectionRecordingToJSON(json: any): ControllerApiResourcesSessionrecordingsV1ConnectionRecording {
    return ControllerApiResourcesSessionrecordingsV1ConnectionRecordingToJSONTyped(json, false);
}

export function ControllerApiResourcesSessionrecordingsV1ConnectionRecordingToJSONTyped(value?: ControllerApiResourcesSessionrecordingsV1ConnectionRecording | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'channel_recordings': value['channelRecordings'] == null ? undefined : ((value['channelRecordings'] as Array<any>).map(ControllerApiResourcesSessionrecordingsV1ChannelRecordingToJSON)),
    };
}
