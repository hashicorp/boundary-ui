 ...
 * 
 * @export
 * @interface ControllerApiServicesV1HostSetServiceRemoveHostSetHostsBody
 */
export interface ControllerApiServicesV1HostSetServiceRemoveHostSetHostsBody {
    /**
     * Version is used to ensure this resource has not changed.
     * The mutation will fail if the version does not match the latest known good version.
     * @type {number}
     * @memberof ControllerApiServicesV1HostSetServiceRemoveHostSetHostsBody
     */
    version?: number;
    /**
...
/**
 * Check if a given object implements the ControllerApiServicesV1HostSetServiceRemoveHostSetHostsBody interface.
 */
export function instanceOfControllerApiServicesV1HostSetServiceRemoveHostSetHostsBody(value: object): value is ControllerApiServicesV1HostSetServiceRemoveHostSetHostsBody {
    return true;
}

export function ControllerApiServicesV1HostSetServiceRemoveHostSetHostsBodyFromJSON(json: any): ControllerApiServicesV1HostSetServiceRemoveHostSetHostsBody {
    return ControllerApiServicesV1HostSetServiceRemoveHostSetHostsBodyFromJSONTyped(json, false);
}

export function ControllerApiServicesV1HostSetServiceRemoveHostSetHostsBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1HostSetServiceRemoveHostSetHostsBody {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiServicesV1HostSetServiceRemoveHostSetHostsBodyToJSON(json: any): ControllerApiServicesV1HostSetServiceRemoveHostSetHostsBody {
    return ControllerApiServicesV1HostSetServiceRemoveHostSetHostsBodyToJSONTyped(json, false);
}

export function ControllerApiServicesV1HostSetServiceRemoveHostSetHostsBodyToJSONTyped(value?: ControllerApiServicesV1HostSetServiceRemoveHostSetHostsBody | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
