 ...
 * 
 * @export
 * @interface ControllerApiServicesV1GroupServiceRemoveGroupMembersBody
 */
export interface ControllerApiServicesV1GroupServiceRemoveGroupMembersBody {
    /**
     * Version is used to ensure this resource has not changed.
     * The mutation will fail if the version does not match the latest known good version.
     * @type {number}
     * @memberof ControllerApiServicesV1GroupServiceRemoveGroupMembersBody
     */
    version?: number;
    /**
     * 
...
/**
 * Check if a given object implements the ControllerApiServicesV1GroupServiceRemoveGroupMembersBody interface.
 */
export function instanceOfControllerApiServicesV1GroupServiceRemoveGroupMembersBody(value: object): value is ControllerApiServicesV1GroupServiceRemoveGroupMembersBody {
    return true;
}

export function ControllerApiServicesV1GroupServiceRemoveGroupMembersBodyFromJSON(json: any): ControllerApiServicesV1GroupServiceRemoveGroupMembersBody {
    return ControllerApiServicesV1GroupServiceRemoveGroupMembersBodyFromJSONTyped(json, false);
}

export function ControllerApiServicesV1GroupServiceRemoveGroupMembersBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1GroupServiceRemoveGroupMembersBody {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiServicesV1GroupServiceRemoveGroupMembersBodyToJSON(json: any): ControllerApiServicesV1GroupServiceRemoveGroupMembersBody {
    return ControllerApiServicesV1GroupServiceRemoveGroupMembersBodyToJSONTyped(json, false);
}

export function ControllerApiServicesV1GroupServiceRemoveGroupMembersBodyToJSONTyped(value?: ControllerApiServicesV1GroupServiceRemoveGroupMembersBody | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
