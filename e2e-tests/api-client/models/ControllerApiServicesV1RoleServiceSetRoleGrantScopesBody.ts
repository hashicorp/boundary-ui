 ...
 * 
 * @export
 * @interface ControllerApiServicesV1RoleServiceSetRoleGrantScopesBody
 */
export interface ControllerApiServicesV1RoleServiceSetRoleGrantScopesBody {
    /**
     * Version is used to ensure this resource has not changed.
     * The mutation will fail if the version does not match the latest known good version.
     * @type {number}
     * @memberof ControllerApiServicesV1RoleServiceSetRoleGrantScopesBody
     */
    version?: number;
    /**
     * 
...
/**
 * Check if a given object implements the ControllerApiServicesV1RoleServiceSetRoleGrantScopesBody interface.
 */
export function instanceOfControllerApiServicesV1RoleServiceSetRoleGrantScopesBody(value: object): value is ControllerApiServicesV1RoleServiceSetRoleGrantScopesBody {
    return true;
}

export function ControllerApiServicesV1RoleServiceSetRoleGrantScopesBodyFromJSON(json: any): ControllerApiServicesV1RoleServiceSetRoleGrantScopesBody {
    return ControllerApiServicesV1RoleServiceSetRoleGrantScopesBodyFromJSONTyped(json, false);
}

export function ControllerApiServicesV1RoleServiceSetRoleGrantScopesBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1RoleServiceSetRoleGrantScopesBody {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiServicesV1RoleServiceSetRoleGrantScopesBodyToJSON(json: any): ControllerApiServicesV1RoleServiceSetRoleGrantScopesBody {
    return ControllerApiServicesV1RoleServiceSetRoleGrantScopesBodyToJSONTyped(json, false);
}

export function ControllerApiServicesV1RoleServiceSetRoleGrantScopesBodyToJSONTyped(value?: ControllerApiServicesV1RoleServiceSetRoleGrantScopesBody | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
