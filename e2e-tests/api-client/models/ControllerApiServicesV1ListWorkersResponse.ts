 ...
 * 
 * @export
 * @interface ControllerApiServicesV1ListWorkersResponse
 */
export interface ControllerApiServicesV1ListWorkersResponse {
    /**
     * 
     * @type {Array<ControllerApiResourcesWorkersV1Worker>}
     * @memberof ControllerApiServicesV1ListWorkersResponse
     */
    items?: Array<ControllerApiResourcesWorkersV1Worker>;
}

/**
 * Check if a given object implements the ControllerApiServicesV1ListWorkersResponse interface.
 */
export function instanceOfControllerApiServicesV1ListWorkersResponse(value: object): value is ControllerApiServicesV1ListWorkersResponse {
    return true;
}

export function ControllerApiServicesV1ListWorkersResponseFromJSON(json: any): ControllerApiServicesV1ListWorkersResponse {
    return ControllerApiServicesV1ListWorkersResponseFromJSONTyped(json, false);
}

export function ControllerApiServicesV1ListWorkersResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1ListWorkersResponse {
    if (json == null) {
        return json;
    }
    return {
        
        'items': json['items'] == null ? undefined : ((json['items'] as Array<any>).map(ControllerApiResourcesWorkersV1WorkerFromJSON)),
    };
}

export function ControllerApiServicesV1ListWorkersResponseToJSON(json: any): ControllerApiServicesV1ListWorkersResponse {
    return ControllerApiServicesV1ListWorkersResponseToJSONTyped(json, false);
}

export function ControllerApiServicesV1ListWorkersResponseToJSONTyped(value?: ControllerApiServicesV1ListWorkersResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'items': value['items'] == null ? undefined : ((value['items'] as Array<any>).map(ControllerApiResourcesWorkersV1WorkerToJSON)),
    };
}
