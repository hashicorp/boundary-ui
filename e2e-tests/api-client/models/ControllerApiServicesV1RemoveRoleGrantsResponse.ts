 ...
 * 
 * @export
 * @interface ControllerApiServicesV1RemoveRoleGrantsResponse
 */
export interface ControllerApiServicesV1RemoveRoleGrantsResponse {
    /**
     * 
     * @type {ControllerApiResourcesRolesV1Role}
     * @memberof ControllerApiServicesV1RemoveRoleGrantsResponse
     */
    item?: ControllerApiResourcesRolesV1Role;
}

/**
 * Check if a given object implements the ControllerApiServicesV1RemoveRoleGrantsResponse interface.
 */
export function instanceOfControllerApiServicesV1RemoveRoleGrantsResponse(value: object): value is ControllerApiServicesV1RemoveRoleGrantsResponse {
    return true;
}

export function ControllerApiServicesV1RemoveRoleGrantsResponseFromJSON(json: any): ControllerApiServicesV1RemoveRoleGrantsResponse {
    return ControllerApiServicesV1RemoveRoleGrantsResponseFromJSONTyped(json, false);
}

export function ControllerApiServicesV1RemoveRoleGrantsResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1RemoveRoleGrantsResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiServicesV1RemoveRoleGrantsResponseToJSON(json: any): ControllerApiServicesV1RemoveRoleGrantsResponse {
    return ControllerApiServicesV1RemoveRoleGrantsResponseToJSONTyped(json, false);
}

export function ControllerApiServicesV1RemoveRoleGrantsResponseToJSONTyped(value?: ControllerApiServicesV1RemoveRoleGrantsResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
