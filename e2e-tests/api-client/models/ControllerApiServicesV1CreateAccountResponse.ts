 ...
 * 
 * @export
 * @interface ControllerApiServicesV1CreateAccountResponse
 */
export interface ControllerApiServicesV1CreateAccountResponse {
    /**
     * 
     * @type {string}
     * @memberof ControllerApiServicesV1CreateAccountResponse
     */
    uri?: string;
    /**
     * 
...
/**
 * Check if a given object implements the ControllerApiServicesV1CreateAccountResponse interface.
 */
export function instanceOfControllerApiServicesV1CreateAccountResponse(value: object): value is ControllerApiServicesV1CreateAccountResponse {
    return true;
}

export function ControllerApiServicesV1CreateAccountResponseFromJSON(json: any): ControllerApiServicesV1CreateAccountResponse {
    return ControllerApiServicesV1CreateAccountResponseFromJSONTyped(json, false);
}

export function ControllerApiServicesV1CreateAccountResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1CreateAccountResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiServicesV1CreateAccountResponseToJSON(json: any): ControllerApiServicesV1CreateAccountResponse {
    return ControllerApiServicesV1CreateAccountResponseToJSONTyped(json, false);
}

export function ControllerApiServicesV1CreateAccountResponseToJSONTyped(value?: ControllerApiServicesV1CreateAccountResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
