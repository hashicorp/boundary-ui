 ...
 * 
 * @export
 * @interface ControllerApiServicesV1GetAuthTokenResponse
 */
export interface ControllerApiServicesV1GetAuthTokenResponse {
    /**
     * 
     * @type {ControllerApiResourcesAuthtokensV1AuthToken}
     * @memberof ControllerApiServicesV1GetAuthTokenResponse
     */
    item?: ControllerApiResourcesAuthtokensV1AuthToken;
}

/**
 * Check if a given object implements the ControllerApiServicesV1GetAuthTokenResponse interface.
 */
export function instanceOfControllerApiServicesV1GetAuthTokenResponse(value: object): value is ControllerApiServicesV1GetAuthTokenResponse {
    return true;
}

export function ControllerApiServicesV1GetAuthTokenResponseFromJSON(json: any): ControllerApiServicesV1GetAuthTokenResponse {
    return ControllerApiServicesV1GetAuthTokenResponseFromJSONTyped(json, false);
}

export function ControllerApiServicesV1GetAuthTokenResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1GetAuthTokenResponse {
    if (json == null) {
        return json;
    }
    return {
        
        'item': json['item'] == null ? undefined : ControllerApiResourcesAuthtokensV1AuthTokenFromJSON(json['item']),
    };
}

export function ControllerApiServicesV1GetAuthTokenResponseToJSON(json: any): ControllerApiServicesV1GetAuthTokenResponse {
    return ControllerApiServicesV1GetAuthTokenResponseToJSONTyped(json, false);
}

export function ControllerApiServicesV1GetAuthTokenResponseToJSONTyped(value?: ControllerApiServicesV1GetAuthTokenResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'item': ControllerApiResourcesAuthtokensV1AuthTokenToJSON(value['item']),
    };
}
