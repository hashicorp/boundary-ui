 ...
 * 
 * @export
 * @interface ControllerApiResourcesRolesV1GrantJson
 */
export interface ControllerApiResourcesRolesV1GrantJson {
    /**
     * Output only. The ID, if set.
     * Deprecated: use "ids" instead.
     * @type {string}
     * @memberof ControllerApiResourcesRolesV1GrantJson
     */
    readonly id?: string;
    /**
...
/**
 * Check if a given object implements the ControllerApiResourcesRolesV1GrantJson interface.
 */
export function instanceOfControllerApiResourcesRolesV1GrantJson(value: object): value is ControllerApiResourcesRolesV1GrantJson {
    return true;
}

export function ControllerApiResourcesRolesV1GrantJsonFromJSON(json: any): ControllerApiResourcesRolesV1GrantJson {
    return ControllerApiResourcesRolesV1GrantJsonFromJSONTyped(json, false);
}

export function ControllerApiResourcesRolesV1GrantJsonFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiResourcesRolesV1GrantJson {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiResourcesRolesV1GrantJsonToJSON(json: any): ControllerApiResourcesRolesV1GrantJson {
    return ControllerApiResourcesRolesV1GrantJsonToJSONTyped(json, false);
}

export function ControllerApiResourcesRolesV1GrantJsonToJSONTyped(value?: Omit<ControllerApiResourcesRolesV1GrantJson, 'id'|'ids'|'type'|'actions'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
