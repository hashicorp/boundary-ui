...
import type { ControllerApiResourcesCredentialsV1Credential } from './ControllerApiResourcesCredentialsV1Credential';
import {
    ControllerApiResourcesCredentialsV1CredentialFromJSON,
    ControllerApiResourcesCredentialsV1CredentialFromJSONTyped,
    ControllerApiResourcesCredentialsV1CredentialToJSON,
    ControllerApiResourcesCredentialsV1CredentialToJSONTyped,
} from './ControllerApiResourcesCredentialsV1Credential';

/**
 * 
 * @export
 * @interface ControllerApiServicesV1ListCredentialsResponse
 */
export interface ControllerApiServicesV1ListCredentialsResponse {
    /**
     * The items returned in this page.
     * @type {Array<ControllerApiResourcesCredentialsV1Credential>}
     * @memberof ControllerApiServicesV1ListCredentialsResponse
     */
    items?: Array<ControllerApiResourcesCredentialsV1Credential>;
    /**
...
/**
 * Check if a given object implements the ControllerApiServicesV1ListCredentialsResponse interface.
 */
export function instanceOfControllerApiServicesV1ListCredentialsResponse(value: object): value is ControllerApiServicesV1ListCredentialsResponse {
    return true;
}

export function ControllerApiServicesV1ListCredentialsResponseFromJSON(json: any): ControllerApiServicesV1ListCredentialsResponse {
    return ControllerApiServicesV1ListCredentialsResponseFromJSONTyped(json, false);
}

export function ControllerApiServicesV1ListCredentialsResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1ListCredentialsResponse {
    if (json == null) {
        return json;
    }
    return {
        
        'items': json['items'] == null ? undefined : ((json['items'] as Array<any>).map(ControllerApiResourcesCredentialsV1CredentialFromJSON)),
...
export function ControllerApiServicesV1ListCredentialsResponseToJSON(json: any): ControllerApiServicesV1ListCredentialsResponse {
    return ControllerApiServicesV1ListCredentialsResponseToJSONTyped(json, false);
}

export function ControllerApiServicesV1ListCredentialsResponseToJSONTyped(value?: ControllerApiServicesV1ListCredentialsResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'items': value['items'] == null ? undefined : ((value['items'] as Array<any>).map(ControllerApiResourcesCredentialsV1CredentialToJSON)),
