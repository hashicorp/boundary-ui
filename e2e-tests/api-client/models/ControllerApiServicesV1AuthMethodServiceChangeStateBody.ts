 ...
 * 
 * @export
 * @interface ControllerApiServicesV1AuthMethodServiceChangeStateBody
 */
export interface ControllerApiServicesV1AuthMethodServiceChangeStateBody {
    /**
     * Version is used to ensure this resource has not changed.
     * The mutation will fail if the version does not match the latest known good version.
     * @type {number}
     * @memberof ControllerApiServicesV1AuthMethodServiceChangeStateBody
     */
    version?: number;
    /**
     * The attributes that are applicable for the specific auth method type. The schema of this field depends on the type of the auth method. The only supported auth method type is OIDC.
...
/**
 * Check if a given object implements the ControllerApiServicesV1AuthMethodServiceChangeStateBody interface.
 */
export function instanceOfControllerApiServicesV1AuthMethodServiceChangeStateBody(value: object): value is ControllerApiServicesV1AuthMethodServiceChangeStateBody {
    return true;
}

export function ControllerApiServicesV1AuthMethodServiceChangeStateBodyFromJSON(json: any): ControllerApiServicesV1AuthMethodServiceChangeStateBody {
    return ControllerApiServicesV1AuthMethodServiceChangeStateBodyFromJSONTyped(json, false);
}

export function ControllerApiServicesV1AuthMethodServiceChangeStateBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1AuthMethodServiceChangeStateBody {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiServicesV1AuthMethodServiceChangeStateBodyToJSON(json: any): ControllerApiServicesV1AuthMethodServiceChangeStateBody {
    return ControllerApiServicesV1AuthMethodServiceChangeStateBodyToJSONTyped(json, false);
}

export function ControllerApiServicesV1AuthMethodServiceChangeStateBodyToJSONTyped(value?: ControllerApiServicesV1AuthMethodServiceChangeStateBody | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
