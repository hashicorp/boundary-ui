...
import type { ControllerApiResourcesHostsV1Host } from './ControllerApiResourcesHostsV1Host';
import {
    ControllerApiResourcesHostsV1HostFromJSON,
    ControllerApiResourcesHostsV1HostFromJSONTyped,
    ControllerApiResourcesHostsV1HostToJSON,
    ControllerApiResourcesHostsV1HostToJSONTyped,
} from './ControllerApiResourcesHostsV1Host';

/**
 * 
 * @export
 * @interface ControllerApiServicesV1ListHostsResponse
 */
export interface ControllerApiServicesV1ListHostsResponse {
    /**
     * 
     * @type {Array<ControllerApiResourcesHostsV1Host>}
     * @memberof ControllerApiServicesV1ListHostsResponse
     */
    items?: Array<ControllerApiResourcesHostsV1Host>;
    /**
...
/**
 * Check if a given object implements the ControllerApiServicesV1ListHostsResponse interface.
 */
export function instanceOfControllerApiServicesV1ListHostsResponse(value: object): value is ControllerApiServicesV1ListHostsResponse {
    return true;
}

export function ControllerApiServicesV1ListHostsResponseFromJSON(json: any): ControllerApiServicesV1ListHostsResponse {
    return ControllerApiServicesV1ListHostsResponseFromJSONTyped(json, false);
}

export function ControllerApiServicesV1ListHostsResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1ListHostsResponse {
    if (json == null) {
        return json;
    }
    return {
        
        'items': json['items'] == null ? undefined : ((json['items'] as Array<any>).map(ControllerApiResourcesHostsV1HostFromJSON)),
...
export function ControllerApiServicesV1ListHostsResponseToJSON(json: any): ControllerApiServicesV1ListHostsResponse {
    return ControllerApiServicesV1ListHostsResponseToJSONTyped(json, false);
}

export function ControllerApiServicesV1ListHostsResponseToJSONTyped(value?: ControllerApiServicesV1ListHostsResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'items': value['items'] == null ? undefined : ((value['items'] as Array<any>).map(ControllerApiResourcesHostsV1HostToJSON)),
