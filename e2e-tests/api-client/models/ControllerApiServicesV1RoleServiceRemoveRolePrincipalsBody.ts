 ...
 * 
 * @export
 * @interface ControllerApiServicesV1RoleServiceRemoveRolePrincipalsBody
 */
export interface ControllerApiServicesV1RoleServiceRemoveRolePrincipalsBody {
    /**
     * Version is used to ensure this resource has not changed.
     * The mutation will fail if the version does not match the latest known good version.
     * @type {number}
     * @memberof ControllerApiServicesV1RoleServiceRemoveRolePrincipalsBody
     */
    version?: number;
    /**
     * 
...
/**
 * Check if a given object implements the ControllerApiServicesV1RoleServiceRemoveRolePrincipalsBody interface.
 */
export function instanceOfControllerApiServicesV1RoleServiceRemoveRolePrincipalsBody(value: object): value is ControllerApiServicesV1RoleServiceRemoveRolePrincipalsBody {
    return true;
}

export function ControllerApiServicesV1RoleServiceRemoveRolePrincipalsBodyFromJSON(json: any): ControllerApiServicesV1RoleServiceRemoveRolePrincipalsBody {
    return ControllerApiServicesV1RoleServiceRemoveRolePrincipalsBodyFromJSONTyped(json, false);
}

export function ControllerApiServicesV1RoleServiceRemoveRolePrincipalsBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1RoleServiceRemoveRolePrincipalsBody {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiServicesV1RoleServiceRemoveRolePrincipalsBodyToJSON(json: any): ControllerApiServicesV1RoleServiceRemoveRolePrincipalsBody {
    return ControllerApiServicesV1RoleServiceRemoveRolePrincipalsBodyToJSONTyped(json, false);
}

export function ControllerApiServicesV1RoleServiceRemoveRolePrincipalsBodyToJSONTyped(value?: ControllerApiServicesV1RoleServiceRemoveRolePrincipalsBody | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
