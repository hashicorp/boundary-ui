 ...
 * recorded session.
 * @export
 * @interface ControllerApiResourcesSessionrecordingsV1HostCatalog
 */
export interface ControllerApiResourcesSessionrecordingsV1HostCatalog {
    /**
     * 
     * @type {string}
     * @memberof ControllerApiResourcesSessionrecordingsV1HostCatalog
     */
    id?: string;
    /**
     * 
...
/**
 * Check if a given object implements the ControllerApiResourcesSessionrecordingsV1HostCatalog interface.
 */
export function instanceOfControllerApiResourcesSessionrecordingsV1HostCatalog(value: object): value is ControllerApiResourcesSessionrecordingsV1HostCatalog {
    return true;
}

export function ControllerApiResourcesSessionrecordingsV1HostCatalogFromJSON(json: any): ControllerApiResourcesSessionrecordingsV1HostCatalog {
    return ControllerApiResourcesSessionrecordingsV1HostCatalogFromJSONTyped(json, false);
}

export function ControllerApiResourcesSessionrecordingsV1HostCatalogFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiResourcesSessionrecordingsV1HostCatalog {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiResourcesSessionrecordingsV1HostCatalogToJSON(json: any): ControllerApiResourcesSessionrecordingsV1HostCatalog {
    return ControllerApiResourcesSessionrecordingsV1HostCatalogToJSONTyped(json, false);
}

export function ControllerApiResourcesSessionrecordingsV1HostCatalogToJSONTyped(value?: ControllerApiResourcesSessionrecordingsV1HostCatalog | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
