 ...
 * 
 * @export
 * @interface ControllerApiServicesV1UserServiceSetUserAccountsBody
 */
export interface ControllerApiServicesV1UserServiceSetUserAccountsBody {
    /**
     * The version ensures the User hasn't changed since it was last retrieved and if it has the request will fail.
     * @type {number}
     * @memberof ControllerApiServicesV1UserServiceSetUserAccountsBody
     */
    version?: number;
    /**
     * 
...
/**
 * Check if a given object implements the ControllerApiServicesV1UserServiceSetUserAccountsBody interface.
 */
export function instanceOfControllerApiServicesV1UserServiceSetUserAccountsBody(value: object): value is ControllerApiServicesV1UserServiceSetUserAccountsBody {
    return true;
}

export function ControllerApiServicesV1UserServiceSetUserAccountsBodyFromJSON(json: any): ControllerApiServicesV1UserServiceSetUserAccountsBody {
    return ControllerApiServicesV1UserServiceSetUserAccountsBodyFromJSONTyped(json, false);
}

export function ControllerApiServicesV1UserServiceSetUserAccountsBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1UserServiceSetUserAccountsBody {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiServicesV1UserServiceSetUserAccountsBodyToJSON(json: any): ControllerApiServicesV1UserServiceSetUserAccountsBody {
    return ControllerApiServicesV1UserServiceSetUserAccountsBodyToJSONTyped(json, false);
}

export function ControllerApiServicesV1UserServiceSetUserAccountsBodyToJSONTyped(value?: ControllerApiServicesV1UserServiceSetUserAccountsBody | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
