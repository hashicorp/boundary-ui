 ...
 * 
 * @export
 * @interface ControllerApiServicesV1CreateHostSetResponse
 */
export interface ControllerApiServicesV1CreateHostSetResponse {
    /**
     * 
     * @type {string}
     * @memberof ControllerApiServicesV1CreateHostSetResponse
     */
    uri?: string;
    /**
     * 
...
/**
 * Check if a given object implements the ControllerApiServicesV1CreateHostSetResponse interface.
 */
export function instanceOfControllerApiServicesV1CreateHostSetResponse(value: object): value is ControllerApiServicesV1CreateHostSetResponse {
    return true;
}

export function ControllerApiServicesV1CreateHostSetResponseFromJSON(json: any): ControllerApiServicesV1CreateHostSetResponse {
    return ControllerApiServicesV1CreateHostSetResponseFromJSONTyped(json, false);
}

export function ControllerApiServicesV1CreateHostSetResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1CreateHostSetResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiServicesV1CreateHostSetResponseToJSON(json: any): ControllerApiServicesV1CreateHostSetResponse {
    return ControllerApiServicesV1CreateHostSetResponseToJSONTyped(json, false);
}

export function ControllerApiServicesV1CreateHostSetResponseToJSONTyped(value?: ControllerApiServicesV1CreateHostSetResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
