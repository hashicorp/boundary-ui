 ...
 * 
 * @export
 * @interface ControllerApiServicesV1RemoveWorkerTagsResponse
 */
export interface ControllerApiServicesV1RemoveWorkerTagsResponse {
    /**
     * 
     * @type {ControllerApiResourcesWorkersV1Worker}
     * @memberof ControllerApiServicesV1RemoveWorkerTagsResponse
     */
    item?: ControllerApiResourcesWorkersV1Worker;
}

/**
 * Check if a given object implements the ControllerApiServicesV1RemoveWorkerTagsResponse interface.
 */
export function instanceOfControllerApiServicesV1RemoveWorkerTagsResponse(value: object): value is ControllerApiServicesV1RemoveWorkerTagsResponse {
    return true;
}

export function ControllerApiServicesV1RemoveWorkerTagsResponseFromJSON(json: any): ControllerApiServicesV1RemoveWorkerTagsResponse {
    return ControllerApiServicesV1RemoveWorkerTagsResponseFromJSONTyped(json, false);
}

export function ControllerApiServicesV1RemoveWorkerTagsResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1RemoveWorkerTagsResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiServicesV1RemoveWorkerTagsResponseToJSON(json: any): ControllerApiServicesV1RemoveWorkerTagsResponse {
    return ControllerApiServicesV1RemoveWorkerTagsResponseToJSONTyped(json, false);
}

export function ControllerApiServicesV1RemoveWorkerTagsResponseToJSONTyped(value?: ControllerApiServicesV1RemoveWorkerTagsResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
