 ...
 * 
 * @export
 * @interface ControllerApiServicesV1AddTargetCredentialSourcesResponse
 */
export interface ControllerApiServicesV1AddTargetCredentialSourcesResponse {
    /**
     * 
     * @type {ControllerApiResourcesTargetsV1Target}
     * @memberof ControllerApiServicesV1AddTargetCredentialSourcesResponse
     */
    item?: ControllerApiResourcesTargetsV1Target;
}

/**
 * Check if a given object implements the ControllerApiServicesV1AddTargetCredentialSourcesResponse interface.
 */
export function instanceOfControllerApiServicesV1AddTargetCredentialSourcesResponse(value: object): value is ControllerApiServicesV1AddTargetCredentialSourcesResponse {
    return true;
}

export function ControllerApiServicesV1AddTargetCredentialSourcesResponseFromJSON(json: any): ControllerApiServicesV1AddTargetCredentialSourcesResponse {
    return ControllerApiServicesV1AddTargetCredentialSourcesResponseFromJSONTyped(json, false);
}

export function ControllerApiServicesV1AddTargetCredentialSourcesResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1AddTargetCredentialSourcesResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiServicesV1AddTargetCredentialSourcesResponseToJSON(json: any): ControllerApiServicesV1AddTargetCredentialSourcesResponse {
    return ControllerApiServicesV1AddTargetCredentialSourcesResponseToJSONTyped(json, false);
}

export function ControllerApiServicesV1AddTargetCredentialSourcesResponseToJSONTyped(value?: ControllerApiServicesV1AddTargetCredentialSourcesResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
