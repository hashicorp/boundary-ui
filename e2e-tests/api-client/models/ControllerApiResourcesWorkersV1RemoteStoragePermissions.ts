 ...
 * 
 * @export
 * @interface ControllerApiResourcesWorkersV1RemoteStoragePermissions
 */
export interface ControllerApiResourcesWorkersV1RemoteStoragePermissions {
    /**
     ...
     * @type {string}
     * @memberof ControllerApiResourcesWorkersV1RemoteStoragePermissions
     */
     ...
     * @memberof ControllerApiResourcesWorkersV1RemoteStoragePermissions
     */
    readonly _delete?: string;
}

/**
 * Check if a given object implements the ControllerApiResourcesWorkersV1RemoteStoragePermissions interface.
 */
export function instanceOfControllerApiResourcesWorkersV1RemoteStoragePermissions(value: object): value is ControllerApiResourcesWorkersV1RemoteStoragePermissions {
    return true;
}

export function ControllerApiResourcesWorkersV1RemoteStoragePermissionsFromJSON(json: any): ControllerApiResourcesWorkersV1RemoteStoragePermissions {
    return ControllerApiResourcesWorkersV1RemoteStoragePermissionsFromJSONTyped(json, false);
}

export function ControllerApiResourcesWorkersV1RemoteStoragePermissionsFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiResourcesWorkersV1RemoteStoragePermissions {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiResourcesWorkersV1RemoteStoragePermissionsToJSON(json: any): ControllerApiResourcesWorkersV1RemoteStoragePermissions {
    return ControllerApiResourcesWorkersV1RemoteStoragePermissionsToJSONTyped(json, false);
}

export function ControllerApiResourcesWorkersV1RemoteStoragePermissionsToJSONTyped(value?: Omit<ControllerApiResourcesWorkersV1RemoteStoragePermissions, 'write'|'read'|'delete'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
