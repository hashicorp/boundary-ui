...
import type { ControllerApiResourcesWorkersV1Certificate } from './ControllerApiResourcesWorkersV1Certificate';
import {
    ControllerApiResourcesWorkersV1CertificateFromJSON,
    ControllerApiResourcesWorkersV1CertificateFromJSONTyped,
    ControllerApiResourcesWorkersV1CertificateToJSON,
    ControllerApiResourcesWorkersV1CertificateToJSONTyped,
} from './ControllerApiResourcesWorkersV1Certificate';

/**
 * 
 * @export
 * @interface ControllerApiResourcesWorkersV1CertificateAuthority
 */
export interface ControllerApiResourcesWorkersV1CertificateAuthority {
    /**
     * 
     * @type {Array<ControllerApiResourcesWorkersV1Certificate>}
     * @memberof ControllerApiResourcesWorkersV1CertificateAuthority
     */
    certs?: Array<ControllerApiResourcesWorkersV1Certificate>;
}

/**
 * Check if a given object implements the ControllerApiResourcesWorkersV1CertificateAuthority interface.
 */
export function instanceOfControllerApiResourcesWorkersV1CertificateAuthority(value: object): value is ControllerApiResourcesWorkersV1CertificateAuthority {
    return true;
}

export function ControllerApiResourcesWorkersV1CertificateAuthorityFromJSON(json: any): ControllerApiResourcesWorkersV1CertificateAuthority {
    return ControllerApiResourcesWorkersV1CertificateAuthorityFromJSONTyped(json, false);
}

export function ControllerApiResourcesWorkersV1CertificateAuthorityFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiResourcesWorkersV1CertificateAuthority {
    if (json == null) {
        return json;
    }
    return {
        
        'certs': json['certs'] == null ? undefined : ((json['certs'] as Array<any>).map(ControllerApiResourcesWorkersV1CertificateFromJSON)),
    };
}

export function ControllerApiResourcesWorkersV1CertificateAuthorityToJSON(json: any): ControllerApiResourcesWorkersV1CertificateAuthority {
    return ControllerApiResourcesWorkersV1CertificateAuthorityToJSONTyped(json, false);
}

export function ControllerApiResourcesWorkersV1CertificateAuthorityToJSONTyped(value?: ControllerApiResourcesWorkersV1CertificateAuthority | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'certs': value['certs'] == null ? undefined : ((value['certs'] as Array<any>).map(ControllerApiResourcesWorkersV1CertificateToJSON)),
    };
}
