 ...
 * 
 * @export
 * @interface ControllerApiServicesV1RoleServiceAddRoleGrantScopesBody
 */
export interface ControllerApiServicesV1RoleServiceAddRoleGrantScopesBody {
    /**
     * Version is used to ensure this resource has not changed.
     * The mutation will fail if the version does not match the latest known good version.
     * @type {number}
     * @memberof ControllerApiServicesV1RoleServiceAddRoleGrantScopesBody
     */
    version?: number;
    /**
     * 
...
/**
 * Check if a given object implements the ControllerApiServicesV1RoleServiceAddRoleGrantScopesBody interface.
 */
export function instanceOfControllerApiServicesV1RoleServiceAddRoleGrantScopesBody(value: object): value is ControllerApiServicesV1RoleServiceAddRoleGrantScopesBody {
    return true;
}

export function ControllerApiServicesV1RoleServiceAddRoleGrantScopesBodyFromJSON(json: any): ControllerApiServicesV1RoleServiceAddRoleGrantScopesBody {
    return ControllerApiServicesV1RoleServiceAddRoleGrantScopesBodyFromJSONTyped(json, false);
}

export function ControllerApiServicesV1RoleServiceAddRoleGrantScopesBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1RoleServiceAddRoleGrantScopesBody {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiServicesV1RoleServiceAddRoleGrantScopesBodyToJSON(json: any): ControllerApiServicesV1RoleServiceAddRoleGrantScopesBody {
    return ControllerApiServicesV1RoleServiceAddRoleGrantScopesBodyToJSONTyped(json, false);
}

export function ControllerApiServicesV1RoleServiceAddRoleGrantScopesBodyToJSONTyped(value?: ControllerApiServicesV1RoleServiceAddRoleGrantScopesBody | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
