...
import type { ControllerApiResourcesAuthtokensV1AuthToken } from './ControllerApiResourcesAuthtokensV1AuthToken';
import {
    ControllerApiResourcesAuthtokensV1AuthTokenFromJSON,
    ControllerApiResourcesAuthtokensV1AuthTokenFromJSONTyped,
    ControllerApiResourcesAuthtokensV1AuthTokenToJSON,
    ControllerApiResourcesAuthtokensV1AuthTokenToJSONTyped,
} from './ControllerApiResourcesAuthtokensV1AuthToken';

/**
 * 
 * @export
 * @interface ControllerApiServicesV1ListAuthTokensResponse
 */
export interface ControllerApiServicesV1ListAuthTokensResponse {
    /**
     * 
     * @type {Array<ControllerApiResourcesAuthtokensV1AuthToken>}
     * @memberof ControllerApiServicesV1ListAuthTokensResponse
     */
    items?: Array<ControllerApiResourcesAuthtokensV1AuthToken>;
    /**
...
/**
 * Check if a given object implements the ControllerApiServicesV1ListAuthTokensResponse interface.
 */
export function instanceOfControllerApiServicesV1ListAuthTokensResponse(value: object): value is ControllerApiServicesV1ListAuthTokensResponse {
    return true;
}

export function ControllerApiServicesV1ListAuthTokensResponseFromJSON(json: any): ControllerApiServicesV1ListAuthTokensResponse {
    return ControllerApiServicesV1ListAuthTokensResponseFromJSONTyped(json, false);
}

export function ControllerApiServicesV1ListAuthTokensResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1ListAuthTokensResponse {
    if (json == null) {
        return json;
    }
    return {
        
        'items': json['items'] == null ? undefined : ((json['items'] as Array<any>).map(ControllerApiResourcesAuthtokensV1AuthTokenFromJSON)),
...
export function ControllerApiServicesV1ListAuthTokensResponseToJSON(json: any): ControllerApiServicesV1ListAuthTokensResponse {
    return ControllerApiServicesV1ListAuthTokensResponseToJSONTyped(json, false);
}

export function ControllerApiServicesV1ListAuthTokensResponseToJSONTyped(value?: ControllerApiServicesV1ListAuthTokensResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'items': value['items'] == null ? undefined : ((value['items'] as Array<any>).map(ControllerApiResourcesAuthtokensV1AuthTokenToJSON)),
