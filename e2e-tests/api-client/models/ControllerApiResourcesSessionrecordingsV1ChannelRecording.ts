 ...
 * @export
 * @interface ControllerApiResourcesSessionrecordingsV1ChannelRecording
 */
export interface ControllerApiResourcesSessionrecordingsV1ChannelRecording {
    /**
     * The ID of the Channel recording.
     * @type {string}
     * @memberof ControllerApiResourcesSessionrecordingsV1ChannelRecording
     */
    id?: string;
    /**
...
/**
 * Check if a given object implements the ControllerApiResourcesSessionrecordingsV1ChannelRecording interface.
 */
export function instanceOfControllerApiResourcesSessionrecordingsV1ChannelRecording(value: object): value is ControllerApiResourcesSessionrecordingsV1ChannelRecording {
    return true;
}

export function ControllerApiResourcesSessionrecordingsV1ChannelRecordingFromJSON(json: any): ControllerApiResourcesSessionrecordingsV1ChannelRecording {
    return ControllerApiResourcesSessionrecordingsV1ChannelRecordingFromJSONTyped(json, false);
}

export function ControllerApiResourcesSessionrecordingsV1ChannelRecordingFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiResourcesSessionrecordingsV1ChannelRecording {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiResourcesSessionrecordingsV1ChannelRecordingToJSON(json: any): ControllerApiResourcesSessionrecordingsV1ChannelRecording {
    return ControllerApiResourcesSessionrecordingsV1ChannelRecordingToJSONTyped(json, false);
}

export function ControllerApiResourcesSessionrecordingsV1ChannelRecordingToJSONTyped(value?: ControllerApiResourcesSessionrecordingsV1ChannelRecording | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
