 ...
 * 
 * @export
 * @interface ControllerApiServicesV1GetSessionResponse
 */
export interface ControllerApiServicesV1GetSessionResponse {
    /**
     * 
     * @type {ControllerApiResourcesSessionsV1Session}
     * @memberof ControllerApiServicesV1GetSessionResponse
     */
    item?: ControllerApiResourcesSessionsV1Session;
}

/**
 * Check if a given object implements the ControllerApiServicesV1GetSessionResponse interface.
 */
export function instanceOfControllerApiServicesV1GetSessionResponse(value: object): value is ControllerApiServicesV1GetSessionResponse {
    return true;
}

export function ControllerApiServicesV1GetSessionResponseFromJSON(json: any): ControllerApiServicesV1GetSessionResponse {
    return ControllerApiServicesV1GetSessionResponseFromJSONTyped(json, false);
}

export function ControllerApiServicesV1GetSessionResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1GetSessionResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiServicesV1GetSessionResponseToJSON(json: any): ControllerApiServicesV1GetSessionResponse {
    return ControllerApiServicesV1GetSessionResponseToJSONTyped(json, false);
}

export function ControllerApiServicesV1GetSessionResponseToJSONTyped(value?: ControllerApiServicesV1GetSessionResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
