 ...
 * 
 * @export
 * @interface ControllerApiServicesV1TargetServiceAuthorizeSessionBody
 */
export interface ControllerApiServicesV1TargetServiceAuthorizeSessionBody {
    /**
     * The name of the target. When using this, scope_id or scope_name must be set.
     * @type {string}
     * @memberof ControllerApiServicesV1TargetServiceAuthorizeSessionBody
     */
    name?: string;
    /**
...
/**
 * Check if a given object implements the ControllerApiServicesV1TargetServiceAuthorizeSessionBody interface.
 */
export function instanceOfControllerApiServicesV1TargetServiceAuthorizeSessionBody(value: object): value is ControllerApiServicesV1TargetServiceAuthorizeSessionBody {
    return true;
}

export function ControllerApiServicesV1TargetServiceAuthorizeSessionBodyFromJSON(json: any): ControllerApiServicesV1TargetServiceAuthorizeSessionBody {
    return ControllerApiServicesV1TargetServiceAuthorizeSessionBodyFromJSONTyped(json, false);
}

export function ControllerApiServicesV1TargetServiceAuthorizeSessionBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1TargetServiceAuthorizeSessionBody {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiServicesV1TargetServiceAuthorizeSessionBodyToJSON(json: any): ControllerApiServicesV1TargetServiceAuthorizeSessionBody {
    return ControllerApiServicesV1TargetServiceAuthorizeSessionBodyToJSONTyped(json, false);
}

export function ControllerApiServicesV1TargetServiceAuthorizeSessionBodyToJSONTyped(value?: ControllerApiServicesV1TargetServiceAuthorizeSessionBody | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
