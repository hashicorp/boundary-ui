 ...
 * @export
 * @interface ControllerApiResourcesScopesV1KeyVersionDestructionJob
 */
export interface ControllerApiResourcesScopesV1KeyVersionDestructionJob {
    /**
     * The ID of the Key version this job relates to.
     * @type {string}
     * @memberof ControllerApiResourcesScopesV1KeyVersionDestructionJob
     */
    keyVersionId?: string;
    /**
     * 
...
/**
 * Check if a given object implements the ControllerApiResourcesScopesV1KeyVersionDestructionJob interface.
 */
export function instanceOfControllerApiResourcesScopesV1KeyVersionDestructionJob(value: object): value is ControllerApiResourcesScopesV1KeyVersionDestructionJob {
    return true;
}

export function ControllerApiResourcesScopesV1KeyVersionDestructionJobFromJSON(json: any): ControllerApiResourcesScopesV1KeyVersionDestructionJob {
    return ControllerApiResourcesScopesV1KeyVersionDestructionJobFromJSONTyped(json, false);
}

export function ControllerApiResourcesScopesV1KeyVersionDestructionJobFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiResourcesScopesV1KeyVersionDestructionJob {
    if (json == null) {
        return json;
    }
    return {
        
        'keyVersionId': json['key_version_id'] == null ? undefined : json['key_version_id'],
        ...
        'completedCount': json['completed_count'] == null ? undefined : json['completed_count'],
        'totalCount': json['total_count'] == null ? undefined : json['total_count'],
    };
}

export function ControllerApiResourcesScopesV1KeyVersionDestructionJobToJSON(json: any): ControllerApiResourcesScopesV1KeyVersionDestructionJob {
    return ControllerApiResourcesScopesV1KeyVersionDestructionJobToJSONTyped(json, false);
}

export function ControllerApiResourcesScopesV1KeyVersionDestructionJobToJSONTyped(value?: ControllerApiResourcesScopesV1KeyVersionDestructionJob | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'key_version_id': value['keyVersionId'],
