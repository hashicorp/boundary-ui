 ...
 * 
 * @export
 * @interface ControllerApiServicesV1CreateRoleResponse
 */
export interface ControllerApiServicesV1CreateRoleResponse {
    /**
     * 
     * @type {string}
     * @memberof ControllerApiServicesV1CreateRoleResponse
     */
    uri?: string;
    /**
     * 
...
/**
 * Check if a given object implements the ControllerApiServicesV1CreateRoleResponse interface.
 */
export function instanceOfControllerApiServicesV1CreateRoleResponse(value: object): value is ControllerApiServicesV1CreateRoleResponse {
    return true;
}

export function ControllerApiServicesV1CreateRoleResponseFromJSON(json: any): ControllerApiServicesV1CreateRoleResponse {
    return ControllerApiServicesV1CreateRoleResponseFromJSONTyped(json, false);
}

export function ControllerApiServicesV1CreateRoleResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1CreateRoleResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiServicesV1CreateRoleResponseToJSON(json: any): ControllerApiServicesV1CreateRoleResponse {
    return ControllerApiServicesV1CreateRoleResponseToJSONTyped(json, false);
}

export function ControllerApiServicesV1CreateRoleResponseToJSONTyped(value?: ControllerApiServicesV1CreateRoleResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
