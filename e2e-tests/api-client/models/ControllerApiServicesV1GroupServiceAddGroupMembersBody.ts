 ...
 * 
 * @export
 * @interface ControllerApiServicesV1GroupServiceAddGroupMembersBody
 */
export interface ControllerApiServicesV1GroupServiceAddGroupMembersBody {
    /**
     * Version is used to ensure this resource has not changed.
     * The mutation will fail if the version does not match the latest known good version.
     * @type {number}
     * @memberof ControllerApiServicesV1GroupServiceAddGroupMembersBody
     */
    version?: number;
    /**
     * 
...
/**
 * Check if a given object implements the ControllerApiServicesV1GroupServiceAddGroupMembersBody interface.
 */
export function instanceOfControllerApiServicesV1GroupServiceAddGroupMembersBody(value: object): value is ControllerApiServicesV1GroupServiceAddGroupMembersBody {
    return true;
}

export function ControllerApiServicesV1GroupServiceAddGroupMembersBodyFromJSON(json: any): ControllerApiServicesV1GroupServiceAddGroupMembersBody {
    return ControllerApiServicesV1GroupServiceAddGroupMembersBodyFromJSONTyped(json, false);
}

export function ControllerApiServicesV1GroupServiceAddGroupMembersBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1GroupServiceAddGroupMembersBody {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiServicesV1GroupServiceAddGroupMembersBodyToJSON(json: any): ControllerApiServicesV1GroupServiceAddGroupMembersBody {
    return ControllerApiServicesV1GroupServiceAddGroupMembersBodyToJSONTyped(json, false);
}

export function ControllerApiServicesV1GroupServiceAddGroupMembersBodyToJSONTyped(value?: ControllerApiServicesV1GroupServiceAddGroupMembersBody | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
