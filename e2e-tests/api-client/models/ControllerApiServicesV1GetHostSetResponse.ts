 ...
 * 
 * @export
 * @interface ControllerApiServicesV1GetHostSetResponse
 */
export interface ControllerApiServicesV1GetHostSetResponse {
    /**
     * 
     * @type {ControllerApiResourcesHostsetsV1HostSet}
     * @memberof ControllerApiServicesV1GetHostSetResponse
     */
    item?: ControllerApiResourcesHostsetsV1HostSet;
}

/**
 * Check if a given object implements the ControllerApiServicesV1GetHostSetResponse interface.
 */
export function instanceOfControllerApiServicesV1GetHostSetResponse(value: object): value is ControllerApiServicesV1GetHostSetResponse {
    return true;
}

export function ControllerApiServicesV1GetHostSetResponseFromJSON(json: any): ControllerApiServicesV1GetHostSetResponse {
    return ControllerApiServicesV1GetHostSetResponseFromJSONTyped(json, false);
}

export function ControllerApiServicesV1GetHostSetResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1GetHostSetResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiServicesV1GetHostSetResponseToJSON(json: any): ControllerApiServicesV1GetHostSetResponse {
    return ControllerApiServicesV1GetHostSetResponseToJSONTyped(json, false);
}

export function ControllerApiServicesV1GetHostSetResponseToJSONTyped(value?: ControllerApiServicesV1GetHostSetResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
