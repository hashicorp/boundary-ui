 ...
 * 
 * @export
 * @interface ControllerApiServicesV1CreateAuthMethodResponse
 */
export interface ControllerApiServicesV1CreateAuthMethodResponse {
    /**
     * 
     * @type {string}
     * @memberof ControllerApiServicesV1CreateAuthMethodResponse
     */
    uri?: string;
    /**
     * 
...
/**
 * Check if a given object implements the ControllerApiServicesV1CreateAuthMethodResponse interface.
 */
export function instanceOfControllerApiServicesV1CreateAuthMethodResponse(value: object): value is ControllerApiServicesV1CreateAuthMethodResponse {
    return true;
}

export function ControllerApiServicesV1CreateAuthMethodResponseFromJSON(json: any): ControllerApiServicesV1CreateAuthMethodResponse {
    return ControllerApiServicesV1CreateAuthMethodResponseFromJSONTyped(json, false);
}

export function ControllerApiServicesV1CreateAuthMethodResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1CreateAuthMethodResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiServicesV1CreateAuthMethodResponseToJSON(json: any): ControllerApiServicesV1CreateAuthMethodResponse {
    return ControllerApiServicesV1CreateAuthMethodResponseToJSONTyped(json, false);
}

export function ControllerApiServicesV1CreateAuthMethodResponseToJSONTyped(value?: ControllerApiServicesV1CreateAuthMethodResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
