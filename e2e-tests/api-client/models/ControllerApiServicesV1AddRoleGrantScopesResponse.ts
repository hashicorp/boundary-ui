 ...
 * 
 * @export
 * @interface ControllerApiServicesV1AddRoleGrantScopesResponse
 */
export interface ControllerApiServicesV1AddRoleGrantScopesResponse {
    /**
     * 
     * @type {ControllerApiResourcesRolesV1Role}
     * @memberof ControllerApiServicesV1AddRoleGrantScopesResponse
     */
    item?: ControllerApiResourcesRolesV1Role;
}

/**
 * Check if a given object implements the ControllerApiServicesV1AddRoleGrantScopesResponse interface.
 */
export function instanceOfControllerApiServicesV1AddRoleGrantScopesResponse(value: object): value is ControllerApiServicesV1AddRoleGrantScopesResponse {
    return true;
}

export function ControllerApiServicesV1AddRoleGrantScopesResponseFromJSON(json: any): ControllerApiServicesV1AddRoleGrantScopesResponse {
    return ControllerApiServicesV1AddRoleGrantScopesResponseFromJSONTyped(json, false);
}

export function ControllerApiServicesV1AddRoleGrantScopesResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1AddRoleGrantScopesResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiServicesV1AddRoleGrantScopesResponseToJSON(json: any): ControllerApiServicesV1AddRoleGrantScopesResponse {
    return ControllerApiServicesV1AddRoleGrantScopesResponseToJSONTyped(json, false);
}

export function ControllerApiServicesV1AddRoleGrantScopesResponseToJSONTyped(value?: ControllerApiServicesV1AddRoleGrantScopesResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
