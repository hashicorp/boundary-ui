 ...
 * 
 * @export
 * @interface ControllerApiServicesV1GetUserResponse
 */
export interface ControllerApiServicesV1GetUserResponse {
    /**
     * 
     * @type {ControllerApiResourcesUsersV1User}
     * @memberof ControllerApiServicesV1GetUserResponse
     */
    item?: ControllerApiResourcesUsersV1User;
}

/**
 * Check if a given object implements the ControllerApiServicesV1GetUserResponse interface.
 */
export function instanceOfControllerApiServicesV1GetUserResponse(value: object): value is ControllerApiServicesV1GetUserResponse {
    return true;
}

export function ControllerApiServicesV1GetUserResponseFromJSON(json: any): ControllerApiServicesV1GetUserResponse {
    return ControllerApiServicesV1GetUserResponseFromJSONTyped(json, false);
}

export function ControllerApiServicesV1GetUserResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1GetUserResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiServicesV1GetUserResponseToJSON(json: any): ControllerApiServicesV1GetUserResponse {
    return ControllerApiServicesV1GetUserResponseToJSONTyped(json, false);
}

export function ControllerApiServicesV1GetUserResponseToJSONTyped(value?: ControllerApiServicesV1GetUserResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
