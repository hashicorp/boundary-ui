 ...
 * 
 * @export
 * @interface ControllerApiServicesV1CreateCredentialResponse
 */
export interface ControllerApiServicesV1CreateCredentialResponse {
    /**
     * 
     * @type {string}
     * @memberof ControllerApiServicesV1CreateCredentialResponse
     */
    uri?: string;
    /**
     * 
...
/**
 * Check if a given object implements the ControllerApiServicesV1CreateCredentialResponse interface.
 */
export function instanceOfControllerApiServicesV1CreateCredentialResponse(value: object): value is ControllerApiServicesV1CreateCredentialResponse {
    return true;
}

export function ControllerApiServicesV1CreateCredentialResponseFromJSON(json: any): ControllerApiServicesV1CreateCredentialResponse {
    return ControllerApiServicesV1CreateCredentialResponseFromJSONTyped(json, false);
}

export function ControllerApiServicesV1CreateCredentialResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1CreateCredentialResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiServicesV1CreateCredentialResponseToJSON(json: any): ControllerApiServicesV1CreateCredentialResponse {
    return ControllerApiServicesV1CreateCredentialResponseToJSONTyped(json, false);
}

export function ControllerApiServicesV1CreateCredentialResponseToJSONTyped(value?: ControllerApiServicesV1CreateCredentialResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
