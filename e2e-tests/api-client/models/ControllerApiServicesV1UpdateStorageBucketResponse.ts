 ...
 * 
 * @export
 * @interface ControllerApiServicesV1UpdateStorageBucketResponse
 */
export interface ControllerApiServicesV1UpdateStorageBucketResponse {
    /**
     * 
     * @type {ControllerApiResourcesStoragebucketsV1StorageBucket}
     * @memberof ControllerApiServicesV1UpdateStorageBucketResponse
     */
    item?: ControllerApiResourcesStoragebucketsV1StorageBucket;
}

/**
 * Check if a given object implements the ControllerApiServicesV1UpdateStorageBucketResponse interface.
 */
export function instanceOfControllerApiServicesV1UpdateStorageBucketResponse(value: object): value is ControllerApiServicesV1UpdateStorageBucketResponse {
    return true;
}

export function ControllerApiServicesV1UpdateStorageBucketResponseFromJSON(json: any): ControllerApiServicesV1UpdateStorageBucketResponse {
    return ControllerApiServicesV1UpdateStorageBucketResponseFromJSONTyped(json, false);
}

export function ControllerApiServicesV1UpdateStorageBucketResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1UpdateStorageBucketResponse {
    if (json == null) {
        return json;
    }
    return {
        
        'item': json['item'] == null ? undefined : ControllerApiResourcesStoragebucketsV1StorageBucketFromJSON(json['item']),
    };
}

export function ControllerApiServicesV1UpdateStorageBucketResponseToJSON(json: any): ControllerApiServicesV1UpdateStorageBucketResponse {
    return ControllerApiServicesV1UpdateStorageBucketResponseToJSONTyped(json, false);
}

export function ControllerApiServicesV1UpdateStorageBucketResponseToJSONTyped(value?: ControllerApiServicesV1UpdateStorageBucketResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'item': ControllerApiResourcesStoragebucketsV1StorageBucketToJSON(value['item']),
    };
}
