 ...
 * 
 * @export
 * @interface ControllerApiServicesV1UpdateUserResponse
 */
export interface ControllerApiServicesV1UpdateUserResponse {
    /**
     * 
     * @type {ControllerApiResourcesUsersV1User}
     * @memberof ControllerApiServicesV1UpdateUserResponse
     */
    item?: ControllerApiResourcesUsersV1User;
}

/**
 * Check if a given object implements the ControllerApiServicesV1UpdateUserResponse interface.
 */
export function instanceOfControllerApiServicesV1UpdateUserResponse(value: object): value is ControllerApiServicesV1UpdateUserResponse {
    return true;
}

export function ControllerApiServicesV1UpdateUserResponseFromJSON(json: any): ControllerApiServicesV1UpdateUserResponse {
    return ControllerApiServicesV1UpdateUserResponseFromJSONTyped(json, false);
}

export function ControllerApiServicesV1UpdateUserResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1UpdateUserResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiServicesV1UpdateUserResponseToJSON(json: any): ControllerApiServicesV1UpdateUserResponse {
    return ControllerApiServicesV1UpdateUserResponseToJSONTyped(json, false);
}

export function ControllerApiServicesV1UpdateUserResponseToJSONTyped(value?: ControllerApiServicesV1UpdateUserResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
