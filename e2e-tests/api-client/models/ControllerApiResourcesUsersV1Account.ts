 ...
 * 
 * @export
 * @interface ControllerApiResourcesUsersV1Account
 */
export interface ControllerApiResourcesUsersV1Account {
    /**
     * Output only. The ID of the Account.
     * @type {string}
     * @memberof ControllerApiResourcesUsersV1Account
     */
    readonly id?: string;
    /**
...
/**
 * Check if a given object implements the ControllerApiResourcesUsersV1Account interface.
 */
export function instanceOfControllerApiResourcesUsersV1Account(value: object): value is ControllerApiResourcesUsersV1Account {
    return true;
}

export function ControllerApiResourcesUsersV1AccountFromJSON(json: any): ControllerApiResourcesUsersV1Account {
    return ControllerApiResourcesUsersV1AccountFromJSONTyped(json, false);
}

export function ControllerApiResourcesUsersV1AccountFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiResourcesUsersV1Account {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiResourcesUsersV1AccountToJSON(json: any): ControllerApiResourcesUsersV1Account {
    return ControllerApiResourcesUsersV1AccountToJSONTyped(json, false);
}

export function ControllerApiResourcesUsersV1AccountToJSONTyped(value?: Omit<ControllerApiResourcesUsersV1Account, 'id'|'scope_id'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
