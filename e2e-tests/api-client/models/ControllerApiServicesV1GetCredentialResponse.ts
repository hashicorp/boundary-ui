 ...
 * 
 * @export
 * @interface ControllerApiServicesV1GetCredentialResponse
 */
export interface ControllerApiServicesV1GetCredentialResponse {
    /**
     * 
     * @type {ControllerApiResourcesCredentialsV1Credential}
     * @memberof ControllerApiServicesV1GetCredentialResponse
     */
    item?: ControllerApiResourcesCredentialsV1Credential;
}

/**
 * Check if a given object implements the ControllerApiServicesV1GetCredentialResponse interface.
 */
export function instanceOfControllerApiServicesV1GetCredentialResponse(value: object): value is ControllerApiServicesV1GetCredentialResponse {
    return true;
}

export function ControllerApiServicesV1GetCredentialResponseFromJSON(json: any): ControllerApiServicesV1GetCredentialResponse {
    return ControllerApiServicesV1GetCredentialResponseFromJSONTyped(json, false);
}

export function ControllerApiServicesV1GetCredentialResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1GetCredentialResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiServicesV1GetCredentialResponseToJSON(json: any): ControllerApiServicesV1GetCredentialResponse {
    return ControllerApiServicesV1GetCredentialResponseToJSONTyped(json, false);
}

export function ControllerApiServicesV1GetCredentialResponseToJSONTyped(value?: ControllerApiServicesV1GetCredentialResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
