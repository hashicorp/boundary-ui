 ...
 * 
 * @export
 * @interface ControllerApiServicesV1UpdateCredentialResponse
 */
export interface ControllerApiServicesV1UpdateCredentialResponse {
    /**
     * 
     * @type {ControllerApiResourcesCredentialsV1Credential}
     * @memberof ControllerApiServicesV1UpdateCredentialResponse
     */
    item?: ControllerApiResourcesCredentialsV1Credential;
}

/**
 * Check if a given object implements the ControllerApiServicesV1UpdateCredentialResponse interface.
 */
export function instanceOfControllerApiServicesV1UpdateCredentialResponse(value: object): value is ControllerApiServicesV1UpdateCredentialResponse {
    return true;
}

export function ControllerApiServicesV1UpdateCredentialResponseFromJSON(json: any): ControllerApiServicesV1UpdateCredentialResponse {
    return ControllerApiServicesV1UpdateCredentialResponseFromJSONTyped(json, false);
}

export function ControllerApiServicesV1UpdateCredentialResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1UpdateCredentialResponse {
    if (json == null) {
        return json;
    }
    return {
        
        'item': json['item'] == null ? undefined : ControllerApiResourcesCredentialsV1CredentialFromJSON(json['item']),
    };
}

export function ControllerApiServicesV1UpdateCredentialResponseToJSON(json: any): ControllerApiServicesV1UpdateCredentialResponse {
    return ControllerApiServicesV1UpdateCredentialResponseToJSONTyped(json, false);
}

export function ControllerApiServicesV1UpdateCredentialResponseToJSONTyped(value?: ControllerApiServicesV1UpdateCredentialResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'item': ControllerApiResourcesCredentialsV1CredentialToJSON(value['item']),
    };
}
