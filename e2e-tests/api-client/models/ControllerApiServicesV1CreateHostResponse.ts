 ...
 * 
 * @export
 * @interface ControllerApiServicesV1CreateHostResponse
 */
export interface ControllerApiServicesV1CreateHostResponse {
    /**
     * 
     * @type {string}
     * @memberof ControllerApiServicesV1CreateHostResponse
     */
    uri?: string;
    /**
     * 
...
/**
 * Check if a given object implements the ControllerApiServicesV1CreateHostResponse interface.
 */
export function instanceOfControllerApiServicesV1CreateHostResponse(value: object): value is ControllerApiServicesV1CreateHostResponse {
    return true;
}

export function ControllerApiServicesV1CreateHostResponseFromJSON(json: any): ControllerApiServicesV1CreateHostResponse {
    return ControllerApiServicesV1CreateHostResponseFromJSONTyped(json, false);
}

export function ControllerApiServicesV1CreateHostResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1CreateHostResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiServicesV1CreateHostResponseToJSON(json: any): ControllerApiServicesV1CreateHostResponse {
    return ControllerApiServicesV1CreateHostResponseToJSONTyped(json, false);
}

export function ControllerApiServicesV1CreateHostResponseToJSONTyped(value?: ControllerApiServicesV1CreateHostResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
