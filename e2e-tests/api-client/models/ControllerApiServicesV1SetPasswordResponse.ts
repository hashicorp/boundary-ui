 ...
 * 
 * @export
 * @interface ControllerApiServicesV1SetPasswordResponse
 */
export interface ControllerApiServicesV1SetPasswordResponse {
    /**
     * 
     * @type {ControllerApiResourcesAccountsV1Account}
     * @memberof ControllerApiServicesV1SetPasswordResponse
     */
    item?: ControllerApiResourcesAccountsV1Account;
}

/**
 * Check if a given object implements the ControllerApiServicesV1SetPasswordResponse interface.
 */
export function instanceOfControllerApiServicesV1SetPasswordResponse(value: object): value is ControllerApiServicesV1SetPasswordResponse {
    return true;
}

export function ControllerApiServicesV1SetPasswordResponseFromJSON(json: any): ControllerApiServicesV1SetPasswordResponse {
    return ControllerApiServicesV1SetPasswordResponseFromJSONTyped(json, false);
}

export function ControllerApiServicesV1SetPasswordResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1SetPasswordResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiServicesV1SetPasswordResponseToJSON(json: any): ControllerApiServicesV1SetPasswordResponse {
    return ControllerApiServicesV1SetPasswordResponseToJSONTyped(json, false);
}

export function ControllerApiServicesV1SetPasswordResponseToJSONTyped(value?: ControllerApiServicesV1SetPasswordResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
