...
import type { ControllerApiResourcesTargetsV1SessionAuthorization } from './ControllerApiResourcesTargetsV1SessionAuthorization';
import {
    ControllerApiResourcesTargetsV1SessionAuthorizationFromJSON,
    ControllerApiResourcesTargetsV1SessionAuthorizationFromJSONTyped,
    ControllerApiResourcesTargetsV1SessionAuthorizationToJSON,
    ControllerApiResourcesTargetsV1SessionAuthorizationToJSONTyped,
} from './ControllerApiResourcesTargetsV1SessionAuthorization';

/**
 * 
 * @export
 * @interface ControllerApiServicesV1AuthorizeSessionResponse
 */
export interface ControllerApiServicesV1AuthorizeSessionResponse {
    /**
     * 
     * @type {ControllerApiResourcesTargetsV1SessionAuthorization}
     * @memberof ControllerApiServicesV1AuthorizeSessionResponse
     */
    item?: ControllerApiResourcesTargetsV1SessionAuthorization;
}

/**
 * Check if a given object implements the ControllerApiServicesV1AuthorizeSessionResponse interface.
 */
export function instanceOfControllerApiServicesV1AuthorizeSessionResponse(value: object): value is ControllerApiServicesV1AuthorizeSessionResponse {
    return true;
}

export function ControllerApiServicesV1AuthorizeSessionResponseFromJSON(json: any): ControllerApiServicesV1AuthorizeSessionResponse {
    return ControllerApiServicesV1AuthorizeSessionResponseFromJSONTyped(json, false);
}

export function ControllerApiServicesV1AuthorizeSessionResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1AuthorizeSessionResponse {
    if (json == null) {
        return json;
    }
    return {
        
        'item': json['item'] == null ? undefined : ControllerApiResourcesTargetsV1SessionAuthorizationFromJSON(json['item']),
    };
}

export function ControllerApiServicesV1AuthorizeSessionResponseToJSON(json: any): ControllerApiServicesV1AuthorizeSessionResponse {
    return ControllerApiServicesV1AuthorizeSessionResponseToJSONTyped(json, false);
}

export function ControllerApiServicesV1AuthorizeSessionResponseToJSONTyped(value?: ControllerApiServicesV1AuthorizeSessionResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'item': ControllerApiResourcesTargetsV1SessionAuthorizationToJSON(value['item']),
    };
}
