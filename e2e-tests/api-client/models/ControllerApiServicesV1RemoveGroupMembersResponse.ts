...
import type { ControllerApiResourcesGroupsV1Group } from './ControllerApiResourcesGroupsV1Group';
import {
    ControllerApiResourcesGroupsV1GroupFromJSON,
    ControllerApiResourcesGroupsV1GroupFromJSONTyped,
    ControllerApiResourcesGroupsV1GroupToJSON,
    ControllerApiResourcesGroupsV1GroupToJSONTyped,
} from './ControllerApiResourcesGroupsV1Group';

/**
 * 
 * @export
 * @interface ControllerApiServicesV1RemoveGroupMembersResponse
 */
export interface ControllerApiServicesV1RemoveGroupMembersResponse {
    /**
     * 
     * @type {ControllerApiResourcesGroupsV1Group}
     * @memberof ControllerApiServicesV1RemoveGroupMembersResponse
     */
    item?: ControllerApiResourcesGroupsV1Group;
}

/**
 * Check if a given object implements the ControllerApiServicesV1RemoveGroupMembersResponse interface.
 */
export function instanceOfControllerApiServicesV1RemoveGroupMembersResponse(value: object): value is ControllerApiServicesV1RemoveGroupMembersResponse {
    return true;
}

export function ControllerApiServicesV1RemoveGroupMembersResponseFromJSON(json: any): ControllerApiServicesV1RemoveGroupMembersResponse {
    return ControllerApiServicesV1RemoveGroupMembersResponseFromJSONTyped(json, false);
}

export function ControllerApiServicesV1RemoveGroupMembersResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1RemoveGroupMembersResponse {
    if (json == null) {
        return json;
    }
    return {
        
        'item': json['item'] == null ? undefined : ControllerApiResourcesGroupsV1GroupFromJSON(json['item']),
    };
}

export function ControllerApiServicesV1RemoveGroupMembersResponseToJSON(json: any): ControllerApiServicesV1RemoveGroupMembersResponse {
    return ControllerApiServicesV1RemoveGroupMembersResponseToJSONTyped(json, false);
}

export function ControllerApiServicesV1RemoveGroupMembersResponseToJSONTyped(value?: ControllerApiServicesV1RemoveGroupMembersResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'item': ControllerApiResourcesGroupsV1GroupToJSON(value['item']),
    };
}
