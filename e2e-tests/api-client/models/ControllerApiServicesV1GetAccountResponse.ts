 ...
 * 
 * @export
 * @interface ControllerApiServicesV1GetAccountResponse
 */
export interface ControllerApiServicesV1GetAccountResponse {
    /**
     * 
     * @type {ControllerApiResourcesAccountsV1Account}
     * @memberof ControllerApiServicesV1GetAccountResponse
     */
    item?: ControllerApiResourcesAccountsV1Account;
}

/**
 * Check if a given object implements the ControllerApiServicesV1GetAccountResponse interface.
 */
export function instanceOfControllerApiServicesV1GetAccountResponse(value: object): value is ControllerApiServicesV1GetAccountResponse {
    return true;
}

export function ControllerApiServicesV1GetAccountResponseFromJSON(json: any): ControllerApiServicesV1GetAccountResponse {
    return ControllerApiServicesV1GetAccountResponseFromJSONTyped(json, false);
}

export function ControllerApiServicesV1GetAccountResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1GetAccountResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiServicesV1GetAccountResponseToJSON(json: any): ControllerApiServicesV1GetAccountResponse {
    return ControllerApiServicesV1GetAccountResponseToJSONTyped(json, false);
}

export function ControllerApiServicesV1GetAccountResponseToJSONTyped(value?: ControllerApiServicesV1GetAccountResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
