 ...
 * 
 * @export
 * @interface ControllerApiServicesV1AccountServiceSetPasswordBody
 */
export interface ControllerApiServicesV1AccountServiceSetPasswordBody {
    /**
     * Version is used to ensure this resource has not changed.
     * The mutation will fail if the version does not match the latest known good version.
     * @type {number}
     * @memberof ControllerApiServicesV1AccountServiceSetPasswordBody
     */
    version?: number;
    /**
...
/**
 * Check if a given object implements the ControllerApiServicesV1AccountServiceSetPasswordBody interface.
 */
export function instanceOfControllerApiServicesV1AccountServiceSetPasswordBody(value: object): value is ControllerApiServicesV1AccountServiceSetPasswordBody {
    return true;
}

export function ControllerApiServicesV1AccountServiceSetPasswordBodyFromJSON(json: any): ControllerApiServicesV1AccountServiceSetPasswordBody {
    return ControllerApiServicesV1AccountServiceSetPasswordBodyFromJSONTyped(json, false);
}

export function ControllerApiServicesV1AccountServiceSetPasswordBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1AccountServiceSetPasswordBody {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiServicesV1AccountServiceSetPasswordBodyToJSON(json: any): ControllerApiServicesV1AccountServiceSetPasswordBody {
    return ControllerApiServicesV1AccountServiceSetPasswordBodyToJSONTyped(json, false);
}

export function ControllerApiServicesV1AccountServiceSetPasswordBodyToJSONTyped(value?: ControllerApiServicesV1AccountServiceSetPasswordBody | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
