 ...
 * 
 * @export
 * @interface ControllerApiServicesV1GetAuthMethodResponse
 */
export interface ControllerApiServicesV1GetAuthMethodResponse {
    /**
     * 
     * @type {ControllerApiResourcesAuthmethodsV1AuthMethod}
     * @memberof ControllerApiServicesV1GetAuthMethodResponse
     */
    item?: ControllerApiResourcesAuthmethodsV1AuthMethod;
}

/**
 * Check if a given object implements the ControllerApiServicesV1GetAuthMethodResponse interface.
 */
export function instanceOfControllerApiServicesV1GetAuthMethodResponse(value: object): value is ControllerApiServicesV1GetAuthMethodResponse {
    return true;
}

export function ControllerApiServicesV1GetAuthMethodResponseFromJSON(json: any): ControllerApiServicesV1GetAuthMethodResponse {
    return ControllerApiServicesV1GetAuthMethodResponseFromJSONTyped(json, false);
}

export function ControllerApiServicesV1GetAuthMethodResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1GetAuthMethodResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiServicesV1GetAuthMethodResponseToJSON(json: any): ControllerApiServicesV1GetAuthMethodResponse {
    return ControllerApiServicesV1GetAuthMethodResponseToJSONTyped(json, false);
}

export function ControllerApiServicesV1GetAuthMethodResponseToJSONTyped(value?: ControllerApiServicesV1GetAuthMethodResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
