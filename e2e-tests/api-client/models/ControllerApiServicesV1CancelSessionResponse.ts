 ...
 * 
 * @export
 * @interface ControllerApiServicesV1CancelSessionResponse
 */
export interface ControllerApiServicesV1CancelSessionResponse {
    /**
     * 
     * @type {ControllerApiResourcesSessionsV1Session}
     * @memberof ControllerApiServicesV1CancelSessionResponse
     */
    item?: ControllerApiResourcesSessionsV1Session;
}

/**
 * Check if a given object implements the ControllerApiServicesV1CancelSessionResponse interface.
 */
export function instanceOfControllerApiServicesV1CancelSessionResponse(value: object): value is ControllerApiServicesV1CancelSessionResponse {
    return true;
}

export function ControllerApiServicesV1CancelSessionResponseFromJSON(json: any): ControllerApiServicesV1CancelSessionResponse {
    return ControllerApiServicesV1CancelSessionResponseFromJSONTyped(json, false);
}

export function ControllerApiServicesV1CancelSessionResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1CancelSessionResponse {
    if (json == null) {
        return json;
    }
    return {
        
        'item': json['item'] == null ? undefined : ControllerApiResourcesSessionsV1SessionFromJSON(json['item']),
    };
}

export function ControllerApiServicesV1CancelSessionResponseToJSON(json: any): ControllerApiServicesV1CancelSessionResponse {
    return ControllerApiServicesV1CancelSessionResponseToJSONTyped(json, false);
}

export function ControllerApiServicesV1CancelSessionResponseToJSONTyped(value?: ControllerApiServicesV1CancelSessionResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'item': ControllerApiResourcesSessionsV1SessionToJSON(value['item']),
    };
}
