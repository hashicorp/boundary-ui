...
import type { ControllerApiResourcesStoragebucketsV1StorageBucket } from './ControllerApiResourcesStoragebucketsV1StorageBucket';
import {
    ControllerApiResourcesStoragebucketsV1StorageBucketFromJSON,
    ControllerApiResourcesStoragebucketsV1StorageBucketFromJSONTyped,
    ControllerApiResourcesStoragebucketsV1StorageBucketToJSON,
    ControllerApiResourcesStoragebucketsV1StorageBucketToJSONTyped,
} from './ControllerApiResourcesStoragebucketsV1StorageBucket';

/**
 * 
 * @export
 * @interface ControllerApiServicesV1ListStorageBucketsResponse
 */
export interface ControllerApiServicesV1ListStorageBucketsResponse {
    /**
     * 
     * @type {Array<ControllerApiResourcesStoragebucketsV1StorageBucket>}
     * @memberof ControllerApiServicesV1ListStorageBucketsResponse
     */
    items?: Array<ControllerApiResourcesStoragebucketsV1StorageBucket>;
    /**
...
/**
 * Check if a given object implements the ControllerApiServicesV1ListStorageBucketsResponse interface.
 */
export function instanceOfControllerApiServicesV1ListStorageBucketsResponse(value: object): value is ControllerApiServicesV1ListStorageBucketsResponse {
    return true;
}

export function ControllerApiServicesV1ListStorageBucketsResponseFromJSON(json: any): ControllerApiServicesV1ListStorageBucketsResponse {
    return ControllerApiServicesV1ListStorageBucketsResponseFromJSONTyped(json, false);
}

export function ControllerApiServicesV1ListStorageBucketsResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1ListStorageBucketsResponse {
    if (json == null) {
        return json;
    }
    return {
        
        'items': json['items'] == null ? undefined : ((json['items'] as Array<any>).map(ControllerApiResourcesStoragebucketsV1StorageBucketFromJSON)),
...
export function ControllerApiServicesV1ListStorageBucketsResponseToJSON(json: any): ControllerApiServicesV1ListStorageBucketsResponse {
    return ControllerApiServicesV1ListStorageBucketsResponseToJSONTyped(json, false);
}

export function ControllerApiServicesV1ListStorageBucketsResponseToJSONTyped(value?: ControllerApiServicesV1ListStorageBucketsResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'items': value['items'] == null ? undefined : ((value['items'] as Array<any>).map(ControllerApiResourcesStoragebucketsV1StorageBucketToJSON)),
