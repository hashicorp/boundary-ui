...
import type { ControllerApiResourcesWorkersV1CertificateAuthority } from './ControllerApiResourcesWorkersV1CertificateAuthority';
import {
    ControllerApiResourcesWorkersV1CertificateAuthorityFromJSON,
    ControllerApiResourcesWorkersV1CertificateAuthorityFromJSONTyped,
    ControllerApiResourcesWorkersV1CertificateAuthorityToJSON,
    ControllerApiResourcesWorkersV1CertificateAuthorityToJSONTyped,
} from './ControllerApiResourcesWorkersV1CertificateAuthority';

/**
 * 
 * @export
 * @interface ControllerApiServicesV1ReinitializeCertificateAuthorityResponse
 */
export interface ControllerApiServicesV1ReinitializeCertificateAuthorityResponse {
    /**
     * 
     * @type {ControllerApiResourcesWorkersV1CertificateAuthority}
     * @memberof ControllerApiServicesV1ReinitializeCertificateAuthorityResponse
     */
    item?: ControllerApiResourcesWorkersV1CertificateAuthority;
}

/**
 * Check if a given object implements the ControllerApiServicesV1ReinitializeCertificateAuthorityResponse interface.
 */
export function instanceOfControllerApiServicesV1ReinitializeCertificateAuthorityResponse(value: object): value is ControllerApiServicesV1ReinitializeCertificateAuthorityResponse {
    return true;
}

export function ControllerApiServicesV1ReinitializeCertificateAuthorityResponseFromJSON(json: any): ControllerApiServicesV1ReinitializeCertificateAuthorityResponse {
    return ControllerApiServicesV1ReinitializeCertificateAuthorityResponseFromJSONTyped(json, false);
}

export function ControllerApiServicesV1ReinitializeCertificateAuthorityResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1ReinitializeCertificateAuthorityResponse {
    if (json == null) {
        return json;
    }
    return {
        
        'item': json['item'] == null ? undefined : ControllerApiResourcesWorkersV1CertificateAuthorityFromJSON(json['item']),
    };
}

export function ControllerApiServicesV1ReinitializeCertificateAuthorityResponseToJSON(json: any): ControllerApiServicesV1ReinitializeCertificateAuthorityResponse {
    return ControllerApiServicesV1ReinitializeCertificateAuthorityResponseToJSONTyped(json, false);
}

export function ControllerApiServicesV1ReinitializeCertificateAuthorityResponseToJSONTyped(value?: ControllerApiServicesV1ReinitializeCertificateAuthorityResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'item': ControllerApiResourcesWorkersV1CertificateAuthorityToJSON(value['item']),
    };
}
