 ...
 * 
 * @export
 * @interface ControllerApiServicesV1TargetServiceAddTargetCredentialSourcesBody
 */
export interface ControllerApiServicesV1TargetServiceAddTargetCredentialSourcesBody {
    /**
     * Version is used to ensure this resource has not changed.
     * The mutation will fail if the version does not match the latest known good version.
     * @type {number}
     * @memberof ControllerApiServicesV1TargetServiceAddTargetCredentialSourcesBody
     */
    version?: number;
    /**
...
/**
 * Check if a given object implements the ControllerApiServicesV1TargetServiceAddTargetCredentialSourcesBody interface.
 */
export function instanceOfControllerApiServicesV1TargetServiceAddTargetCredentialSourcesBody(value: object): value is ControllerApiServicesV1TargetServiceAddTargetCredentialSourcesBody {
    return true;
}

export function ControllerApiServicesV1TargetServiceAddTargetCredentialSourcesBodyFromJSON(json: any): ControllerApiServicesV1TargetServiceAddTargetCredentialSourcesBody {
    return ControllerApiServicesV1TargetServiceAddTargetCredentialSourcesBodyFromJSONTyped(json, false);
}

export function ControllerApiServicesV1TargetServiceAddTargetCredentialSourcesBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1TargetServiceAddTargetCredentialSourcesBody {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiServicesV1TargetServiceAddTargetCredentialSourcesBodyToJSON(json: any): ControllerApiServicesV1TargetServiceAddTargetCredentialSourcesBody {
    return ControllerApiServicesV1TargetServiceAddTargetCredentialSourcesBodyToJSONTyped(json, false);
}

export function ControllerApiServicesV1TargetServiceAddTargetCredentialSourcesBodyToJSONTyped(value?: ControllerApiServicesV1TargetServiceAddTargetCredentialSourcesBody | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
