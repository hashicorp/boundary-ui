 ...
 * 
 * @export
 * @interface ControllerApiServicesV1DestroyKeyVersionRequest
 */
export interface ControllerApiServicesV1DestroyKeyVersionRequest {
    /**
     * 
     * @type {string}
     * @memberof ControllerApiServicesV1DestroyKeyVersionRequest
     */
    scopeId?: string;
    /**
     * 
...
/**
 * Check if a given object implements the ControllerApiServicesV1DestroyKeyVersionRequest interface.
 */
export function instanceOfControllerApiServicesV1DestroyKeyVersionRequest(value: object): value is ControllerApiServicesV1DestroyKeyVersionRequest {
    return true;
}

export function ControllerApiServicesV1DestroyKeyVersionRequestFromJSON(json: any): ControllerApiServicesV1DestroyKeyVersionRequest {
    return ControllerApiServicesV1DestroyKeyVersionRequestFromJSONTyped(json, false);
}

export function ControllerApiServicesV1DestroyKeyVersionRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1DestroyKeyVersionRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiServicesV1DestroyKeyVersionRequestToJSON(json: any): ControllerApiServicesV1DestroyKeyVersionRequest {
    return ControllerApiServicesV1DestroyKeyVersionRequestToJSONTyped(json, false);
}

export function ControllerApiServicesV1DestroyKeyVersionRequestToJSONTyped(value?: ControllerApiServicesV1DestroyKeyVersionRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
