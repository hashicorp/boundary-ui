 ...
 * 
 * @export
 * @interface ControllerApiServicesV1RemoveRolePrincipalsResponse
 */
export interface ControllerApiServicesV1RemoveRolePrincipalsResponse {
    /**
     * 
     * @type {ControllerApiResourcesRolesV1Role}
     * @memberof ControllerApiServicesV1RemoveRolePrincipalsResponse
     */
    item?: ControllerApiResourcesRolesV1Role;
}

/**
 * Check if a given object implements the ControllerApiServicesV1RemoveRolePrincipalsResponse interface.
 */
export function instanceOfControllerApiServicesV1RemoveRolePrincipalsResponse(value: object): value is ControllerApiServicesV1RemoveRolePrincipalsResponse {
    return true;
}

export function ControllerApiServicesV1RemoveRolePrincipalsResponseFromJSON(json: any): ControllerApiServicesV1RemoveRolePrincipalsResponse {
    return ControllerApiServicesV1RemoveRolePrincipalsResponseFromJSONTyped(json, false);
}

export function ControllerApiServicesV1RemoveRolePrincipalsResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1RemoveRolePrincipalsResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiServicesV1RemoveRolePrincipalsResponseToJSON(json: any): ControllerApiServicesV1RemoveRolePrincipalsResponse {
    return ControllerApiServicesV1RemoveRolePrincipalsResponseToJSONTyped(json, false);
}

export function ControllerApiServicesV1RemoveRolePrincipalsResponseToJSONTyped(value?: ControllerApiServicesV1RemoveRolePrincipalsResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
