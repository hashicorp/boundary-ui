 ...
 * 
 * @export
 * @interface ControllerApiServicesV1UpdateHostSetResponse
 */
export interface ControllerApiServicesV1UpdateHostSetResponse {
    /**
     * 
     * @type {ControllerApiResourcesHostsetsV1HostSet}
     * @memberof ControllerApiServicesV1UpdateHostSetResponse
     */
    item?: ControllerApiResourcesHostsetsV1HostSet;
}

/**
 * Check if a given object implements the ControllerApiServicesV1UpdateHostSetResponse interface.
 */
export function instanceOfControllerApiServicesV1UpdateHostSetResponse(value: object): value is ControllerApiServicesV1UpdateHostSetResponse {
    return true;
}

export function ControllerApiServicesV1UpdateHostSetResponseFromJSON(json: any): ControllerApiServicesV1UpdateHostSetResponse {
    return ControllerApiServicesV1UpdateHostSetResponseFromJSONTyped(json, false);
}

export function ControllerApiServicesV1UpdateHostSetResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1UpdateHostSetResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiServicesV1UpdateHostSetResponseToJSON(json: any): ControllerApiServicesV1UpdateHostSetResponse {
    return ControllerApiServicesV1UpdateHostSetResponseToJSONTyped(json, false);
}

export function ControllerApiServicesV1UpdateHostSetResponseToJSONTyped(value?: ControllerApiServicesV1UpdateHostSetResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
