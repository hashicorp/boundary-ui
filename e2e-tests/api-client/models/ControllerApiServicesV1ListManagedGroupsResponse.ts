...
import type { ControllerApiResourcesManagedgroupsV1ManagedGroup } from './ControllerApiResourcesManagedgroupsV1ManagedGroup';
import {
    ControllerApiResourcesManagedgroupsV1ManagedGroupFromJSON,
    ControllerApiResourcesManagedgroupsV1ManagedGroupFromJSONTyped,
    ControllerApiResourcesManagedgroupsV1ManagedGroupToJSON,
    ControllerApiResourcesManagedgroupsV1ManagedGroupToJSONTyped,
} from './ControllerApiResourcesManagedgroupsV1ManagedGroup';

/**
 * 
 * @export
 * @interface ControllerApiServicesV1ListManagedGroupsResponse
 */
export interface ControllerApiServicesV1ListManagedGroupsResponse {
    /**
     * 
     * @type {Array<ControllerApiResourcesManagedgroupsV1ManagedGroup>}
     * @memberof ControllerApiServicesV1ListManagedGroupsResponse
     */
    items?: Array<ControllerApiResourcesManagedgroupsV1ManagedGroup>;
    /**
...
/**
 * Check if a given object implements the ControllerApiServicesV1ListManagedGroupsResponse interface.
 */
export function instanceOfControllerApiServicesV1ListManagedGroupsResponse(value: object): value is ControllerApiServicesV1ListManagedGroupsResponse {
    return true;
}

export function ControllerApiServicesV1ListManagedGroupsResponseFromJSON(json: any): ControllerApiServicesV1ListManagedGroupsResponse {
    return ControllerApiServicesV1ListManagedGroupsResponseFromJSONTyped(json, false);
}

export function ControllerApiServicesV1ListManagedGroupsResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1ListManagedGroupsResponse {
    if (json == null) {
        return json;
    }
    return {
        
        'items': json['items'] == null ? undefined : ((json['items'] as Array<any>).map(ControllerApiResourcesManagedgroupsV1ManagedGroupFromJSON)),
...
export function ControllerApiServicesV1ListManagedGroupsResponseToJSON(json: any): ControllerApiServicesV1ListManagedGroupsResponse {
    return ControllerApiServicesV1ListManagedGroupsResponseToJSONTyped(json, false);
}

export function ControllerApiServicesV1ListManagedGroupsResponseToJSONTyped(value?: ControllerApiServicesV1ListManagedGroupsResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'items': value['items'] == null ? undefined : ((value['items'] as Array<any>).map(ControllerApiResourcesManagedgroupsV1ManagedGroupToJSON)),
