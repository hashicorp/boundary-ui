 ...
 * 
 * @export
 * @interface ControllerApiServicesV1WorkerServiceRemoveWorkerTagsBody
 */
export interface ControllerApiServicesV1WorkerServiceRemoveWorkerTagsBody {
    /**
     * Version is used to ensure this resource has not changed.
     * The mutation will fail if the version does not match the latest known good version.
     * @type {number}
     * @memberof ControllerApiServicesV1WorkerServiceRemoveWorkerTagsBody
     */
    version?: number;
    /**
     * 
     ...
     * @memberof ControllerApiServicesV1WorkerServiceRemoveWorkerTagsBody
     */
    apiTags?: { [key: string]: Array<object>; };
}

/**
 * Check if a given object implements the ControllerApiServicesV1WorkerServiceRemoveWorkerTagsBody interface.
 */
export function instanceOfControllerApiServicesV1WorkerServiceRemoveWorkerTagsBody(value: object): value is ControllerApiServicesV1WorkerServiceRemoveWorkerTagsBody {
    return true;
}

export function ControllerApiServicesV1WorkerServiceRemoveWorkerTagsBodyFromJSON(json: any): ControllerApiServicesV1WorkerServiceRemoveWorkerTagsBody {
    return ControllerApiServicesV1WorkerServiceRemoveWorkerTagsBodyFromJSONTyped(json, false);
}

export function ControllerApiServicesV1WorkerServiceRemoveWorkerTagsBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1WorkerServiceRemoveWorkerTagsBody {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiServicesV1WorkerServiceRemoveWorkerTagsBodyToJSON(json: any): ControllerApiServicesV1WorkerServiceRemoveWorkerTagsBody {
    return ControllerApiServicesV1WorkerServiceRemoveWorkerTagsBodyToJSONTyped(json, false);
}

export function ControllerApiServicesV1WorkerServiceRemoveWorkerTagsBodyToJSONTyped(value?: ControllerApiServicesV1WorkerServiceRemoveWorkerTagsBody | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
