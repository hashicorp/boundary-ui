 ...
 * 
 * @export
 * @interface ControllerApiServicesV1GetHostResponse
 */
export interface ControllerApiServicesV1GetHostResponse {
    /**
     * 
     * @type {ControllerApiResourcesHostsV1Host}
     * @memberof ControllerApiServicesV1GetHostResponse
     */
    item?: ControllerApiResourcesHostsV1Host;
}

/**
 * Check if a given object implements the ControllerApiServicesV1GetHostResponse interface.
 */
export function instanceOfControllerApiServicesV1GetHostResponse(value: object): value is ControllerApiServicesV1GetHostResponse {
    return true;
}

export function ControllerApiServicesV1GetHostResponseFromJSON(json: any): ControllerApiServicesV1GetHostResponse {
    return ControllerApiServicesV1GetHostResponseFromJSONTyped(json, false);
}

export function ControllerApiServicesV1GetHostResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1GetHostResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiServicesV1GetHostResponseToJSON(json: any): ControllerApiServicesV1GetHostResponse {
    return ControllerApiServicesV1GetHostResponseToJSONTyped(json, false);
}

export function ControllerApiServicesV1GetHostResponseToJSONTyped(value?: ControllerApiServicesV1GetHostResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
