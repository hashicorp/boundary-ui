 ...
 * 
 * @export
 * @interface ControllerApiServicesV1SetTargetCredentialSourcesResponse
 */
export interface ControllerApiServicesV1SetTargetCredentialSourcesResponse {
    /**
     * 
     * @type {ControllerApiResourcesTargetsV1Target}
     * @memberof ControllerApiServicesV1SetTargetCredentialSourcesResponse
     */
    item?: ControllerApiResourcesTargetsV1Target;
}

/**
 * Check if a given object implements the ControllerApiServicesV1SetTargetCredentialSourcesResponse interface.
 */
export function instanceOfControllerApiServicesV1SetTargetCredentialSourcesResponse(value: object): value is ControllerApiServicesV1SetTargetCredentialSourcesResponse {
    return true;
}

export function ControllerApiServicesV1SetTargetCredentialSourcesResponseFromJSON(json: any): ControllerApiServicesV1SetTargetCredentialSourcesResponse {
    return ControllerApiServicesV1SetTargetCredentialSourcesResponseFromJSONTyped(json, false);
}

export function ControllerApiServicesV1SetTargetCredentialSourcesResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1SetTargetCredentialSourcesResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiServicesV1SetTargetCredentialSourcesResponseToJSON(json: any): ControllerApiServicesV1SetTargetCredentialSourcesResponse {
    return ControllerApiServicesV1SetTargetCredentialSourcesResponseToJSONTyped(json, false);
}

export function ControllerApiServicesV1SetTargetCredentialSourcesResponseToJSONTyped(value?: ControllerApiServicesV1SetTargetCredentialSourcesResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
