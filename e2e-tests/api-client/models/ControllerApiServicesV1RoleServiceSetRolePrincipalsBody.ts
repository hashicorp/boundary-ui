 ...
 * 
 * @export
 * @interface ControllerApiServicesV1RoleServiceSetRolePrincipalsBody
 */
export interface ControllerApiServicesV1RoleServiceSetRolePrincipalsBody {
    /**
     * Version is used to ensure this resource has not changed.
     * The mutation will fail if the version does not match the latest known good version.
     * @type {number}
     * @memberof ControllerApiServicesV1RoleServiceSetRolePrincipalsBody
     */
    version?: number;
    /**
     * 
...
/**
 * Check if a given object implements the ControllerApiServicesV1RoleServiceSetRolePrincipalsBody interface.
 */
export function instanceOfControllerApiServicesV1RoleServiceSetRolePrincipalsBody(value: object): value is ControllerApiServicesV1RoleServiceSetRolePrincipalsBody {
    return true;
}

export function ControllerApiServicesV1RoleServiceSetRolePrincipalsBodyFromJSON(json: any): ControllerApiServicesV1RoleServiceSetRolePrincipalsBody {
    return ControllerApiServicesV1RoleServiceSetRolePrincipalsBodyFromJSONTyped(json, false);
}

export function ControllerApiServicesV1RoleServiceSetRolePrincipalsBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1RoleServiceSetRolePrincipalsBody {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiServicesV1RoleServiceSetRolePrincipalsBodyToJSON(json: any): ControllerApiServicesV1RoleServiceSetRolePrincipalsBody {
    return ControllerApiServicesV1RoleServiceSetRolePrincipalsBodyToJSONTyped(json, false);
}

export function ControllerApiServicesV1RoleServiceSetRolePrincipalsBodyToJSONTyped(value?: ControllerApiServicesV1RoleServiceSetRolePrincipalsBody | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
