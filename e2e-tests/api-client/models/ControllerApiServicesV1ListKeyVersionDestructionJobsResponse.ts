...
import type { ControllerApiResourcesScopesV1KeyVersionDestructionJob } from './ControllerApiResourcesScopesV1KeyVersionDestructionJob';
import {
    ControllerApiResourcesScopesV1KeyVersionDestructionJobFromJSON,
    ControllerApiResourcesScopesV1KeyVersionDestructionJobFromJSONTyped,
    ControllerApiResourcesScopesV1KeyVersionDestructionJobToJSON,
    ControllerApiResourcesScopesV1KeyVersionDestructionJobToJSONTyped,
} from './ControllerApiResourcesScopesV1KeyVersionDestructionJob';

/**
 * 
 * @export
 * @interface ControllerApiServicesV1ListKeyVersionDestructionJobsResponse
 */
export interface ControllerApiServicesV1ListKeyVersionDestructionJobsResponse {
    /**
     * 
     * @type {Array<ControllerApiResourcesScopesV1KeyVersionDestructionJob>}
     * @memberof ControllerApiServicesV1ListKeyVersionDestructionJobsResponse
     */
    items?: Array<ControllerApiResourcesScopesV1KeyVersionDestructionJob>;
}

/**
 * Check if a given object implements the ControllerApiServicesV1ListKeyVersionDestructionJobsResponse interface.
 */
export function instanceOfControllerApiServicesV1ListKeyVersionDestructionJobsResponse(value: object): value is ControllerApiServicesV1ListKeyVersionDestructionJobsResponse {
    return true;
}

export function ControllerApiServicesV1ListKeyVersionDestructionJobsResponseFromJSON(json: any): ControllerApiServicesV1ListKeyVersionDestructionJobsResponse {
    return ControllerApiServicesV1ListKeyVersionDestructionJobsResponseFromJSONTyped(json, false);
}

export function ControllerApiServicesV1ListKeyVersionDestructionJobsResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1ListKeyVersionDestructionJobsResponse {
    if (json == null) {
        return json;
    }
    return {
        
        'items': json['items'] == null ? undefined : ((json['items'] as Array<any>).map(ControllerApiResourcesScopesV1KeyVersionDestructionJobFromJSON)),
    };
}

export function ControllerApiServicesV1ListKeyVersionDestructionJobsResponseToJSON(json: any): ControllerApiServicesV1ListKeyVersionDestructionJobsResponse {
    return ControllerApiServicesV1ListKeyVersionDestructionJobsResponseToJSONTyped(json, false);
}

export function ControllerApiServicesV1ListKeyVersionDestructionJobsResponseToJSONTyped(value?: ControllerApiServicesV1ListKeyVersionDestructionJobsResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'items': value['items'] == null ? undefined : ((value['items'] as Array<any>).map(ControllerApiResourcesScopesV1KeyVersionDestructionJobToJSON)),
    };
}
