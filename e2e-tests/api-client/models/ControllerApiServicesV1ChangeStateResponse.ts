 ...
 * 
 * @export
 * @interface ControllerApiServicesV1ChangeStateResponse
 */
export interface ControllerApiServicesV1ChangeStateResponse {
    /**
     * 
     * @type {ControllerApiResourcesAuthmethodsV1AuthMethod}
     * @memberof ControllerApiServicesV1ChangeStateResponse
     */
    item?: ControllerApiResourcesAuthmethodsV1AuthMethod;
}

/**
 * Check if a given object implements the ControllerApiServicesV1ChangeStateResponse interface.
 */
export function instanceOfControllerApiServicesV1ChangeStateResponse(value: object): value is ControllerApiServicesV1ChangeStateResponse {
    return true;
}

export function ControllerApiServicesV1ChangeStateResponseFromJSON(json: any): ControllerApiServicesV1ChangeStateResponse {
    return ControllerApiServicesV1ChangeStateResponseFromJSONTyped(json, false);
}

export function ControllerApiServicesV1ChangeStateResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1ChangeStateResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiServicesV1ChangeStateResponseToJSON(json: any): ControllerApiServicesV1ChangeStateResponse {
    return ControllerApiServicesV1ChangeStateResponseToJSONTyped(json, false);
}

export function ControllerApiServicesV1ChangeStateResponseToJSONTyped(value?: ControllerApiServicesV1ChangeStateResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
