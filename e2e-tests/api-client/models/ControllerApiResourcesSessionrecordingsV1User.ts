 ...
 * @export
 * @interface ControllerApiResourcesSessionrecordingsV1User
 */
export interface ControllerApiResourcesSessionrecordingsV1User {
    /**
     * The ID of the User.
     * @type {string}
     * @memberof ControllerApiResourcesSessionrecordingsV1User
     */
    id?: string;
    /**
...
/**
 * Check if a given object implements the ControllerApiResourcesSessionrecordingsV1User interface.
 */
export function instanceOfControllerApiResourcesSessionrecordingsV1User(value: object): value is ControllerApiResourcesSessionrecordingsV1User {
    return true;
}

export function ControllerApiResourcesSessionrecordingsV1UserFromJSON(json: any): ControllerApiResourcesSessionrecordingsV1User {
    return ControllerApiResourcesSessionrecordingsV1UserFromJSONTyped(json, false);
}

export function ControllerApiResourcesSessionrecordingsV1UserFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiResourcesSessionrecordingsV1User {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiResourcesSessionrecordingsV1UserToJSON(json: any): ControllerApiResourcesSessionrecordingsV1User {
    return ControllerApiResourcesSessionrecordingsV1UserToJSONTyped(json, false);
}

export function ControllerApiResourcesSessionrecordingsV1UserToJSONTyped(value?: ControllerApiResourcesSessionrecordingsV1User | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
