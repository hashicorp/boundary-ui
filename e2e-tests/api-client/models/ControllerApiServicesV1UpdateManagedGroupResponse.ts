 ...
 * 
 * @export
 * @interface ControllerApiServicesV1UpdateManagedGroupResponse
 */
export interface ControllerApiServicesV1UpdateManagedGroupResponse {
    /**
     * 
     * @type {ControllerApiResourcesManagedgroupsV1ManagedGroup}
     * @memberof ControllerApiServicesV1UpdateManagedGroupResponse
     */
    item?: ControllerApiResourcesManagedgroupsV1ManagedGroup;
}

/**
 * Check if a given object implements the ControllerApiServicesV1UpdateManagedGroupResponse interface.
 */
export function instanceOfControllerApiServicesV1UpdateManagedGroupResponse(value: object): value is ControllerApiServicesV1UpdateManagedGroupResponse {
    return true;
}

export function ControllerApiServicesV1UpdateManagedGroupResponseFromJSON(json: any): ControllerApiServicesV1UpdateManagedGroupResponse {
    return ControllerApiServicesV1UpdateManagedGroupResponseFromJSONTyped(json, false);
}

export function ControllerApiServicesV1UpdateManagedGroupResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1UpdateManagedGroupResponse {
    if (json == null) {
        return json;
    }
    return {
        
        'item': json['item'] == null ? undefined : ControllerApiResourcesManagedgroupsV1ManagedGroupFromJSON(json['item']),
    };
}

export function ControllerApiServicesV1UpdateManagedGroupResponseToJSON(json: any): ControllerApiServicesV1UpdateManagedGroupResponse {
    return ControllerApiServicesV1UpdateManagedGroupResponseToJSONTyped(json, false);
}

export function ControllerApiServicesV1UpdateManagedGroupResponseToJSONTyped(value?: ControllerApiServicesV1UpdateManagedGroupResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'item': ControllerApiResourcesManagedgroupsV1ManagedGroupToJSON(value['item']),
    };
}
