 ...
 * @export
 * @interface ControllerApiV1FieldError
 */
export interface ControllerApiV1FieldError {
    /**
     * The name of the field.
     * @type {string}
     * @memberof ControllerApiV1FieldError
     */
    name?: string;
    /**
...
/**
 * Check if a given object implements the ControllerApiV1FieldError interface.
 */
export function instanceOfControllerApiV1FieldError(value: object): value is ControllerApiV1FieldError {
    return true;
}

export function ControllerApiV1FieldErrorFromJSON(json: any): ControllerApiV1FieldError {
    return ControllerApiV1FieldErrorFromJSONTyped(json, false);
}

export function ControllerApiV1FieldErrorFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiV1FieldError {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiV1FieldErrorToJSON(json: any): ControllerApiV1FieldError {
    return ControllerApiV1FieldErrorToJSONTyped(json, false);
}

export function ControllerApiV1FieldErrorToJSONTyped(value?: ControllerApiV1FieldError | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
