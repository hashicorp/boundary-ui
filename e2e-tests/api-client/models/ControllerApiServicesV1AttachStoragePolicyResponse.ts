 ...
 * 
 * @export
 * @interface ControllerApiServicesV1AttachStoragePolicyResponse
 */
export interface ControllerApiServicesV1AttachStoragePolicyResponse {
    /**
     * 
     * @type {ControllerApiResourcesScopesV1Scope}
     * @memberof ControllerApiServicesV1AttachStoragePolicyResponse
     */
    item?: ControllerApiResourcesScopesV1Scope;
}

/**
 * Check if a given object implements the ControllerApiServicesV1AttachStoragePolicyResponse interface.
 */
export function instanceOfControllerApiServicesV1AttachStoragePolicyResponse(value: object): value is ControllerApiServicesV1AttachStoragePolicyResponse {
    return true;
}

export function ControllerApiServicesV1AttachStoragePolicyResponseFromJSON(json: any): ControllerApiServicesV1AttachStoragePolicyResponse {
    return ControllerApiServicesV1AttachStoragePolicyResponseFromJSONTyped(json, false);
}

export function ControllerApiServicesV1AttachStoragePolicyResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1AttachStoragePolicyResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiServicesV1AttachStoragePolicyResponseToJSON(json: any): ControllerApiServicesV1AttachStoragePolicyResponse {
    return ControllerApiServicesV1AttachStoragePolicyResponseToJSONTyped(json, false);
}

export function ControllerApiServicesV1AttachStoragePolicyResponseToJSONTyped(value?: ControllerApiServicesV1AttachStoragePolicyResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
