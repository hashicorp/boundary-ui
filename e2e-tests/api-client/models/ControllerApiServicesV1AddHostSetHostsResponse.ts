 ...
 * 
 * @export
 * @interface ControllerApiServicesV1AddHostSetHostsResponse
 */
export interface ControllerApiServicesV1AddHostSetHostsResponse {
    /**
     * 
     * @type {ControllerApiResourcesHostsetsV1HostSet}
     * @memberof ControllerApiServicesV1AddHostSetHostsResponse
     */
    item?: ControllerApiResourcesHostsetsV1HostSet;
}

/**
 * Check if a given object implements the ControllerApiServicesV1AddHostSetHostsResponse interface.
 */
export function instanceOfControllerApiServicesV1AddHostSetHostsResponse(value: object): value is ControllerApiServicesV1AddHostSetHostsResponse {
    return true;
}

export function ControllerApiServicesV1AddHostSetHostsResponseFromJSON(json: any): ControllerApiServicesV1AddHostSetHostsResponse {
    return ControllerApiServicesV1AddHostSetHostsResponseFromJSONTyped(json, false);
}

export function ControllerApiServicesV1AddHostSetHostsResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1AddHostSetHostsResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiServicesV1AddHostSetHostsResponseToJSON(json: any): ControllerApiServicesV1AddHostSetHostsResponse {
    return ControllerApiServicesV1AddHostSetHostsResponseToJSONTyped(json, false);
}

export function ControllerApiServicesV1AddHostSetHostsResponseToJSONTyped(value?: ControllerApiServicesV1AddHostSetHostsResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
