...
import type { ControllerApiResourcesScopesV1Scope } from './ControllerApiResourcesScopesV1Scope';
import {
    ControllerApiResourcesScopesV1ScopeFromJSON,
    ControllerApiResourcesScopesV1ScopeFromJSONTyped,
    ControllerApiResourcesScopesV1ScopeToJSON,
    ControllerApiResourcesScopesV1ScopeToJSONTyped,
} from './ControllerApiResourcesScopesV1Scope';

/**
 * 
 * @export
 * @interface ControllerApiServicesV1DetachStoragePolicyResponse
 */
export interface ControllerApiServicesV1DetachStoragePolicyResponse {
    /**
     * 
     * @type {ControllerApiResourcesScopesV1Scope}
     * @memberof ControllerApiServicesV1DetachStoragePolicyResponse
     */
    item?: ControllerApiResourcesScopesV1Scope;
}

/**
 * Check if a given object implements the ControllerApiServicesV1DetachStoragePolicyResponse interface.
 */
export function instanceOfControllerApiServicesV1DetachStoragePolicyResponse(value: object): value is ControllerApiServicesV1DetachStoragePolicyResponse {
    return true;
}

export function ControllerApiServicesV1DetachStoragePolicyResponseFromJSON(json: any): ControllerApiServicesV1DetachStoragePolicyResponse {
    return ControllerApiServicesV1DetachStoragePolicyResponseFromJSONTyped(json, false);
}

export function ControllerApiServicesV1DetachStoragePolicyResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1DetachStoragePolicyResponse {
    if (json == null) {
        return json;
    }
    return {
        
        'item': json['item'] == null ? undefined : ControllerApiResourcesScopesV1ScopeFromJSON(json['item']),
    };
}

export function ControllerApiServicesV1DetachStoragePolicyResponseToJSON(json: any): ControllerApiServicesV1DetachStoragePolicyResponse {
    return ControllerApiServicesV1DetachStoragePolicyResponseToJSONTyped(json, false);
}

export function ControllerApiServicesV1DetachStoragePolicyResponseToJSONTyped(value?: ControllerApiServicesV1DetachStoragePolicyResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'item': ControllerApiResourcesScopesV1ScopeToJSON(value['item']),
    };
}
