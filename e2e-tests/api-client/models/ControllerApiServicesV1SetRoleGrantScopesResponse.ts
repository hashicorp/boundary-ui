 ...
 * 
 * @export
 * @interface ControllerApiServicesV1SetRoleGrantScopesResponse
 */
export interface ControllerApiServicesV1SetRoleGrantScopesResponse {
    /**
     * 
     * @type {ControllerApiResourcesRolesV1Role}
     * @memberof ControllerApiServicesV1SetRoleGrantScopesResponse
     */
    item?: ControllerApiResourcesRolesV1Role;
}

/**
 * Check if a given object implements the ControllerApiServicesV1SetRoleGrantScopesResponse interface.
 */
export function instanceOfControllerApiServicesV1SetRoleGrantScopesResponse(value: object): value is ControllerApiServicesV1SetRoleGrantScopesResponse {
    return true;
}

export function ControllerApiServicesV1SetRoleGrantScopesResponseFromJSON(json: any): ControllerApiServicesV1SetRoleGrantScopesResponse {
    return ControllerApiServicesV1SetRoleGrantScopesResponseFromJSONTyped(json, false);
}

export function ControllerApiServicesV1SetRoleGrantScopesResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1SetRoleGrantScopesResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiServicesV1SetRoleGrantScopesResponseToJSON(json: any): ControllerApiServicesV1SetRoleGrantScopesResponse {
    return ControllerApiServicesV1SetRoleGrantScopesResponseToJSONTyped(json, false);
}

export function ControllerApiServicesV1SetRoleGrantScopesResponseToJSONTyped(value?: ControllerApiServicesV1SetRoleGrantScopesResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
