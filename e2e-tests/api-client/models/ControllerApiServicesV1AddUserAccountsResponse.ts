 ...
 * 
 * @export
 * @interface ControllerApiServicesV1AddUserAccountsResponse
 */
export interface ControllerApiServicesV1AddUserAccountsResponse {
    /**
     * 
     * @type {ControllerApiResourcesUsersV1User}
     * @memberof ControllerApiServicesV1AddUserAccountsResponse
     */
    item?: ControllerApiResourcesUsersV1User;
}

/**
 * Check if a given object implements the ControllerApiServicesV1AddUserAccountsResponse interface.
 */
export function instanceOfControllerApiServicesV1AddUserAccountsResponse(value: object): value is ControllerApiServicesV1AddUserAccountsResponse {
    return true;
}

export function ControllerApiServicesV1AddUserAccountsResponseFromJSON(json: any): ControllerApiServicesV1AddUserAccountsResponse {
    return ControllerApiServicesV1AddUserAccountsResponseFromJSONTyped(json, false);
}

export function ControllerApiServicesV1AddUserAccountsResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1AddUserAccountsResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiServicesV1AddUserAccountsResponseToJSON(json: any): ControllerApiServicesV1AddUserAccountsResponse {
    return ControllerApiServicesV1AddUserAccountsResponseToJSONTyped(json, false);
}

export function ControllerApiServicesV1AddUserAccountsResponseToJSONTyped(value?: ControllerApiServicesV1AddUserAccountsResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
