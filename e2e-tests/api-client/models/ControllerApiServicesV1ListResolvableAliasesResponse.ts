...
import type { ControllerApiResourcesAliasesV1Alias } from './ControllerApiResourcesAliasesV1Alias';
import {
    ControllerApiResourcesAliasesV1AliasFromJSON,
    ControllerApiResourcesAliasesV1AliasFromJSONTyped,
    ControllerApiResourcesAliasesV1AliasToJSON,
    ControllerApiResourcesAliasesV1AliasToJSONTyped,
} from './ControllerApiResourcesAliasesV1Alias';

/**
 * 
 * @export
 * @interface ControllerApiServicesV1ListResolvableAliasesResponse
 */
export interface ControllerApiServicesV1ListResolvableAliasesResponse {
    /**
     * 
     * @type {Array<ControllerApiResourcesAliasesV1Alias>}
     * @memberof ControllerApiServicesV1ListResolvableAliasesResponse
     */
    items?: Array<ControllerApiResourcesAliasesV1Alias>;
    /**
...
/**
 * Check if a given object implements the ControllerApiServicesV1ListResolvableAliasesResponse interface.
 */
export function instanceOfControllerApiServicesV1ListResolvableAliasesResponse(value: object): value is ControllerApiServicesV1ListResolvableAliasesResponse {
    return true;
}

export function ControllerApiServicesV1ListResolvableAliasesResponseFromJSON(json: any): ControllerApiServicesV1ListResolvableAliasesResponse {
    return ControllerApiServicesV1ListResolvableAliasesResponseFromJSONTyped(json, false);
}

export function ControllerApiServicesV1ListResolvableAliasesResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1ListResolvableAliasesResponse {
    if (json == null) {
        return json;
    }
    return {
        
        'items': json['items'] == null ? undefined : ((json['items'] as Array<any>).map(ControllerApiResourcesAliasesV1AliasFromJSON)),
...
export function ControllerApiServicesV1ListResolvableAliasesResponseToJSON(json: any): ControllerApiServicesV1ListResolvableAliasesResponse {
    return ControllerApiServicesV1ListResolvableAliasesResponseToJSONTyped(json, false);
}

export function ControllerApiServicesV1ListResolvableAliasesResponseToJSONTyped(value?: ControllerApiServicesV1ListResolvableAliasesResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'items': value['items'] == null ? undefined : ((value['items'] as Array<any>).map(ControllerApiResourcesAliasesV1AliasToJSON)),
