 ...
 * 
 * @export
 * @interface ControllerApiServicesV1RoleServiceSetRoleGrantsBody
 */
export interface ControllerApiServicesV1RoleServiceSetRoleGrantsBody {
    /**
     * Version is used to ensure this resource has not changed.
     * The mutation will fail if the version does not match the latest known good version.
     * @type {number}
     * @memberof ControllerApiServicesV1RoleServiceSetRoleGrantsBody
     */
    version?: number;
    /**
     * 
...
/**
 * Check if a given object implements the ControllerApiServicesV1RoleServiceSetRoleGrantsBody interface.
 */
export function instanceOfControllerApiServicesV1RoleServiceSetRoleGrantsBody(value: object): value is ControllerApiServicesV1RoleServiceSetRoleGrantsBody {
    return true;
}

export function ControllerApiServicesV1RoleServiceSetRoleGrantsBodyFromJSON(json: any): ControllerApiServicesV1RoleServiceSetRoleGrantsBody {
    return ControllerApiServicesV1RoleServiceSetRoleGrantsBodyFromJSONTyped(json, false);
}

export function ControllerApiServicesV1RoleServiceSetRoleGrantsBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1RoleServiceSetRoleGrantsBody {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiServicesV1RoleServiceSetRoleGrantsBodyToJSON(json: any): ControllerApiServicesV1RoleServiceSetRoleGrantsBody {
    return ControllerApiServicesV1RoleServiceSetRoleGrantsBodyToJSONTyped(json, false);
}

export function ControllerApiServicesV1RoleServiceSetRoleGrantsBodyToJSONTyped(value?: ControllerApiServicesV1RoleServiceSetRoleGrantsBody | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
