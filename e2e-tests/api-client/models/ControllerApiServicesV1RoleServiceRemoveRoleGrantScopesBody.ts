 ...
 * 
 * @export
 * @interface ControllerApiServicesV1RoleServiceRemoveRoleGrantScopesBody
 */
export interface ControllerApiServicesV1RoleServiceRemoveRoleGrantScopesBody {
    /**
     * Version is used to ensure this resource has not changed.
     * The mutation will fail if the version does not match the latest known good version.
     * @type {number}
     * @memberof ControllerApiServicesV1RoleServiceRemoveRoleGrantScopesBody
     */
    version?: number;
    /**
     * 
     ...
     * @memberof ControllerApiServicesV1RoleServiceRemoveRoleGrantScopesBody
     */
    grantScopeIds?: Array<string>;
}

/**
 * Check if a given object implements the ControllerApiServicesV1RoleServiceRemoveRoleGrantScopesBody interface.
 */
export function instanceOfControllerApiServicesV1RoleServiceRemoveRoleGrantScopesBody(value: object): value is ControllerApiServicesV1RoleServiceRemoveRoleGrantScopesBody {
    return true;
}

export function ControllerApiServicesV1RoleServiceRemoveRoleGrantScopesBodyFromJSON(json: any): ControllerApiServicesV1RoleServiceRemoveRoleGrantScopesBody {
    return ControllerApiServicesV1RoleServiceRemoveRoleGrantScopesBodyFromJSONTyped(json, false);
}

export function ControllerApiServicesV1RoleServiceRemoveRoleGrantScopesBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1RoleServiceRemoveRoleGrantScopesBody {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiServicesV1RoleServiceRemoveRoleGrantScopesBodyToJSON(json: any): ControllerApiServicesV1RoleServiceRemoveRoleGrantScopesBody {
    return ControllerApiServicesV1RoleServiceRemoveRoleGrantScopesBodyToJSONTyped(json, false);
}

export function ControllerApiServicesV1RoleServiceRemoveRoleGrantScopesBodyToJSONTyped(value?: ControllerApiServicesV1RoleServiceRemoveRoleGrantScopesBody | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'grant_scope_ids': value['grantScopeIds'],
    };
}
