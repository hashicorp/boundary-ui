...
import type { ControllerApiV1ErrorDetails } from './ControllerApiV1ErrorDetails';
import {
    ControllerApiV1ErrorDetailsFromJSON,
    ControllerApiV1ErrorDetailsFromJSONTyped,
    ControllerApiV1ErrorDetailsToJSON,
    ControllerApiV1ErrorDetailsToJSONTyped,
} from './ControllerApiV1ErrorDetails';

/**
 * Error is returned by the JSON API when an error occurs.
 * @export
 * @interface ControllerApiV1Error
 */
export interface ControllerApiV1Error {
    /**
     * The kind of error this is.
     * @type {string}
     * @memberof ControllerApiV1Error
     */
    kind?: string;
    /**
    ...
    /**
     * 
     * @type {ControllerApiV1ErrorDetails}
     * @memberof ControllerApiV1Error
     */
    details?: ControllerApiV1ErrorDetails;
}

/**
 * Check if a given object implements the ControllerApiV1Error interface.
 */
export function instanceOfControllerApiV1Error(value: object): value is ControllerApiV1Error {
    return true;
}

export function ControllerApiV1ErrorFromJSON(json: any): ControllerApiV1Error {
    return ControllerApiV1ErrorFromJSONTyped(json, false);
}

export function ControllerApiV1ErrorFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiV1Error {
    if (json == null) {
        return json;
    }
    return {
        ...
        'details': json['details'] == null ? undefined : ControllerApiV1ErrorDetailsFromJSON(json['details']),
    };
}

export function ControllerApiV1ErrorToJSON(json: any): ControllerApiV1Error {
    return ControllerApiV1ErrorToJSONTyped(json, false);
}

export function ControllerApiV1ErrorToJSONTyped(value?: ControllerApiV1Error | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'details': ControllerApiV1ErrorDetailsToJSON(value['details']),
    };
}
