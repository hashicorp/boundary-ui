 ...
 * 
 * @export
 * @interface ControllerApiServicesV1UpdateAccountResponse
 */
export interface ControllerApiServicesV1UpdateAccountResponse {
    /**
     * 
     * @type {ControllerApiResourcesAccountsV1Account}
     * @memberof ControllerApiServicesV1UpdateAccountResponse
     */
    item?: ControllerApiResourcesAccountsV1Account;
}

/**
 * Check if a given object implements the ControllerApiServicesV1UpdateAccountResponse interface.
 */
export function instanceOfControllerApiServicesV1UpdateAccountResponse(value: object): value is ControllerApiServicesV1UpdateAccountResponse {
    return true;
}

export function ControllerApiServicesV1UpdateAccountResponseFromJSON(json: any): ControllerApiServicesV1UpdateAccountResponse {
    return ControllerApiServicesV1UpdateAccountResponseFromJSONTyped(json, false);
}

export function ControllerApiServicesV1UpdateAccountResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1UpdateAccountResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiServicesV1UpdateAccountResponseToJSON(json: any): ControllerApiServicesV1UpdateAccountResponse {
    return ControllerApiServicesV1UpdateAccountResponseToJSONTyped(json, false);
}

export function ControllerApiServicesV1UpdateAccountResponseToJSONTyped(value?: ControllerApiServicesV1UpdateAccountResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
