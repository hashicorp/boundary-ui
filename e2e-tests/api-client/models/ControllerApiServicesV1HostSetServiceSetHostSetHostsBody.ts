 ...
 * 
 * @export
 * @interface ControllerApiServicesV1HostSetServiceSetHostSetHostsBody
 */
export interface ControllerApiServicesV1HostSetServiceSetHostSetHostsBody {
    /**
     * Version is used to ensure this resource has not changed.
     * The mutation will fail if the version does not match the latest known good version.
     * @type {number}
     * @memberof ControllerApiServicesV1HostSetServiceSetHostSetHostsBody
     */
    version?: number;
    /**
...
/**
 * Check if a given object implements the ControllerApiServicesV1HostSetServiceSetHostSetHostsBody interface.
 */
export function instanceOfControllerApiServicesV1HostSetServiceSetHostSetHostsBody(value: object): value is ControllerApiServicesV1HostSetServiceSetHostSetHostsBody {
    return true;
}

export function ControllerApiServicesV1HostSetServiceSetHostSetHostsBodyFromJSON(json: any): ControllerApiServicesV1HostSetServiceSetHostSetHostsBody {
    return ControllerApiServicesV1HostSetServiceSetHostSetHostsBodyFromJSONTyped(json, false);
}

export function ControllerApiServicesV1HostSetServiceSetHostSetHostsBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1HostSetServiceSetHostSetHostsBody {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiServicesV1HostSetServiceSetHostSetHostsBodyToJSON(json: any): ControllerApiServicesV1HostSetServiceSetHostSetHostsBody {
    return ControllerApiServicesV1HostSetServiceSetHostSetHostsBodyToJSONTyped(json, false);
}

export function ControllerApiServicesV1HostSetServiceSetHostSetHostsBodyToJSONTyped(value?: ControllerApiServicesV1HostSetServiceSetHostSetHostsBody | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
