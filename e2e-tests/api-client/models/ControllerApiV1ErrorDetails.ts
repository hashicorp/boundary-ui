...
import type { ControllerApiV1WrappedError } from './ControllerApiV1WrappedError';
import {
    ControllerApiV1WrappedErrorFromJSON,
    ControllerApiV1WrappedErrorFromJSONTyped,
    ControllerApiV1WrappedErrorToJSON,
    ControllerApiV1WrappedErrorToJSONTyped,
} from './ControllerApiV1WrappedError';
import type { ControllerApiV1FieldError } from './ControllerApiV1FieldError';
import {
    ControllerApiV1FieldErrorFromJSON,
    ControllerApiV1FieldErrorFromJSONTyped,
    ControllerApiV1FieldErrorToJSON,
    ControllerApiV1FieldErrorToJSONTyped,
} from './ControllerApiV1FieldError';

/**
 * Additional details regarding a specific error.
 * @export
 * @interface ControllerApiV1ErrorDetails
 */
export interface ControllerApiV1ErrorDetails {
    /**
     * Request-field-specific error details.
     * @type {Array<ControllerApiV1FieldError>}
     * @memberof ControllerApiV1ErrorDetails
     */
    requestFields?: Array<ControllerApiV1FieldError>;
    /**
     * The errors that were wrapped in the backend for this returned error.
     * @type {Array<ControllerApiV1WrappedError>}
     * @memberof ControllerApiV1ErrorDetails
     */
    wrappedErrors?: Array<ControllerApiV1WrappedError>;
}

/**
 * Check if a given object implements the ControllerApiV1ErrorDetails interface.
 */
export function instanceOfControllerApiV1ErrorDetails(value: object): value is ControllerApiV1ErrorDetails {
    return true;
}

export function ControllerApiV1ErrorDetailsFromJSON(json: any): ControllerApiV1ErrorDetails {
    return ControllerApiV1ErrorDetailsFromJSONTyped(json, false);
}

export function ControllerApiV1ErrorDetailsFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiV1ErrorDetails {
    if (json == null) {
        return json;
    }
    return {
        
        'requestFields': json['request_fields'] == null ? undefined : ((json['request_fields'] as Array<any>).map(ControllerApiV1FieldErrorFromJSON)),
        'wrappedErrors': json['wrapped_errors'] == null ? undefined : ((json['wrapped_errors'] as Array<any>).map(ControllerApiV1WrappedErrorFromJSON)),
    };
}

export function ControllerApiV1ErrorDetailsToJSON(json: any): ControllerApiV1ErrorDetails {
    return ControllerApiV1ErrorDetailsToJSONTyped(json, false);
}

export function ControllerApiV1ErrorDetailsToJSONTyped(value?: ControllerApiV1ErrorDetails | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'request_fields': value['requestFields'] == null ? undefined : ((value['requestFields'] as Array<any>).map(ControllerApiV1FieldErrorToJSON)),
        'wrapped_errors': value['wrappedErrors'] == null ? undefined : ((value['wrappedErrors'] as Array<any>).map(ControllerApiV1WrappedErrorToJSON)),
    };
}
