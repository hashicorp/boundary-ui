 ...
 * 
 * @export
 * @interface ControllerApiServicesV1ListSessionRecordingsResponse
 */
export interface ControllerApiServicesV1ListSessionRecordingsResponse {
    /**
     * The items returned in this page.
     * @type {Array<ControllerApiResourcesSessionrecordingsV1SessionRecording>}
     * @memberof ControllerApiServicesV1ListSessionRecordingsResponse
     */
    items?: Array<ControllerApiResourcesSessionrecordingsV1SessionRecording>;
    /**
...
/**
 * Check if a given object implements the ControllerApiServicesV1ListSessionRecordingsResponse interface.
 */
export function instanceOfControllerApiServicesV1ListSessionRecordingsResponse(value: object): value is ControllerApiServicesV1ListSessionRecordingsResponse {
    return true;
}

export function ControllerApiServicesV1ListSessionRecordingsResponseFromJSON(json: any): ControllerApiServicesV1ListSessionRecordingsResponse {
    return ControllerApiServicesV1ListSessionRecordingsResponseFromJSONTyped(json, false);
}

export function ControllerApiServicesV1ListSessionRecordingsResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1ListSessionRecordingsResponse {
    if (json == null) {
        return json;
    }
    return {
        
        'items': json['items'] == null ? undefined : ((json['items'] as Array<any>).map(ControllerApiResourcesSessionrecordingsV1SessionRecordingFromJSON)),
...
export function ControllerApiServicesV1ListSessionRecordingsResponseToJSON(json: any): ControllerApiServicesV1ListSessionRecordingsResponse {
    return ControllerApiServicesV1ListSessionRecordingsResponseToJSONTyped(json, false);
}

export function ControllerApiServicesV1ListSessionRecordingsResponseToJSONTyped(value?: ControllerApiServicesV1ListSessionRecordingsResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'items': value['items'] == null ? undefined : ((value['items'] as Array<any>).map(ControllerApiResourcesSessionrecordingsV1SessionRecordingToJSON)),
