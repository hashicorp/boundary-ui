 ...
 * 
 * @export
 * @interface ControllerApiServicesV1TargetServiceRemoveTargetCredentialSourcesBody
 */
export interface ControllerApiServicesV1TargetServiceRemoveTargetCredentialSourcesBody {
    /**
     * Version is used to ensure this resource has not changed.
     * The mutation will fail if the version does not match the latest known good version.
     * @type {number}
     * @memberof ControllerApiServicesV1TargetServiceRemoveTargetCredentialSourcesBody
     */
    version?: number;
    /**
     ...
     * @memberof ControllerApiServicesV1TargetServiceRemoveTargetCredentialSourcesBody
     */
    brokeredCredentialSourceIds?: Array<string>;
    /**
     ...
     * @memberof ControllerApiServicesV1TargetServiceRemoveTargetCredentialSourcesBody
     */
    injectedApplicationCredentialSourceIds?: Array<string>;
}

/**
 * Check if a given object implements the ControllerApiServicesV1TargetServiceRemoveTargetCredentialSourcesBody interface.
 */
export function instanceOfControllerApiServicesV1TargetServiceRemoveTargetCredentialSourcesBody(value: object): value is ControllerApiServicesV1TargetServiceRemoveTargetCredentialSourcesBody {
    return true;
}

export function ControllerApiServicesV1TargetServiceRemoveTargetCredentialSourcesBodyFromJSON(json: any): ControllerApiServicesV1TargetServiceRemoveTargetCredentialSourcesBody {
    return ControllerApiServicesV1TargetServiceRemoveTargetCredentialSourcesBodyFromJSONTyped(json, false);
}

export function ControllerApiServicesV1TargetServiceRemoveTargetCredentialSourcesBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1TargetServiceRemoveTargetCredentialSourcesBody {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiServicesV1TargetServiceRemoveTargetCredentialSourcesBodyToJSON(json: any): ControllerApiServicesV1TargetServiceRemoveTargetCredentialSourcesBody {
    return ControllerApiServicesV1TargetServiceRemoveTargetCredentialSourcesBodyToJSONTyped(json, false);
}

export function ControllerApiServicesV1TargetServiceRemoveTargetCredentialSourcesBodyToJSONTyped(value?: ControllerApiServicesV1TargetServiceRemoveTargetCredentialSourcesBody | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'brokered_credential_source_ids': value['brokeredCredentialSourceIds'],
        'injected_application_credential_source_ids': value['injectedApplicationCredentialSourceIds'],
    };
}
