 ...
 * 
 * @export
 * @interface ControllerApiServicesV1SetTargetHostSourcesResponse
 */
export interface ControllerApiServicesV1SetTargetHostSourcesResponse {
    /**
     * 
     * @type {ControllerApiResourcesTargetsV1Target}
     * @memberof ControllerApiServicesV1SetTargetHostSourcesResponse
     */
    item?: ControllerApiResourcesTargetsV1Target;
}

/**
 * Check if a given object implements the ControllerApiServicesV1SetTargetHostSourcesResponse interface.
 */
export function instanceOfControllerApiServicesV1SetTargetHostSourcesResponse(value: object): value is ControllerApiServicesV1SetTargetHostSourcesResponse {
    return true;
}

export function ControllerApiServicesV1SetTargetHostSourcesResponseFromJSON(json: any): ControllerApiServicesV1SetTargetHostSourcesResponse {
    return ControllerApiServicesV1SetTargetHostSourcesResponseFromJSONTyped(json, false);
}

export function ControllerApiServicesV1SetTargetHostSourcesResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1SetTargetHostSourcesResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiServicesV1SetTargetHostSourcesResponseToJSON(json: any): ControllerApiServicesV1SetTargetHostSourcesResponse {
    return ControllerApiServicesV1SetTargetHostSourcesResponseToJSONTyped(json, false);
}

export function ControllerApiServicesV1SetTargetHostSourcesResponseToJSONTyped(value?: ControllerApiServicesV1SetTargetHostSourcesResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
