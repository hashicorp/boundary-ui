 ...
 * 
 * @export
 * @interface ControllerApiServicesV1SetHostSetHostsResponse
 */
export interface ControllerApiServicesV1SetHostSetHostsResponse {
    /**
     * 
     * @type {ControllerApiResourcesHostsetsV1HostSet}
     * @memberof ControllerApiServicesV1SetHostSetHostsResponse
     */
    item?: ControllerApiResourcesHostsetsV1HostSet;
}

/**
 * Check if a given object implements the ControllerApiServicesV1SetHostSetHostsResponse interface.
 */
export function instanceOfControllerApiServicesV1SetHostSetHostsResponse(value: object): value is ControllerApiServicesV1SetHostSetHostsResponse {
    return true;
}

export function ControllerApiServicesV1SetHostSetHostsResponseFromJSON(json: any): ControllerApiServicesV1SetHostSetHostsResponse {
    return ControllerApiServicesV1SetHostSetHostsResponseFromJSONTyped(json, false);
}

export function ControllerApiServicesV1SetHostSetHostsResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1SetHostSetHostsResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiServicesV1SetHostSetHostsResponseToJSON(json: any): ControllerApiServicesV1SetHostSetHostsResponse {
    return ControllerApiServicesV1SetHostSetHostsResponseToJSONTyped(json, false);
}

export function ControllerApiServicesV1SetHostSetHostsResponseToJSONTyped(value?: ControllerApiServicesV1SetHostSetHostsResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
