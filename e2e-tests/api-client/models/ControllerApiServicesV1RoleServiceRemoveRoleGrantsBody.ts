 ...
 * 
 * @export
 * @interface ControllerApiServicesV1RoleServiceRemoveRoleGrantsBody
 */
export interface ControllerApiServicesV1RoleServiceRemoveRoleGrantsBody {
    /**
     * Version is used to ensure this resource has not changed.
     * The mutation will fail if the version does not match the latest known good version.
     * @type {number}
     * @memberof ControllerApiServicesV1RoleServiceRemoveRoleGrantsBody
     */
    version?: number;
    /**
     * 
     ...
     * @memberof ControllerApiServicesV1RoleServiceRemoveRoleGrantsBody
     */
    grantStrings?: Array<string>;
}

/**
 * Check if a given object implements the ControllerApiServicesV1RoleServiceRemoveRoleGrantsBody interface.
 */
export function instanceOfControllerApiServicesV1RoleServiceRemoveRoleGrantsBody(value: object): value is ControllerApiServicesV1RoleServiceRemoveRoleGrantsBody {
    return true;
}

export function ControllerApiServicesV1RoleServiceRemoveRoleGrantsBodyFromJSON(json: any): ControllerApiServicesV1RoleServiceRemoveRoleGrantsBody {
    return ControllerApiServicesV1RoleServiceRemoveRoleGrantsBodyFromJSONTyped(json, false);
}

export function ControllerApiServicesV1RoleServiceRemoveRoleGrantsBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1RoleServiceRemoveRoleGrantsBody {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiServicesV1RoleServiceRemoveRoleGrantsBodyToJSON(json: any): ControllerApiServicesV1RoleServiceRemoveRoleGrantsBody {
    return ControllerApiServicesV1RoleServiceRemoveRoleGrantsBodyToJSONTyped(json, false);
}

export function ControllerApiServicesV1RoleServiceRemoveRoleGrantsBodyToJSONTyped(value?: ControllerApiServicesV1RoleServiceRemoveRoleGrantsBody | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'grant_strings': value['grantStrings'],
    };
}
