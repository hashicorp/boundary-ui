 ...
 * 
 * @export
 * @interface ControllerApiResourcesSessionrecordingsV1Credential
 */
export interface ControllerApiResourcesSessionrecordingsV1Credential {
    /**
     * The ID of the Credential.
     * @type {string}
     * @memberof ControllerApiResourcesSessionrecordingsV1Credential
     */
    id?: string;
    /**
     * 
...
/**
 * Check if a given object implements the ControllerApiResourcesSessionrecordingsV1Credential interface.
 */
export function instanceOfControllerApiResourcesSessionrecordingsV1Credential(value: object): value is ControllerApiResourcesSessionrecordingsV1Credential {
    return true;
}

export function ControllerApiResourcesSessionrecordingsV1CredentialFromJSON(json: any): ControllerApiResourcesSessionrecordingsV1Credential {
    return ControllerApiResourcesSessionrecordingsV1CredentialFromJSONTyped(json, false);
}

export function ControllerApiResourcesSessionrecordingsV1CredentialFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiResourcesSessionrecordingsV1Credential {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiResourcesSessionrecordingsV1CredentialToJSON(json: any): ControllerApiResourcesSessionrecordingsV1Credential {
    return ControllerApiResourcesSessionrecordingsV1CredentialToJSONTyped(json, false);
}

export function ControllerApiResourcesSessionrecordingsV1CredentialToJSONTyped(value?: ControllerApiResourcesSessionrecordingsV1Credential | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
