 ...
 * 
 * @export
 * @interface ControllerApiServicesV1ListHostCatalogsResponse
 */
export interface ControllerApiServicesV1ListHostCatalogsResponse {
    /**
     * 
     * @type {Array<ControllerApiResourcesHostcatalogsV1HostCatalog>}
     * @memberof ControllerApiServicesV1ListHostCatalogsResponse
     */
    items?: Array<ControllerApiResourcesHostcatalogsV1HostCatalog>;
    /**
...
/**
 * Check if a given object implements the ControllerApiServicesV1ListHostCatalogsResponse interface.
 */
export function instanceOfControllerApiServicesV1ListHostCatalogsResponse(value: object): value is ControllerApiServicesV1ListHostCatalogsResponse {
    return true;
}

export function ControllerApiServicesV1ListHostCatalogsResponseFromJSON(json: any): ControllerApiServicesV1ListHostCatalogsResponse {
    return ControllerApiServicesV1ListHostCatalogsResponseFromJSONTyped(json, false);
}

export function ControllerApiServicesV1ListHostCatalogsResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1ListHostCatalogsResponse {
    if (json == null) {
        return json;
    }
    return {
        
        'items': json['items'] == null ? undefined : ((json['items'] as Array<any>).map(ControllerApiResourcesHostcatalogsV1HostCatalogFromJSON)),
...
export function ControllerApiServicesV1ListHostCatalogsResponseToJSON(json: any): ControllerApiServicesV1ListHostCatalogsResponse {
    return ControllerApiServicesV1ListHostCatalogsResponseToJSONTyped(json, false);
}

export function ControllerApiServicesV1ListHostCatalogsResponseToJSONTyped(value?: ControllerApiServicesV1ListHostCatalogsResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'items': value['items'] == null ? undefined : ((value['items'] as Array<any>).map(ControllerApiResourcesHostcatalogsV1HostCatalogToJSON)),
