 ...
 * 
 * @export
 * @interface ControllerApiServicesV1AddWorkerTagsResponse
 */
export interface ControllerApiServicesV1AddWorkerTagsResponse {
    /**
     * 
     * @type {ControllerApiResourcesWorkersV1Worker}
     * @memberof ControllerApiServicesV1AddWorkerTagsResponse
     */
    item?: ControllerApiResourcesWorkersV1Worker;
}

/**
 * Check if a given object implements the ControllerApiServicesV1AddWorkerTagsResponse interface.
 */
export function instanceOfControllerApiServicesV1AddWorkerTagsResponse(value: object): value is ControllerApiServicesV1AddWorkerTagsResponse {
    return true;
}

export function ControllerApiServicesV1AddWorkerTagsResponseFromJSON(json: any): ControllerApiServicesV1AddWorkerTagsResponse {
    return ControllerApiServicesV1AddWorkerTagsResponseFromJSONTyped(json, false);
}

export function ControllerApiServicesV1AddWorkerTagsResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1AddWorkerTagsResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiServicesV1AddWorkerTagsResponseToJSON(json: any): ControllerApiServicesV1AddWorkerTagsResponse {
    return ControllerApiServicesV1AddWorkerTagsResponseToJSONTyped(json, false);
}

export function ControllerApiServicesV1AddWorkerTagsResponseToJSONTyped(value?: ControllerApiServicesV1AddWorkerTagsResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
