...
import type { ControllerApiResourcesRolesV1Role } from './ControllerApiResourcesRolesV1Role';
import {
    ControllerApiResourcesRolesV1RoleFromJSON,
    ControllerApiResourcesRolesV1RoleFromJSONTyped,
    ControllerApiResourcesRolesV1RoleToJSON,
    ControllerApiResourcesRolesV1RoleToJSONTyped,
} from './ControllerApiResourcesRolesV1Role';

/**
 * 
 * @export
 * @interface ControllerApiServicesV1RemoveRoleGrantScopesResponse
 */
export interface ControllerApiServicesV1RemoveRoleGrantScopesResponse {
    /**
     * 
     * @type {ControllerApiResourcesRolesV1Role}
     * @memberof ControllerApiServicesV1RemoveRoleGrantScopesResponse
     */
    item?: ControllerApiResourcesRolesV1Role;
}

/**
 * Check if a given object implements the ControllerApiServicesV1RemoveRoleGrantScopesResponse interface.
 */
export function instanceOfControllerApiServicesV1RemoveRoleGrantScopesResponse(value: object): value is ControllerApiServicesV1RemoveRoleGrantScopesResponse {
    return true;
}

export function ControllerApiServicesV1RemoveRoleGrantScopesResponseFromJSON(json: any): ControllerApiServicesV1RemoveRoleGrantScopesResponse {
    return ControllerApiServicesV1RemoveRoleGrantScopesResponseFromJSONTyped(json, false);
}

export function ControllerApiServicesV1RemoveRoleGrantScopesResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1RemoveRoleGrantScopesResponse {
    if (json == null) {
        return json;
    }
    return {
        
        'item': json['item'] == null ? undefined : ControllerApiResourcesRolesV1RoleFromJSON(json['item']),
    };
}

export function ControllerApiServicesV1RemoveRoleGrantScopesResponseToJSON(json: any): ControllerApiServicesV1RemoveRoleGrantScopesResponse {
    return ControllerApiServicesV1RemoveRoleGrantScopesResponseToJSONTyped(json, false);
}

export function ControllerApiServicesV1RemoveRoleGrantScopesResponseToJSONTyped(value?: ControllerApiServicesV1RemoveRoleGrantScopesResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'item': ControllerApiResourcesRolesV1RoleToJSON(value['item']),
    };
}
