 ...
 * 
 * @export
 * @interface ControllerApiResourcesCredentialstoresV1CredentialStore
 */
export interface ControllerApiResourcesCredentialstoresV1CredentialStore {
    /**
     * Output only. The ID of the Credential Store.
     * @type {string}
     * @memberof ControllerApiResourcesCredentialstoresV1CredentialStore
     */
    readonly id?: string;
    /**
...
/**
 * Check if a given object implements the ControllerApiResourcesCredentialstoresV1CredentialStore interface.
 */
export function instanceOfControllerApiResourcesCredentialstoresV1CredentialStore(value: object): value is ControllerApiResourcesCredentialstoresV1CredentialStore {
    return true;
}

export function ControllerApiResourcesCredentialstoresV1CredentialStoreFromJSON(json: any): ControllerApiResourcesCredentialstoresV1CredentialStore {
    return ControllerApiResourcesCredentialstoresV1CredentialStoreFromJSONTyped(json, false);
}

export function ControllerApiResourcesCredentialstoresV1CredentialStoreFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiResourcesCredentialstoresV1CredentialStore {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiResourcesCredentialstoresV1CredentialStoreToJSON(json: any): ControllerApiResourcesCredentialstoresV1CredentialStore {
    return ControllerApiResourcesCredentialstoresV1CredentialStoreToJSONTyped(json, false);
}

export function ControllerApiResourcesCredentialstoresV1CredentialStoreToJSONTyped(value?: Omit<ControllerApiResourcesCredentialstoresV1CredentialStore, 'id'|'created_time'|'updated_time'|'authorized_actions'|'authorized_collection_actions'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
