 ...
 * 
 * @export
 * @interface ControllerApiServicesV1GetAliasResponse
 */
export interface ControllerApiServicesV1GetAliasResponse {
    /**
     * 
     * @type {ControllerApiResourcesAliasesV1Alias}
     * @memberof ControllerApiServicesV1GetAliasResponse
     */
    item?: ControllerApiResourcesAliasesV1Alias;
}

/**
 * Check if a given object implements the ControllerApiServicesV1GetAliasResponse interface.
 */
export function instanceOfControllerApiServicesV1GetAliasResponse(value: object): value is ControllerApiServicesV1GetAliasResponse {
    return true;
}

export function ControllerApiServicesV1GetAliasResponseFromJSON(json: any): ControllerApiServicesV1GetAliasResponse {
    return ControllerApiServicesV1GetAliasResponseFromJSONTyped(json, false);
}

export function ControllerApiServicesV1GetAliasResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1GetAliasResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiServicesV1GetAliasResponseToJSON(json: any): ControllerApiServicesV1GetAliasResponse {
    return ControllerApiServicesV1GetAliasResponseToJSONTyped(json, false);
}

export function ControllerApiServicesV1GetAliasResponseToJSONTyped(value?: ControllerApiServicesV1GetAliasResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
