 ...
 * 
 * @export
 * @interface ControllerApiServicesV1AddRolePrincipalsResponse
 */
export interface ControllerApiServicesV1AddRolePrincipalsResponse {
    /**
     * 
     * @type {ControllerApiResourcesRolesV1Role}
     * @memberof ControllerApiServicesV1AddRolePrincipalsResponse
     */
    item?: ControllerApiResourcesRolesV1Role;
}

/**
 * Check if a given object implements the ControllerApiServicesV1AddRolePrincipalsResponse interface.
 */
export function instanceOfControllerApiServicesV1AddRolePrincipalsResponse(value: object): value is ControllerApiServicesV1AddRolePrincipalsResponse {
    return true;
}

export function ControllerApiServicesV1AddRolePrincipalsResponseFromJSON(json: any): ControllerApiServicesV1AddRolePrincipalsResponse {
    return ControllerApiServicesV1AddRolePrincipalsResponseFromJSONTyped(json, false);
}

export function ControllerApiServicesV1AddRolePrincipalsResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1AddRolePrincipalsResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiServicesV1AddRolePrincipalsResponseToJSON(json: any): ControllerApiServicesV1AddRolePrincipalsResponse {
    return ControllerApiServicesV1AddRolePrincipalsResponseToJSONTyped(json, false);
}

export function ControllerApiServicesV1AddRolePrincipalsResponseToJSONTyped(value?: ControllerApiServicesV1AddRolePrincipalsResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
