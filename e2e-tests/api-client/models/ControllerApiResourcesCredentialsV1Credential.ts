 ...
 * 
 * @export
 * @interface ControllerApiResourcesCredentialsV1Credential
 */
export interface ControllerApiResourcesCredentialsV1Credential {
    /**
     * Output only. The ID of the Credential.
     * @type {string}
     * @memberof ControllerApiResourcesCredentialsV1Credential
     */
    readonly id?: string;
    /**
...
/**
 * Check if a given object implements the ControllerApiResourcesCredentialsV1Credential interface.
 */
export function instanceOfControllerApiResourcesCredentialsV1Credential(value: object): value is ControllerApiResourcesCredentialsV1Credential {
    return true;
}

export function ControllerApiResourcesCredentialsV1CredentialFromJSON(json: any): ControllerApiResourcesCredentialsV1Credential {
    return ControllerApiResourcesCredentialsV1CredentialFromJSONTyped(json, false);
}

export function ControllerApiResourcesCredentialsV1CredentialFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiResourcesCredentialsV1Credential {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiResourcesCredentialsV1CredentialToJSON(json: any): ControllerApiResourcesCredentialsV1Credential {
    return ControllerApiResourcesCredentialsV1CredentialToJSONTyped(json, false);
}

export function ControllerApiResourcesCredentialsV1CredentialToJSONTyped(value?: Omit<ControllerApiResourcesCredentialsV1Credential, 'id'|'created_time'|'updated_time'|'authorized_actions'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
