 ...
 * 
 * @export
 * @interface ControllerApiServicesV1GetScopeResponse
 */
export interface ControllerApiServicesV1GetScopeResponse {
    /**
     * 
     * @type {ControllerApiResourcesScopesV1Scope}
     * @memberof ControllerApiServicesV1GetScopeResponse
     */
    item?: ControllerApiResourcesScopesV1Scope;
}

/**
 * Check if a given object implements the ControllerApiServicesV1GetScopeResponse interface.
 */
export function instanceOfControllerApiServicesV1GetScopeResponse(value: object): value is ControllerApiServicesV1GetScopeResponse {
    return true;
}

export function ControllerApiServicesV1GetScopeResponseFromJSON(json: any): ControllerApiServicesV1GetScopeResponse {
    return ControllerApiServicesV1GetScopeResponseFromJSONTyped(json, false);
}

export function ControllerApiServicesV1GetScopeResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1GetScopeResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiServicesV1GetScopeResponseToJSON(json: any): ControllerApiServicesV1GetScopeResponse {
    return ControllerApiServicesV1GetScopeResponseToJSONTyped(json, false);
}

export function ControllerApiServicesV1GetScopeResponseToJSONTyped(value?: ControllerApiServicesV1GetScopeResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
