...
import type { ControllerApiResourcesTargetsV1TargetAliasAttributes } from './ControllerApiResourcesTargetsV1TargetAliasAttributes';
import {
    ControllerApiResourcesTargetsV1TargetAliasAttributesFromJSON,
    ControllerApiResourcesTargetsV1TargetAliasAttributesFromJSONTyped,
    ControllerApiResourcesTargetsV1TargetAliasAttributesToJSON,
    ControllerApiResourcesTargetsV1TargetAliasAttributesToJSONTyped,
} from './ControllerApiResourcesTargetsV1TargetAliasAttributes';

/**
 * Alias is the alias information related to the aliases associated with the target.
 * @export
 * @interface ControllerApiResourcesTargetsV1Alias
 */
export interface ControllerApiResourcesTargetsV1Alias {
    /**
     * Output only. The ID of the alias referencing this target.
     * @type {string}
     * @memberof ControllerApiResourcesTargetsV1Alias
     */
    readonly id?: string;
    /**
    ...
    /**
     * 
     * @type {ControllerApiResourcesTargetsV1TargetAliasAttributes}
     * @memberof ControllerApiResourcesTargetsV1Alias
     */
    attributes?: ControllerApiResourcesTargetsV1TargetAliasAttributes;
}

/**
 * Check if a given object implements the ControllerApiResourcesTargetsV1Alias interface.
 */
export function instanceOfControllerApiResourcesTargetsV1Alias(value: object): value is ControllerApiResourcesTargetsV1Alias {
    return true;
}

export function ControllerApiResourcesTargetsV1AliasFromJSON(json: any): ControllerApiResourcesTargetsV1Alias {
    return ControllerApiResourcesTargetsV1AliasFromJSONTyped(json, false);
}

export function ControllerApiResourcesTargetsV1AliasFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiResourcesTargetsV1Alias {
    if (json == null) {
        return json;
    }
    return {
        ...
        'attributes': json['attributes'] == null ? undefined : ControllerApiResourcesTargetsV1TargetAliasAttributesFromJSON(json['attributes']),
    };
}

export function ControllerApiResourcesTargetsV1AliasToJSON(json: any): ControllerApiResourcesTargetsV1Alias {
    return ControllerApiResourcesTargetsV1AliasToJSONTyped(json, false);
}

export function ControllerApiResourcesTargetsV1AliasToJSONTyped(value?: Omit<ControllerApiResourcesTargetsV1Alias, 'id'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'attributes': ControllerApiResourcesTargetsV1TargetAliasAttributesToJSON(value['attributes']),
    };
}
