 ...
 * 
 * @export
 * @interface ControllerApiServicesV1GetCredentialStoreResponse
 */
export interface ControllerApiServicesV1GetCredentialStoreResponse {
    /**
     * 
     * @type {ControllerApiResourcesCredentialstoresV1CredentialStore}
     * @memberof ControllerApiServicesV1GetCredentialStoreResponse
     */
    item?: ControllerApiResourcesCredentialstoresV1CredentialStore;
}

/**
 * Check if a given object implements the ControllerApiServicesV1GetCredentialStoreResponse interface.
 */
export function instanceOfControllerApiServicesV1GetCredentialStoreResponse(value: object): value is ControllerApiServicesV1GetCredentialStoreResponse {
    return true;
}

export function ControllerApiServicesV1GetCredentialStoreResponseFromJSON(json: any): ControllerApiServicesV1GetCredentialStoreResponse {
    return ControllerApiServicesV1GetCredentialStoreResponseFromJSONTyped(json, false);
}

export function ControllerApiServicesV1GetCredentialStoreResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1GetCredentialStoreResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiServicesV1GetCredentialStoreResponseToJSON(json: any): ControllerApiServicesV1GetCredentialStoreResponse {
    return ControllerApiServicesV1GetCredentialStoreResponseToJSONTyped(json, false);
}

export function ControllerApiServicesV1GetCredentialStoreResponseToJSONTyped(value?: ControllerApiServicesV1GetCredentialStoreResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
