 ...
 * @export
 * @interface ControllerApiResourcesTargetsV1SessionSecret
 */
export interface ControllerApiResourcesTargetsV1SessionSecret {
    /**
     * Output only. The base64-encoded value representing the raw bytes from the
     * credential provider.
     * @type {string}
     * @memberof ControllerApiResourcesTargetsV1SessionSecret
     */
    readonly raw?: string;
    /**
     ...
     * @memberof ControllerApiResourcesTargetsV1SessionSecret
     */
    readonly decoded?: object;
}

/**
 * Check if a given object implements the ControllerApiResourcesTargetsV1SessionSecret interface.
 */
export function instanceOfControllerApiResourcesTargetsV1SessionSecret(value: object): value is ControllerApiResourcesTargetsV1SessionSecret {
    return true;
}

export function ControllerApiResourcesTargetsV1SessionSecretFromJSON(json: any): ControllerApiResourcesTargetsV1SessionSecret {
    return ControllerApiResourcesTargetsV1SessionSecretFromJSONTyped(json, false);
}

export function ControllerApiResourcesTargetsV1SessionSecretFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiResourcesTargetsV1SessionSecret {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiResourcesTargetsV1SessionSecretToJSON(json: any): ControllerApiResourcesTargetsV1SessionSecret {
    return ControllerApiResourcesTargetsV1SessionSecretToJSONTyped(json, false);
}

export function ControllerApiResourcesTargetsV1SessionSecretToJSONTyped(value?: Omit<ControllerApiResourcesTargetsV1SessionSecret, 'raw'|'decoded'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
