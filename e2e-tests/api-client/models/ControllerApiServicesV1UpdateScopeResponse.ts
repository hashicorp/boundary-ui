 ...
 * 
 * @export
 * @interface ControllerApiServicesV1UpdateScopeResponse
 */
export interface ControllerApiServicesV1UpdateScopeResponse {
    /**
     * 
     * @type {ControllerApiResourcesScopesV1Scope}
     * @memberof ControllerApiServicesV1UpdateScopeResponse
     */
    item?: ControllerApiResourcesScopesV1Scope;
}

/**
 * Check if a given object implements the ControllerApiServicesV1UpdateScopeResponse interface.
 */
export function instanceOfControllerApiServicesV1UpdateScopeResponse(value: object): value is ControllerApiServicesV1UpdateScopeResponse {
    return true;
}

export function ControllerApiServicesV1UpdateScopeResponseFromJSON(json: any): ControllerApiServicesV1UpdateScopeResponse {
    return ControllerApiServicesV1UpdateScopeResponseFromJSONTyped(json, false);
}

export function ControllerApiServicesV1UpdateScopeResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1UpdateScopeResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiServicesV1UpdateScopeResponseToJSON(json: any): ControllerApiServicesV1UpdateScopeResponse {
    return ControllerApiServicesV1UpdateScopeResponseToJSONTyped(json, false);
}

export function ControllerApiServicesV1UpdateScopeResponseToJSONTyped(value?: ControllerApiServicesV1UpdateScopeResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
