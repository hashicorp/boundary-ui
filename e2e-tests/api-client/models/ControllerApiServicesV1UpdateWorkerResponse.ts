 ...
 * 
 * @export
 * @interface ControllerApiServicesV1UpdateWorkerResponse
 */
export interface ControllerApiServicesV1UpdateWorkerResponse {
    /**
     * 
     * @type {ControllerApiResourcesWorkersV1Worker}
     * @memberof ControllerApiServicesV1UpdateWorkerResponse
     */
    item?: ControllerApiResourcesWorkersV1Worker;
}

/**
 * Check if a given object implements the ControllerApiServicesV1UpdateWorkerResponse interface.
 */
export function instanceOfControllerApiServicesV1UpdateWorkerResponse(value: object): value is ControllerApiServicesV1UpdateWorkerResponse {
    return true;
}

export function ControllerApiServicesV1UpdateWorkerResponseFromJSON(json: any): ControllerApiServicesV1UpdateWorkerResponse {
    return ControllerApiServicesV1UpdateWorkerResponseFromJSONTyped(json, false);
}

export function ControllerApiServicesV1UpdateWorkerResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1UpdateWorkerResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiServicesV1UpdateWorkerResponseToJSON(json: any): ControllerApiServicesV1UpdateWorkerResponse {
    return ControllerApiServicesV1UpdateWorkerResponseToJSONTyped(json, false);
}

export function ControllerApiServicesV1UpdateWorkerResponseToJSONTyped(value?: ControllerApiServicesV1UpdateWorkerResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
