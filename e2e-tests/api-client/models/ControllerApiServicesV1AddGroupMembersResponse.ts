 ...
 * 
 * @export
 * @interface ControllerApiServicesV1AddGroupMembersResponse
 */
export interface ControllerApiServicesV1AddGroupMembersResponse {
    /**
     * 
     * @type {ControllerApiResourcesGroupsV1Group}
     * @memberof ControllerApiServicesV1AddGroupMembersResponse
     */
    item?: ControllerApiResourcesGroupsV1Group;
}

/**
 * Check if a given object implements the ControllerApiServicesV1AddGroupMembersResponse interface.
 */
export function instanceOfControllerApiServicesV1AddGroupMembersResponse(value: object): value is ControllerApiServicesV1AddGroupMembersResponse {
    return true;
}

export function ControllerApiServicesV1AddGroupMembersResponseFromJSON(json: any): ControllerApiServicesV1AddGroupMembersResponse {
    return ControllerApiServicesV1AddGroupMembersResponseFromJSONTyped(json, false);
}

export function ControllerApiServicesV1AddGroupMembersResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1AddGroupMembersResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiServicesV1AddGroupMembersResponseToJSON(json: any): ControllerApiServicesV1AddGroupMembersResponse {
    return ControllerApiServicesV1AddGroupMembersResponseToJSONTyped(json, false);
}

export function ControllerApiServicesV1AddGroupMembersResponseToJSONTyped(value?: ControllerApiServicesV1AddGroupMembersResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
