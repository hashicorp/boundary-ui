 ...
 * 
 * @export
 * @interface ControllerApiServicesV1ListAliasesResponse
 */
export interface ControllerApiServicesV1ListAliasesResponse {
    /**
     * The list of aliases.
     * @type {Array<ControllerApiResourcesAliasesV1Alias>}
     * @memberof ControllerApiServicesV1ListAliasesResponse
     */
...
/**
 * Check if a given object implements the ControllerApiServicesV1ListAliasesResponse interface.
 */
export function instanceOfControllerApiServicesV1ListAliasesResponse(value: object): value is ControllerApiServicesV1ListAliasesResponse {
    return true;
}

export function ControllerApiServicesV1ListAliasesResponseFromJSON(json: any): ControllerApiServicesV1ListAliasesResponse {
    return ControllerApiServicesV1ListAliasesResponseFromJSONTyped(json, false);
}

export function ControllerApiServicesV1ListAliasesResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1ListAliasesResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiServicesV1ListAliasesResponseToJSON(json: any): ControllerApiServicesV1ListAliasesResponse {
    return ControllerApiServicesV1ListAliasesResponseToJSONTyped(json, false);
}

export function ControllerApiServicesV1ListAliasesResponseToJSONTyped(value?: ControllerApiServicesV1ListAliasesResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
