...
import type { ControllerApiResourcesRolesV1GrantJson } from './ControllerApiResourcesRolesV1GrantJson';
import {
    ControllerApiResourcesRolesV1GrantJsonFromJSON,
    ControllerApiResourcesRolesV1GrantJsonFromJSONTyped,
    ControllerApiResourcesRolesV1GrantJsonToJSON,
    ControllerApiResourcesRolesV1GrantJsonToJSONTyped,
} from './ControllerApiResourcesRolesV1GrantJson';

/**
 * 
 * @export
 * @interface ControllerApiResourcesRolesV1Grant
 */
export interface ControllerApiResourcesRolesV1Grant {
    /**
     * Output only. The original user-supplied string.
     * @type {string}
     * @memberof ControllerApiResourcesRolesV1Grant
     */
    readonly raw?: string;
    /**
    ...
    /**
     * 
     * @type {ControllerApiResourcesRolesV1GrantJson}
     * @memberof ControllerApiResourcesRolesV1Grant
     */
    json?: ControllerApiResourcesRolesV1GrantJson;
}

/**
 * Check if a given object implements the ControllerApiResourcesRolesV1Grant interface.
 */
export function instanceOfControllerApiResourcesRolesV1Grant(value: object): value is ControllerApiResourcesRolesV1Grant {
    return true;
}

export function ControllerApiResourcesRolesV1GrantFromJSON(json: any): ControllerApiResourcesRolesV1Grant {
    return ControllerApiResourcesRolesV1GrantFromJSONTyped(json, false);
}

export function ControllerApiResourcesRolesV1GrantFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiResourcesRolesV1Grant {
    if (json == null) {
        return json;
    }
    return {
        ...
        'json': json['json'] == null ? undefined : ControllerApiResourcesRolesV1GrantJsonFromJSON(json['json']),
    };
}

export function ControllerApiResourcesRolesV1GrantToJSON(json: any): ControllerApiResourcesRolesV1Grant {
    return ControllerApiResourcesRolesV1GrantToJSONTyped(json, false);
}

export function ControllerApiResourcesRolesV1GrantToJSONTyped(value?: Omit<ControllerApiResourcesRolesV1Grant, 'raw'|'canonical'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'json': ControllerApiResourcesRolesV1GrantJsonToJSON(value['json']),
    };
}
