 ...
 * 
 * @export
 * @interface ControllerApiServicesV1TargetServiceSetTargetHostSourcesBody
 */
export interface ControllerApiServicesV1TargetServiceSetTargetHostSourcesBody {
    /**
     * Version is used to ensure this resource has not changed.
     * The mutation will fail if the version does not match the latest known good version.
     * @type {number}
     * @memberof ControllerApiServicesV1TargetServiceSetTargetHostSourcesBody
     */
    version?: number;
    /**
     * 
...
/**
 * Check if a given object implements the ControllerApiServicesV1TargetServiceSetTargetHostSourcesBody interface.
 */
export function instanceOfControllerApiServicesV1TargetServiceSetTargetHostSourcesBody(value: object): value is ControllerApiServicesV1TargetServiceSetTargetHostSourcesBody {
    return true;
}

export function ControllerApiServicesV1TargetServiceSetTargetHostSourcesBodyFromJSON(json: any): ControllerApiServicesV1TargetServiceSetTargetHostSourcesBody {
    return ControllerApiServicesV1TargetServiceSetTargetHostSourcesBodyFromJSONTyped(json, false);
}

export function ControllerApiServicesV1TargetServiceSetTargetHostSourcesBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1TargetServiceSetTargetHostSourcesBody {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiServicesV1TargetServiceSetTargetHostSourcesBodyToJSON(json: any): ControllerApiServicesV1TargetServiceSetTargetHostSourcesBody {
    return ControllerApiServicesV1TargetServiceSetTargetHostSourcesBodyToJSONTyped(json, false);
}

export function ControllerApiServicesV1TargetServiceSetTargetHostSourcesBodyToJSONTyped(value?: ControllerApiServicesV1TargetServiceSetTargetHostSourcesBody | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
