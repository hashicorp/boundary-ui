 ...
 * 
 * @export
 * @interface ControllerApiServicesV1GetWorkerResponse
 */
export interface ControllerApiServicesV1GetWorkerResponse {
    /**
     * 
     * @type {ControllerApiResourcesWorkersV1Worker}
     * @memberof ControllerApiServicesV1GetWorkerResponse
     */
    item?: ControllerApiResourcesWorkersV1Worker;
}

/**
 * Check if a given object implements the ControllerApiServicesV1GetWorkerResponse interface.
 */
export function instanceOfControllerApiServicesV1GetWorkerResponse(value: object): value is ControllerApiServicesV1GetWorkerResponse {
    return true;
}

export function ControllerApiServicesV1GetWorkerResponseFromJSON(json: any): ControllerApiServicesV1GetWorkerResponse {
    return ControllerApiServicesV1GetWorkerResponseFromJSONTyped(json, false);
}

export function ControllerApiServicesV1GetWorkerResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1GetWorkerResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiServicesV1GetWorkerResponseToJSON(json: any): ControllerApiServicesV1GetWorkerResponse {
    return ControllerApiServicesV1GetWorkerResponseToJSONTyped(json, false);
}

export function ControllerApiServicesV1GetWorkerResponseToJSONTyped(value?: ControllerApiServicesV1GetWorkerResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
