 ...
 * 
 * @export
 * @interface ControllerApiServicesV1AddTargetHostSourcesResponse
 */
export interface ControllerApiServicesV1AddTargetHostSourcesResponse {
    /**
     * 
     * @type {ControllerApiResourcesTargetsV1Target}
     * @memberof ControllerApiServicesV1AddTargetHostSourcesResponse
     */
    item?: ControllerApiResourcesTargetsV1Target;
}

/**
 * Check if a given object implements the ControllerApiServicesV1AddTargetHostSourcesResponse interface.
 */
export function instanceOfControllerApiServicesV1AddTargetHostSourcesResponse(value: object): value is ControllerApiServicesV1AddTargetHostSourcesResponse {
    return true;
}

export function ControllerApiServicesV1AddTargetHostSourcesResponseFromJSON(json: any): ControllerApiServicesV1AddTargetHostSourcesResponse {
    return ControllerApiServicesV1AddTargetHostSourcesResponseFromJSONTyped(json, false);
}

export function ControllerApiServicesV1AddTargetHostSourcesResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1AddTargetHostSourcesResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiServicesV1AddTargetHostSourcesResponseToJSON(json: any): ControllerApiServicesV1AddTargetHostSourcesResponse {
    return ControllerApiServicesV1AddTargetHostSourcesResponseToJSONTyped(json, false);
}

export function ControllerApiServicesV1AddTargetHostSourcesResponseToJSONTyped(value?: ControllerApiServicesV1AddTargetHostSourcesResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
