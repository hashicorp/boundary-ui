 ...
 * 
 * @export
 * @interface ControllerApiResourcesTargetsV1HostSource
 */
export interface ControllerApiResourcesTargetsV1HostSource {
    /**
     * Output only. The ID of the Host Set.
     * @type {string}
     * @memberof ControllerApiResourcesTargetsV1HostSource
     */
    readonly id?: string;
    /**
...
/**
 * Check if a given object implements the ControllerApiResourcesTargetsV1HostSource interface.
 */
export function instanceOfControllerApiResourcesTargetsV1HostSource(value: object): value is ControllerApiResourcesTargetsV1HostSource {
    return true;
}

export function ControllerApiResourcesTargetsV1HostSourceFromJSON(json: any): ControllerApiResourcesTargetsV1HostSource {
    return ControllerApiResourcesTargetsV1HostSourceFromJSONTyped(json, false);
}

export function ControllerApiResourcesTargetsV1HostSourceFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiResourcesTargetsV1HostSource {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiResourcesTargetsV1HostSourceToJSON(json: any): ControllerApiResourcesTargetsV1HostSource {
    return ControllerApiResourcesTargetsV1HostSourceToJSONTyped(json, false);
}

export function ControllerApiResourcesTargetsV1HostSourceToJSONTyped(value?: Omit<ControllerApiResourcesTargetsV1HostSource, 'id'|'host_catalog_id'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
