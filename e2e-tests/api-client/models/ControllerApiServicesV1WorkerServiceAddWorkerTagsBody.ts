 ...
 * 
 * @export
 * @interface ControllerApiServicesV1WorkerServiceAddWorkerTagsBody
 */
export interface ControllerApiServicesV1WorkerServiceAddWorkerTagsBody {
    /**
     * Version is used to ensure this resource has not changed.
     * The mutation will fail if the version does not match the latest known good version.
     * @type {number}
     * @memberof ControllerApiServicesV1WorkerServiceAddWorkerTagsBody
     */
    version?: number;
    /**
     * 
...
/**
 * Check if a given object implements the ControllerApiServicesV1WorkerServiceAddWorkerTagsBody interface.
 */
export function instanceOfControllerApiServicesV1WorkerServiceAddWorkerTagsBody(value: object): value is ControllerApiServicesV1WorkerServiceAddWorkerTagsBody {
    return true;
}

export function ControllerApiServicesV1WorkerServiceAddWorkerTagsBodyFromJSON(json: any): ControllerApiServicesV1WorkerServiceAddWorkerTagsBody {
    return ControllerApiServicesV1WorkerServiceAddWorkerTagsBodyFromJSONTyped(json, false);
}

export function ControllerApiServicesV1WorkerServiceAddWorkerTagsBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1WorkerServiceAddWorkerTagsBody {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiServicesV1WorkerServiceAddWorkerTagsBodyToJSON(json: any): ControllerApiServicesV1WorkerServiceAddWorkerTagsBody {
    return ControllerApiServicesV1WorkerServiceAddWorkerTagsBodyToJSONTyped(json, false);
}

export function ControllerApiServicesV1WorkerServiceAddWorkerTagsBodyToJSONTyped(value?: ControllerApiServicesV1WorkerServiceAddWorkerTagsBody | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
