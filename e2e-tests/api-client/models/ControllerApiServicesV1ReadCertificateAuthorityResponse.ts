 ...
 * 
 * @export
 * @interface ControllerApiServicesV1ReadCertificateAuthorityResponse
 */
export interface ControllerApiServicesV1ReadCertificateAuthorityResponse {
    /**
     * 
     * @type {ControllerApiResourcesWorkersV1CertificateAuthority}
     * @memberof ControllerApiServicesV1ReadCertificateAuthorityResponse
     */
    item?: ControllerApiResourcesWorkersV1CertificateAuthority;
}

/**
 * Check if a given object implements the ControllerApiServicesV1ReadCertificateAuthorityResponse interface.
 */
export function instanceOfControllerApiServicesV1ReadCertificateAuthorityResponse(value: object): value is ControllerApiServicesV1ReadCertificateAuthorityResponse {
    return true;
}

export function ControllerApiServicesV1ReadCertificateAuthorityResponseFromJSON(json: any): ControllerApiServicesV1ReadCertificateAuthorityResponse {
    return ControllerApiServicesV1ReadCertificateAuthorityResponseFromJSONTyped(json, false);
}

export function ControllerApiServicesV1ReadCertificateAuthorityResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1ReadCertificateAuthorityResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiServicesV1ReadCertificateAuthorityResponseToJSON(json: any): ControllerApiServicesV1ReadCertificateAuthorityResponse {
    return ControllerApiServicesV1ReadCertificateAuthorityResponseToJSONTyped(json, false);
}

export function ControllerApiServicesV1ReadCertificateAuthorityResponseToJSONTyped(value?: ControllerApiServicesV1ReadCertificateAuthorityResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
