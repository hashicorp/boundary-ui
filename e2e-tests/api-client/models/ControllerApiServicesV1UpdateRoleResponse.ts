 ...
 * 
 * @export
 * @interface ControllerApiServicesV1UpdateRoleResponse
 */
export interface ControllerApiServicesV1UpdateRoleResponse {
    /**
     * 
     * @type {ControllerApiResourcesRolesV1Role}
     * @memberof ControllerApiServicesV1UpdateRoleResponse
     */
    item?: ControllerApiResourcesRolesV1Role;
}

/**
 * Check if a given object implements the ControllerApiServicesV1UpdateRoleResponse interface.
 */
export function instanceOfControllerApiServicesV1UpdateRoleResponse(value: object): value is ControllerApiServicesV1UpdateRoleResponse {
    return true;
}

export function ControllerApiServicesV1UpdateRoleResponseFromJSON(json: any): ControllerApiServicesV1UpdateRoleResponse {
    return ControllerApiServicesV1UpdateRoleResponseFromJSONTyped(json, false);
}

export function ControllerApiServicesV1UpdateRoleResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1UpdateRoleResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiServicesV1UpdateRoleResponseToJSON(json: any): ControllerApiServicesV1UpdateRoleResponse {
    return ControllerApiServicesV1UpdateRoleResponseToJSONTyped(json, false);
}

export function ControllerApiServicesV1UpdateRoleResponseToJSONTyped(value?: ControllerApiServicesV1UpdateRoleResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
