...
import type { ControllerApiResourcesSessionrecordingsV1CredentialStore } from './ControllerApiResourcesSessionrecordingsV1CredentialStore';
import {
    ControllerApiResourcesSessionrecordingsV1CredentialStoreFromJSON,
    ControllerApiResourcesSessionrecordingsV1CredentialStoreFromJSONTyped,
    ControllerApiResourcesSessionrecordingsV1CredentialStoreToJSON,
    ControllerApiResourcesSessionrecordingsV1CredentialStoreToJSONTyped,
} from './ControllerApiResourcesSessionrecordingsV1CredentialStore';

/**
 * 
 * @export
 * @interface ControllerApiResourcesSessionrecordingsV1CredentialLibrary
 */
export interface ControllerApiResourcesSessionrecordingsV1CredentialLibrary {
    /**
     * The ID of the Credential Library.
     * @type {string}
     * @memberof ControllerApiResourcesSessionrecordingsV1CredentialLibrary
     */
    id?: string;
    /**
     * 
     * @type {ControllerApiResourcesSessionrecordingsV1CredentialStore}
     * @memberof ControllerApiResourcesSessionrecordingsV1CredentialLibrary
     */
    credentialStore?: ControllerApiResourcesSessionrecordingsV1CredentialStore;
    /**
...
/**
 * Check if a given object implements the ControllerApiResourcesSessionrecordingsV1CredentialLibrary interface.
 */
export function instanceOfControllerApiResourcesSessionrecordingsV1CredentialLibrary(value: object): value is ControllerApiResourcesSessionrecordingsV1CredentialLibrary {
    return true;
}

export function ControllerApiResourcesSessionrecordingsV1CredentialLibraryFromJSON(json: any): ControllerApiResourcesSessionrecordingsV1CredentialLibrary {
    return ControllerApiResourcesSessionrecordingsV1CredentialLibraryFromJSONTyped(json, false);
}

export function ControllerApiResourcesSessionrecordingsV1CredentialLibraryFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiResourcesSessionrecordingsV1CredentialLibrary {
    if (json == null) {
        return json;
    }
    return {
        ...
        'credentialStore': json['credential_store'] == null ? undefined : ControllerApiResourcesSessionrecordingsV1CredentialStoreFromJSON(json['credential_store']),
...
export function ControllerApiResourcesSessionrecordingsV1CredentialLibraryToJSON(json: any): ControllerApiResourcesSessionrecordingsV1CredentialLibrary {
    return ControllerApiResourcesSessionrecordingsV1CredentialLibraryToJSONTyped(json, false);
}

export function ControllerApiResourcesSessionrecordingsV1CredentialLibraryToJSONTyped(value?: ControllerApiResourcesSessionrecordingsV1CredentialLibrary | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'id': value['id'],
        'credential_store': ControllerApiResourcesSessionrecordingsV1CredentialStoreToJSON(value['credentialStore']),
        'name': value['name'],
