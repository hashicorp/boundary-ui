 ...
 * 
 * @export
 * @interface ControllerApiServicesV1GetPolicyResponse
 */
export interface ControllerApiServicesV1GetPolicyResponse {
    /**
     * 
     * @type {ControllerApiResourcesPoliciesV1Policy}
     * @memberof ControllerApiServicesV1GetPolicyResponse
     */
    item?: ControllerApiResourcesPoliciesV1Policy;
}

/**
 * Check if a given object implements the ControllerApiServicesV1GetPolicyResponse interface.
 */
export function instanceOfControllerApiServicesV1GetPolicyResponse(value: object): value is ControllerApiServicesV1GetPolicyResponse {
    return true;
}

export function ControllerApiServicesV1GetPolicyResponseFromJSON(json: any): ControllerApiServicesV1GetPolicyResponse {
    return ControllerApiServicesV1GetPolicyResponseFromJSONTyped(json, false);
}

export function ControllerApiServicesV1GetPolicyResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1GetPolicyResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiServicesV1GetPolicyResponseToJSON(json: any): ControllerApiServicesV1GetPolicyResponse {
    return ControllerApiServicesV1GetPolicyResponseToJSONTyped(json, false);
}

export function ControllerApiServicesV1GetPolicyResponseToJSONTyped(value?: ControllerApiServicesV1GetPolicyResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
