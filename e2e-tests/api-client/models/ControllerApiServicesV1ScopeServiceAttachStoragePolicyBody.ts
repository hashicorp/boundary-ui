 ...
 * 
 * @export
 * @interface ControllerApiServicesV1ScopeServiceAttachStoragePolicyBody
 */
export interface ControllerApiServicesV1ScopeServiceAttachStoragePolicyBody {
    /**
     * 
     * @type {string}
     * @memberof ControllerApiServicesV1ScopeServiceAttachStoragePolicyBody
     */
...
/**
 * Check if a given object implements the ControllerApiServicesV1ScopeServiceAttachStoragePolicyBody interface.
 */
export function instanceOfControllerApiServicesV1ScopeServiceAttachStoragePolicyBody(value: object): value is ControllerApiServicesV1ScopeServiceAttachStoragePolicyBody {
    return true;
}

export function ControllerApiServicesV1ScopeServiceAttachStoragePolicyBodyFromJSON(json: any): ControllerApiServicesV1ScopeServiceAttachStoragePolicyBody {
    return ControllerApiServicesV1ScopeServiceAttachStoragePolicyBodyFromJSONTyped(json, false);
}

export function ControllerApiServicesV1ScopeServiceAttachStoragePolicyBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1ScopeServiceAttachStoragePolicyBody {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiServicesV1ScopeServiceAttachStoragePolicyBodyToJSON(json: any): ControllerApiServicesV1ScopeServiceAttachStoragePolicyBody {
    return ControllerApiServicesV1ScopeServiceAttachStoragePolicyBodyToJSONTyped(json, false);
}

export function ControllerApiServicesV1ScopeServiceAttachStoragePolicyBodyToJSONTyped(value?: ControllerApiServicesV1ScopeServiceAttachStoragePolicyBody | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'storage_policy_id': value['storagePolicyId'],
