 ...
 * 
 * @export
 * @interface ControllerApiServicesV1CreateHostCatalogResponse
 */
export interface ControllerApiServicesV1CreateHostCatalogResponse {
    /**
     * 
     * @type {string}
     * @memberof ControllerApiServicesV1CreateHostCatalogResponse
     */
    uri?: string;
    /**
     * 
...
/**
 * Check if a given object implements the ControllerApiServicesV1CreateHostCatalogResponse interface.
 */
export function instanceOfControllerApiServicesV1CreateHostCatalogResponse(value: object): value is ControllerApiServicesV1CreateHostCatalogResponse {
    return true;
}

export function ControllerApiServicesV1CreateHostCatalogResponseFromJSON(json: any): ControllerApiServicesV1CreateHostCatalogResponse {
    return ControllerApiServicesV1CreateHostCatalogResponseFromJSONTyped(json, false);
}

export function ControllerApiServicesV1CreateHostCatalogResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1CreateHostCatalogResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiServicesV1CreateHostCatalogResponseToJSON(json: any): ControllerApiServicesV1CreateHostCatalogResponse {
    return ControllerApiServicesV1CreateHostCatalogResponseToJSONTyped(json, false);
}

export function ControllerApiServicesV1CreateHostCatalogResponseToJSONTyped(value?: ControllerApiServicesV1CreateHostCatalogResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
