 ...
 * 
 * @export
 * @interface ControllerApiServicesV1DestroyKeyVersionResponse
 */
export interface ControllerApiServicesV1DestroyKeyVersionResponse {
    /**
     ...
     * @type {string}
     * @memberof ControllerApiServicesV1DestroyKeyVersionResponse
     */
    state?: string;
}

/**
 * Check if a given object implements the ControllerApiServicesV1DestroyKeyVersionResponse interface.
 */
export function instanceOfControllerApiServicesV1DestroyKeyVersionResponse(value: object): value is ControllerApiServicesV1DestroyKeyVersionResponse {
    return true;
}

export function ControllerApiServicesV1DestroyKeyVersionResponseFromJSON(json: any): ControllerApiServicesV1DestroyKeyVersionResponse {
    return ControllerApiServicesV1DestroyKeyVersionResponseFromJSONTyped(json, false);
}

export function ControllerApiServicesV1DestroyKeyVersionResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1DestroyKeyVersionResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiServicesV1DestroyKeyVersionResponseToJSON(json: any): ControllerApiServicesV1DestroyKeyVersionResponse {
    return ControllerApiServicesV1DestroyKeyVersionResponseToJSONTyped(json, false);
}

export function ControllerApiServicesV1DestroyKeyVersionResponseToJSONTyped(value?: ControllerApiServicesV1DestroyKeyVersionResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
