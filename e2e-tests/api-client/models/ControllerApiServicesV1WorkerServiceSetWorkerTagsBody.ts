 ...
 * 
 * @export
 * @interface ControllerApiServicesV1WorkerServiceSetWorkerTagsBody
 */
export interface ControllerApiServicesV1WorkerServiceSetWorkerTagsBody {
    /**
     * Version is used to ensure this resource has not changed.
     * The mutation will fail if the version does not match the latest known good version.
     * @type {number}
     * @memberof ControllerApiServicesV1WorkerServiceSetWorkerTagsBody
     */
    version?: number;
    /**
     * 
...
/**
 * Check if a given object implements the ControllerApiServicesV1WorkerServiceSetWorkerTagsBody interface.
 */
export function instanceOfControllerApiServicesV1WorkerServiceSetWorkerTagsBody(value: object): value is ControllerApiServicesV1WorkerServiceSetWorkerTagsBody {
    return true;
}

export function ControllerApiServicesV1WorkerServiceSetWorkerTagsBodyFromJSON(json: any): ControllerApiServicesV1WorkerServiceSetWorkerTagsBody {
    return ControllerApiServicesV1WorkerServiceSetWorkerTagsBodyFromJSONTyped(json, false);
}

export function ControllerApiServicesV1WorkerServiceSetWorkerTagsBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1WorkerServiceSetWorkerTagsBody {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiServicesV1WorkerServiceSetWorkerTagsBodyToJSON(json: any): ControllerApiServicesV1WorkerServiceSetWorkerTagsBody {
    return ControllerApiServicesV1WorkerServiceSetWorkerTagsBodyToJSONTyped(json, false);
}

export function ControllerApiServicesV1WorkerServiceSetWorkerTagsBodyToJSONTyped(value?: ControllerApiServicesV1WorkerServiceSetWorkerTagsBody | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
