 ...
 * 
 * @export
 * @interface ControllerApiResourcesTargetsV1CredentialSource
 */
export interface ControllerApiResourcesTargetsV1CredentialSource {
    /**
     * The ID of the Credential. May be empty if the credential is dynamically generated from a library.
     * @type {string}
     * @memberof ControllerApiResourcesTargetsV1CredentialSource
     */
    id?: string;
    /**
...
/**
 * Check if a given object implements the ControllerApiResourcesTargetsV1CredentialSource interface.
 */
export function instanceOfControllerApiResourcesTargetsV1CredentialSource(value: object): value is ControllerApiResourcesTargetsV1CredentialSource {
    return true;
}

export function ControllerApiResourcesTargetsV1CredentialSourceFromJSON(json: any): ControllerApiResourcesTargetsV1CredentialSource {
    return ControllerApiResourcesTargetsV1CredentialSourceFromJSONTyped(json, false);
}

export function ControllerApiResourcesTargetsV1CredentialSourceFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiResourcesTargetsV1CredentialSource {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiResourcesTargetsV1CredentialSourceToJSON(json: any): ControllerApiResourcesTargetsV1CredentialSource {
    return ControllerApiResourcesTargetsV1CredentialSourceToJSONTyped(json, false);
}

export function ControllerApiResourcesTargetsV1CredentialSourceToJSONTyped(value?: Omit<ControllerApiResourcesTargetsV1CredentialSource, 'name'|'description'|'credential_store_id'|'type'|'credential_type'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
