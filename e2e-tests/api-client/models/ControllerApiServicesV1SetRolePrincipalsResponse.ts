 ...
 * 
 * @export
 * @interface ControllerApiServicesV1SetRolePrincipalsResponse
 */
export interface ControllerApiServicesV1SetRolePrincipalsResponse {
    /**
     * 
     * @type {ControllerApiResourcesRolesV1Role}
     * @memberof ControllerApiServicesV1SetRolePrincipalsResponse
     */
    item?: ControllerApiResourcesRolesV1Role;
}

/**
 * Check if a given object implements the ControllerApiServicesV1SetRolePrincipalsResponse interface.
 */
export function instanceOfControllerApiServicesV1SetRolePrincipalsResponse(value: object): value is ControllerApiServicesV1SetRolePrincipalsResponse {
    return true;
}

export function ControllerApiServicesV1SetRolePrincipalsResponseFromJSON(json: any): ControllerApiServicesV1SetRolePrincipalsResponse {
    return ControllerApiServicesV1SetRolePrincipalsResponseFromJSONTyped(json, false);
}

export function ControllerApiServicesV1SetRolePrincipalsResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1SetRolePrincipalsResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiServicesV1SetRolePrincipalsResponseToJSON(json: any): ControllerApiServicesV1SetRolePrincipalsResponse {
    return ControllerApiServicesV1SetRolePrincipalsResponseToJSONTyped(json, false);
}

export function ControllerApiServicesV1SetRolePrincipalsResponseToJSONTyped(value?: ControllerApiServicesV1SetRolePrincipalsResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
