 ...
 * 
 * @export
 * @interface ControllerApiServicesV1TargetServiceRemoveTargetHostSourcesBody
 */
export interface ControllerApiServicesV1TargetServiceRemoveTargetHostSourcesBody {
    /**
     * Version is used to ensure this resource has not changed.
     * The mutation will fail if the version does not match the latest known good version.
     * @type {number}
     * @memberof ControllerApiServicesV1TargetServiceRemoveTargetHostSourcesBody
     */
    version?: number;
    /**
     * 
     ...
     * @memberof ControllerApiServicesV1TargetServiceRemoveTargetHostSourcesBody
     */
    hostSourceIds?: Array<string>;
}

/**
 * Check if a given object implements the ControllerApiServicesV1TargetServiceRemoveTargetHostSourcesBody interface.
 */
export function instanceOfControllerApiServicesV1TargetServiceRemoveTargetHostSourcesBody(value: object): value is ControllerApiServicesV1TargetServiceRemoveTargetHostSourcesBody {
    return true;
}

export function ControllerApiServicesV1TargetServiceRemoveTargetHostSourcesBodyFromJSON(json: any): ControllerApiServicesV1TargetServiceRemoveTargetHostSourcesBody {
    return ControllerApiServicesV1TargetServiceRemoveTargetHostSourcesBodyFromJSONTyped(json, false);
}

export function ControllerApiServicesV1TargetServiceRemoveTargetHostSourcesBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1TargetServiceRemoveTargetHostSourcesBody {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiServicesV1TargetServiceRemoveTargetHostSourcesBodyToJSON(json: any): ControllerApiServicesV1TargetServiceRemoveTargetHostSourcesBody {
    return ControllerApiServicesV1TargetServiceRemoveTargetHostSourcesBodyToJSONTyped(json, false);
}

export function ControllerApiServicesV1TargetServiceRemoveTargetHostSourcesBodyToJSONTyped(value?: ControllerApiServicesV1TargetServiceRemoveTargetHostSourcesBody | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'host_source_ids': value['hostSourceIds'],
    };
}
