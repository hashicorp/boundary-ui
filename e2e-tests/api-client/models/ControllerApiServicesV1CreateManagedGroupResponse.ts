 ...
 * 
 * @export
 * @interface ControllerApiServicesV1CreateManagedGroupResponse
 */
export interface ControllerApiServicesV1CreateManagedGroupResponse {
    /**
     * 
     * @type {string}
     * @memberof ControllerApiServicesV1CreateManagedGroupResponse
     */
    uri?: string;
    /**
     * 
...
/**
 * Check if a given object implements the ControllerApiServicesV1CreateManagedGroupResponse interface.
 */
export function instanceOfControllerApiServicesV1CreateManagedGroupResponse(value: object): value is ControllerApiServicesV1CreateManagedGroupResponse {
    return true;
}

export function ControllerApiServicesV1CreateManagedGroupResponseFromJSON(json: any): ControllerApiServicesV1CreateManagedGroupResponse {
    return ControllerApiServicesV1CreateManagedGroupResponseFromJSONTyped(json, false);
}

export function ControllerApiServicesV1CreateManagedGroupResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1CreateManagedGroupResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiServicesV1CreateManagedGroupResponseToJSON(json: any): ControllerApiServicesV1CreateManagedGroupResponse {
    return ControllerApiServicesV1CreateManagedGroupResponseToJSONTyped(json, false);
}

export function ControllerApiServicesV1CreateManagedGroupResponseToJSONTyped(value?: ControllerApiServicesV1CreateManagedGroupResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
