 ...
 * 
 * @export
 * @interface ControllerApiResourcesHostsV1Host
 */
export interface ControllerApiResourcesHostsV1Host {
    /**
     * Output only. The ID of the Host.
     * @type {string}
     * @memberof ControllerApiResourcesHostsV1Host
     */
    readonly id?: string;
    /**
     ...
     * @memberof ControllerApiResourcesHostsV1Host
     */
    readonly hostSetIds?: Array<string>;
    /**
     ...
     * @memberof ControllerApiResourcesHostsV1Host
     */
    readonly dnsNames?: Array<string>;
    /**
...
/**
 * Check if a given object implements the ControllerApiResourcesHostsV1Host interface.
 */
export function instanceOfControllerApiResourcesHostsV1Host(value: object): value is ControllerApiResourcesHostsV1Host {
    return true;
}

export function ControllerApiResourcesHostsV1HostFromJSON(json: any): ControllerApiResourcesHostsV1Host {
    return ControllerApiResourcesHostsV1HostFromJSONTyped(json, false);
}

export function ControllerApiResourcesHostsV1HostFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiResourcesHostsV1Host {
    if (json == null) {
        return json;
    }
    return {
        ...
        'hostSetIds': json['host_set_ids'] == null ? undefined : json['host_set_ids'],
        'attributes': json['attributes'] == null ? undefined : json['attributes'],
        'ipAddresses': json['ip_addresses'] == null ? undefined : json['ip_addresses'],
        'dnsNames': json['dns_names'] == null ? undefined : json['dns_names'],
...
export function ControllerApiResourcesHostsV1HostToJSON(json: any): ControllerApiResourcesHostsV1Host {
    return ControllerApiResourcesHostsV1HostToJSONTyped(json, false);
}

export function ControllerApiResourcesHostsV1HostToJSONTyped(value?: Omit<ControllerApiResourcesHostsV1Host, 'id'|'created_time'|'updated_time'|'host_set_ids'|'ip_addresses'|'dns_names'|'external_id'|'external_name'|'authorized_actions'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
