 ...
 * 
 * @export
 * @interface ControllerApiServicesV1UpdateHostCatalogResponse
 */
export interface ControllerApiServicesV1UpdateHostCatalogResponse {
    /**
     * 
     * @type {ControllerApiResourcesHostcatalogsV1HostCatalog}
     * @memberof ControllerApiServicesV1UpdateHostCatalogResponse
     */
    item?: ControllerApiResourcesHostcatalogsV1HostCatalog;
}

/**
 * Check if a given object implements the ControllerApiServicesV1UpdateHostCatalogResponse interface.
 */
export function instanceOfControllerApiServicesV1UpdateHostCatalogResponse(value: object): value is ControllerApiServicesV1UpdateHostCatalogResponse {
    return true;
}

export function ControllerApiServicesV1UpdateHostCatalogResponseFromJSON(json: any): ControllerApiServicesV1UpdateHostCatalogResponse {
    return ControllerApiServicesV1UpdateHostCatalogResponseFromJSONTyped(json, false);
}

export function ControllerApiServicesV1UpdateHostCatalogResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1UpdateHostCatalogResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function ControllerApiServicesV1UpdateHostCatalogResponseToJSON(json: any): ControllerApiServicesV1UpdateHostCatalogResponse {
    return ControllerApiServicesV1UpdateHostCatalogResponseToJSONTyped(json, false);
}

export function ControllerApiServicesV1UpdateHostCatalogResponseToJSONTyped(value?: ControllerApiServicesV1UpdateHostCatalogResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
