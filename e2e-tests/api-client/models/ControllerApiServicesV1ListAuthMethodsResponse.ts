...
import type { ControllerApiResourcesAuthmethodsV1AuthMethod } from './ControllerApiResourcesAuthmethodsV1AuthMethod';
import {
    ControllerApiResourcesAuthmethodsV1AuthMethodFromJSON,
    ControllerApiResourcesAuthmethodsV1AuthMethodFromJSONTyped,
    ControllerApiResourcesAuthmethodsV1AuthMethodToJSON,
    ControllerApiResourcesAuthmethodsV1AuthMethodToJSONTyped,
} from './ControllerApiResourcesAuthmethodsV1AuthMethod';

/**
 * 
 * @export
 * @interface ControllerApiServicesV1ListAuthMethodsResponse
 */
export interface ControllerApiServicesV1ListAuthMethodsResponse {
    /**
     * The items returned in this page.
     * @type {Array<ControllerApiResourcesAuthmethodsV1AuthMethod>}
     * @memberof ControllerApiServicesV1ListAuthMethodsResponse
     */
    items?: Array<ControllerApiResourcesAuthmethodsV1AuthMethod>;
    /**
...
/**
 * Check if a given object implements the ControllerApiServicesV1ListAuthMethodsResponse interface.
 */
export function instanceOfControllerApiServicesV1ListAuthMethodsResponse(value: object): value is ControllerApiServicesV1ListAuthMethodsResponse {
    return true;
}

export function ControllerApiServicesV1ListAuthMethodsResponseFromJSON(json: any): ControllerApiServicesV1ListAuthMethodsResponse {
    return ControllerApiServicesV1ListAuthMethodsResponseFromJSONTyped(json, false);
}

export function ControllerApiServicesV1ListAuthMethodsResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1ListAuthMethodsResponse {
    if (json == null) {
        return json;
    }
    return {
        
        'items': json['items'] == null ? undefined : ((json['items'] as Array<any>).map(ControllerApiResourcesAuthmethodsV1AuthMethodFromJSON)),
...
export function ControllerApiServicesV1ListAuthMethodsResponseToJSON(json: any): ControllerApiServicesV1ListAuthMethodsResponse {
    return ControllerApiServicesV1ListAuthMethodsResponseToJSONTyped(json, false);
}

export function ControllerApiServicesV1ListAuthMethodsResponseToJSONTyped(value?: ControllerApiServicesV1ListAuthMethodsResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'items': value['items'] == null ? undefined : ((value['items'] as Array<any>).map(ControllerApiResourcesAuthmethodsV1AuthMethodToJSON)),
