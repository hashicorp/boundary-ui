 ...
 * 
 * @export
 * @interface ControllerApiServicesV1UpdateHostResponse
 */
export interface ControllerApiServicesV1UpdateHostResponse {
    /**
     * 
     * @type {ControllerApiResourcesHostsV1Host}
     * @memberof ControllerApiServicesV1UpdateHostResponse
     */
    item?: ControllerApiResourcesHostsV1Host;
}

/**
 * Check if a given object implements the ControllerApiServicesV1UpdateHostResponse interface.
 */
export function instanceOfControllerApiServicesV1UpdateHostResponse(value: object): value is ControllerApiServicesV1UpdateHostResponse {
    return true;
}

export function ControllerApiServicesV1UpdateHostResponseFromJSON(json: any): ControllerApiServicesV1UpdateHostResponse {
    return ControllerApiServicesV1UpdateHostResponseFromJSONTyped(json, false);
}

export function ControllerApiServicesV1UpdateHostResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControllerApiServicesV1UpdateHostResponse {
    if (json == null) {
        return json;
    }
    return {
        
        'item': json['item'] == null ? undefined : ControllerApiResourcesHostsV1HostFromJSON(json['item']),
    };
}

export function ControllerApiServicesV1UpdateHostResponseToJSON(json: any): ControllerApiServicesV1UpdateHostResponse {
    return ControllerApiServicesV1UpdateHostResponseToJSONTyped(json, false);
}

export function ControllerApiServicesV1UpdateHostResponseToJSONTyped(value?: ControllerApiServicesV1UpdateHostResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'item': ControllerApiResourcesHostsV1HostToJSON(value['item']),
    };
}
