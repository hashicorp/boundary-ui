...
import type {
  ControllerApiResourcesAuthtokensV1AuthToken,
  ControllerApiServicesV1ListAuthTokensResponse,
  ControllerApiV1Error,
} from '../models/index';
import {
    ControllerApiResourcesAuthtokensV1AuthTokenFromJSON,
    ControllerApiResourcesAuthtokensV1AuthTokenToJSON,
    ControllerApiServicesV1ListAuthTokensResponseFromJSON,
    ControllerApiServicesV1ListAuthTokensResponseToJSON,
    ControllerApiV1ErrorFromJSON,
    ControllerApiV1ErrorToJSON,
} from '../models/index';

export interface AuthTokenServiceDeleteAuthTokenRequest {
    id: string;
}

export interface AuthTokenServiceGetAuthTokenRequest {
    id: string;
}

export interface AuthTokenServiceListAuthTokensRequest {
    scopeId?: string;
    recursive?: boolean;
    filter?: string;
    listToken?: string;
 ...
 * 
 */
export class AuthTokenServiceApi extends runtime.BaseAPI {

    /**
     * Deletes an Auth Token.
     */
    async authTokenServiceDeleteAuthTokenRaw(requestParameters: AuthTokenServiceDeleteAuthTokenRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<object>> {
        if (requestParameters['id'] == null) {
            throw new runtime.RequiredError(
                'id',
                'Required parameter "id" was null or undefined when calling authTokenServiceDeleteAuthToken().'
            );
        }
     ...
     * Deletes an Auth Token.
     */
    async authTokenServiceDeleteAuthToken(requestParameters: AuthTokenServiceDeleteAuthTokenRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<object> {
        const response = await this.authTokenServiceDeleteAuthTokenRaw(requestParameters, initOverrides);
     ...
     */
    async authTokenServiceGetAuthTokenRaw(requestParameters: AuthTokenServiceGetAuthTokenRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ControllerApiResourcesAuthtokensV1AuthToken>> {
        if (requestParameters['id'] == null) {
            throw new runtime.RequiredError(
                'id',
                'Required parameter "id" was null or undefined when calling authTokenServiceGetAuthToken().'
            );
        }
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => ControllerApiResourcesAuthtokensV1AuthTokenFromJSON(jsonValue));
    }

    /**
     * Gets a single Auth Token.
     */
    async authTokenServiceGetAuthToken(requestParameters: AuthTokenServiceGetAuthTokenRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ControllerApiResourcesAuthtokensV1AuthToken> {
        const response = await this.authTokenServiceGetAuthTokenRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async authTokenServiceListAuthTokensRaw(requestParameters: AuthTokenServiceListAuthTokensRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ControllerApiServicesV1ListAuthTokensResponse>> {
        const queryParameters: any = {};
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => ControllerApiServicesV1ListAuthTokensResponseFromJSON(jsonValue));
    }

    /**
     * Lists all Auth Tokens.
     */
    async authTokenServiceListAuthTokens(requestParameters: AuthTokenServiceListAuthTokensRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ControllerApiServicesV1ListAuthTokensResponse> {
        const response = await this.authTokenServiceListAuthTokensRaw(requestParameters, initOverrides);
        return await response.value();
    }
