...
import type {
  ControllerApiResourcesSessionrecordingsV1SessionRecording,
  ControllerApiServicesV1ListSessionRecordingsResponse,
...
import {
    ...
    ControllerApiServicesV1ListSessionRecordingsResponseFromJSON,
    ControllerApiServicesV1ListSessionRecordingsResponseToJSON,
    ControllerApiV1ErrorFromJSON,
    ControllerApiV1ErrorToJSON,
} from '../models/index';

export interface SessionRecordingServiceDeleteSessionRecordingRequest {
    id: string;
}

export interface SessionRecordingServiceDownloadRequest {
    id: string;
    mimeType?: string;
}

export interface SessionRecordingServiceGetSessionRecordingRequest {
    id: string;
}

export interface SessionRecordingServiceListSessionRecordingsRequest {
    scopeId?: string;
    recursive?: boolean;
    listToken?: string;
    pageSize?: number;
...
export interface SessionRecordingServiceReApplyStoragePolicyRequest {
    id: string;
}
 ...
 * 
 */
export class SessionRecordingServiceApi extends runtime.BaseAPI {

    /**
     * Deletes a Session Recording
     */
    async sessionRecordingServiceDeleteSessionRecordingRaw(requestParameters: SessionRecordingServiceDeleteSessionRecordingRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<object>> {
        if (requestParameters['id'] == null) {
            throw new runtime.RequiredError(
                'id',
                'Required parameter "id" was null or undefined when calling sessionRecordingServiceDeleteSessionRecording().'
            );
        }
        ...
        const response = await this.request({
            path: `/v1/session-recordings/{id}`.replace(`{${"id"}}`, encodeURIComponent(String(requestParameters['id']))),
            method: 'DELETE',
     ...
     * Deletes a Session Recording
     */
    async sessionRecordingServiceDeleteSessionRecording(requestParameters: SessionRecordingServiceDeleteSessionRecordingRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<object> {
        const response = await this.sessionRecordingServiceDeleteSessionRecordingRaw(requestParameters, initOverrides);
     ...
     */
    async sessionRecordingServiceDownloadRaw(requestParameters: SessionRecordingServiceDownloadRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Blob>> {
        if (requestParameters['id'] == null) {
            throw new runtime.RequiredError(
                'id',
                'Required parameter "id" was null or undefined when calling sessionRecordingServiceDownload().'
            );
        }
        ...
        const response = await this.request({
            path: `/v1/session-recordings/{id}:download`.replace(`{${"id"}}`, encodeURIComponent(String(requestParameters['id']))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
     ...
     * Download returns the contents of the specified resource in the specified mime type. Supports both Session ID and Session recording ID for looking up a Session recording. Supports both Connection ID and Connection recording ID to look up a Connection recording. A Channel recording ID is required to look up a Channel recording. The only supported mime type is \"application/x-asciicast\".
     */
    async sessionRecordingServiceDownload(requestParameters: SessionRecordingServiceDownloadRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Blob> {
        const response = await this.sessionRecordingServiceDownloadRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async sessionRecordingServiceGetSessionRecordingRaw(requestParameters: SessionRecordingServiceGetSessionRecordingRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ControllerApiResourcesSessionrecordingsV1SessionRecording>> {
        if (requestParameters['id'] == null) {
            throw new runtime.RequiredError(
                'id',
                'Required parameter "id" was null or undefined when calling sessionRecordingServiceGetSessionRecording().'
            );
        }
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => ControllerApiResourcesSessionrecordingsV1SessionRecordingFromJSON(jsonValue));
    }

    /**
     * GetSessionRecording returns a stored Session recording if present. The provided request must include the Session recording ID for the Session recording being retrieved, or the ID of the Session that was recorded. If that ID is missing, malformed or reference a non existing resource, an error is returned.
     */
    async sessionRecordingServiceGetSessionRecording(requestParameters: SessionRecordingServiceGetSessionRecordingRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ControllerApiResourcesSessionrecordingsV1SessionRecording> {
        const response = await this.sessionRecordingServiceGetSessionRecordingRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async sessionRecordingServiceListSessionRecordingsRaw(requestParameters: SessionRecordingServiceListSessionRecordingsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ControllerApiServicesV1ListSessionRecordingsResponse>> {
        const queryParameters: any = {};
        ...
        const response = await this.request({
            path: `/v1/session-recordings`,
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => ControllerApiServicesV1ListSessionRecordingsResponseFromJSON(jsonValue));
    }

    /**
     * ListSessionRecordings lists all Session recordings. Session recordings are ordered by start_time descending (most recently started first).
     */
    async sessionRecordingServiceListSessionRecordings(requestParameters: SessionRecordingServiceListSessionRecordingsRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ControllerApiServicesV1ListSessionRecordingsResponse> {
        const response = await this.sessionRecordingServiceListSessionRecordingsRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async sessionRecordingServiceReApplyStoragePolicyRaw(requestParameters: SessionRecordingServiceReApplyStoragePolicyRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ControllerApiResourcesSessionrecordingsV1SessionRecording>> {
        if (requestParameters['id'] == null) {
            throw new runtime.RequiredError(
                'id',
                'Required parameter "id" was null or undefined when calling sessionRecordingServiceReApplyStoragePolicy().'
            );
        }
        ...
        const response = await this.request({
            path: `/v1/session-recordings/{id}:reapply-storage-policy`.replace(`{${"id"}}`, encodeURIComponent(String(requestParameters['id']))),
            method: 'POST',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
     ...
     * ReApplyStoragePolicy will recalculate the resultant set of policy and apply the result to the given session recording.
     */
    async sessionRecordingServiceReApplyStoragePolicy(requestParameters: SessionRecordingServiceReApplyStoragePolicyRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ControllerApiResourcesSessionrecordingsV1SessionRecording> {
        const response = await this.sessionRecordingServiceReApplyStoragePolicyRaw(requestParameters, initOverrides);
        return await response.value();
    }
