...
import type {
  ControllerApiServicesV1MonthlyActiveUsersResponse,
  ControllerApiV1Error,
} from '../models/index';
import {
    ControllerApiServicesV1MonthlyActiveUsersResponseFromJSON,
    ControllerApiServicesV1MonthlyActiveUsersResponseToJSON,
    ControllerApiV1ErrorFromJSON,
    ControllerApiV1ErrorToJSON,
} from '../models/index';

export interface BillingServiceMonthlyActiveUsersRequest {
    startTime?: string;
    endTime?: string;
}
 ...
 * 
 */
export class BillingServiceApi extends runtime.BaseAPI {

    /**
     * Returns monthly active users.
     */
    async billingServiceMonthlyActiveUsersRaw(requestParameters: BillingServiceMonthlyActiveUsersRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ControllerApiServicesV1MonthlyActiveUsersResponse>> {
        ...
        const response = await this.request({
            path: `/v1/billing:monthly-active-users`,
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => ControllerApiServicesV1MonthlyActiveUsersResponseFromJSON(jsonValue));
    }

    /**
     * Returns monthly active users.
     */
    async billingServiceMonthlyActiveUsers(requestParameters: BillingServiceMonthlyActiveUsersRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ControllerApiServicesV1MonthlyActiveUsersResponse> {
        const response = await this.billingServiceMonthlyActiveUsersRaw(requestParameters, initOverrides);
